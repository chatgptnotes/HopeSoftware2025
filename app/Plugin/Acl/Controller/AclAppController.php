...
{
    public $components = array('Acl', 'Auth', 'Session', 'Acl.AclManager', 'Acl.AclReflector');
    ...
    public function _get_passed_aco_path()
	{
	...
	public function _set_aco_variables()
	{
	...
	public function _get_role_primary_key_name()
	{
	...
	public function _get_user_primary_key_name()
	{
	...
	public function _get_role_foreign_key_name()
	{
	...
	public function _return_to_referer()
	{
