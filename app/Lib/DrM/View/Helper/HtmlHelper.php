 ...
 */
	public function __construct(View $View, $settings = array()) {
		 ...
		 */
		$allowedHelpers = array_keys($View->request->autocompleteActionsHelper);
		if($View->request->isAjax() && in_array($View->view, $allowedHelpers)){
			if(!in_array($name, $View->request->autocompleteActionsHelper[$this->view])) $location = null;
		}
		/** Pawan Meshram
		 * 
		 */
