...
<div class="inner_title">
	<h3>
		&nbsp;
		<?php echo __('Edit Allergy List', true); ?>
	</h3>
</div>
<?php echo $this->Form->create('editallergy',array('url'=>array('controller'=>'patients','action'=>'edit_allergies'),'type'=>'post','id'=>'frm1'));?>
<?php 
if(!empty($errors)) {
?>
...
<table border="0" cellpadding="0" cellspacing="0" width="60%"
	align="center">
	<tr><?php echo $this->Form->hidden('allergy_name',array('value'=> $edit_data['0']['NewCropAllergies']['name']));?>
		<td colspan="2" align="left"> Allergy Name</td>
		<td colspan="2" align="left"> <?php echo $edit_data['0']['NewCropAllergies']['name'];?></td>
	</tr>
	<tr>
	<td></td>
	</tr>
