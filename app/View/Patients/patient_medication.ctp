...
<div class="inner_title">
 <h3>
 <?php echo __('Patient Medication'); ?>
 </h3>
</div>
	<?php 
			echo $this->Form->create('User', array('type' => 'post','url' => 'https://preproduction.newcropaccounts.com/InterfaceV7/RxEntry.aspx','target'=>'aframe'));?>
...
<script>
			...
			function submit_form()
			{
			  ...
			  document.getElementById('UserPatientMedicationForm').submit();
			}
