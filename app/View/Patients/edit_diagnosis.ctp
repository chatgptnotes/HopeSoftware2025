...
echo $this->Form->create('edit_diagnosis',array('id'=>'dxfrm'));
	...
	<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="500px">
		...
		<tr class="row_title">
			<td class="row_format" colspan=''>
				...
				&nbsp;<?php
//debug($icd);
				echo  $snomed_code; ?>&nbsp;&nbsp;&nbsp;<?php echo $snomed_name; ?></td>
		</tr>
		<tr class="row_title">                                                                                                    
			<td class="row_format" colspan=''>
		...
		<tr class="row_title">
			...
			<?php echo $this->Form->radio(__('disease_status'), array('Chronic'=>'Chronic','terminal'=>'is terminal'),array('value'=>(isset($this->data['NoteDiagnosis']['disease_status'])?$this->data['NoteDiagnosis']['disease_status']:""),'legend'=>false,'name'=>'disease_status','label'=>false,'id' => 'disease_status' ));
 ?></td>
		</tr>
		 <tr>
			<td>
		...
		<tr>
			<td>
				<?php  echo $this->Form->input(__('Pervious comment on this diagnosis'),array('type'=>'textarea','rows'=>'2','cols'=>'80','name'=>'prev_comment'),array('value'=>(isset($this->data['NoteDiagnosis']['prev_comment']))));?>
			</td>
		</tr> 
		...
		<tr>
			<td>
				<?php  echo $this->Form->button(__('Back'), array('type'=>'button','label'=> false,'div' => false,'error' => false,'class'=>'blueBtn','id'=>'makd' ));?>
	...
	jQuery(document)
			.ready(
					function() {
						...
						jQuery("#start_date").validationEngine();

						jQuery("#start_date").submit(
								function() {

									var returnVal = jQuery("#start_date")
