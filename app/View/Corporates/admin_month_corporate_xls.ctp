...
<table width="" cellpadding="0" cellspacing="1" border="1" class="tabularForm top-header">
	<tr class='row_title'>
		<td colspan="7" width="" height='30px' align='center' valign='middle'>
	...
	<tr> 
		<thead> 
            ...
            <th width="10%"  align="center" style="text-align:center;">Invoice Number</th>
		...
		<th width="10%"  align="center" style="text-align: center;">Aging (In Days)</th>
