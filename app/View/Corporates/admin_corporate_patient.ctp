...
<div class="inner_title">
	<h3>Outstanding Report - <?php echo $tariffData[$tariffStandardID];?></h3>
		...
		<span style="float:right;">
    		<?php	
 	  			echo $this->Form->create('',array('url'=>array('controller'=>'Corporates','action'=>'admin_corporate_patient',$tariffStandardID,'admin'=>'TRUE'),'id'=>'otherOutRepFrm','type'=>'get')); 
		...
		<td style="color:#000;">
		 ...
		 <td><?php echo "Delay In Bill Preparation - Aging Report <br>".$this->Form->input('delay_in_bill_preparation',array('class'=>'textBoxExpnd','empty'=>'Please Select',
		  ...
		  <td>
			...
			<?php echo $this->Html->link($this->Html->image('icons/refresh-icon.png'),array('action'=>'admin_corporate_patient',$tariffStandardID,'admin'=>'TRUE'),array('escape'=>false, 'title' => 'Refresh'));?>
		  </td>	
...
// 		echo $result['Patient']['corporate_status']; 
	...
	<tr>
		...
		<td width="10%"  align="center" style="text-align:center;"></td>
		<td width="10%"  align="center" style="text-align:center;"></td>
		<td width="10%"  align="center" style="text-align:center;"></td>
		<td width="10%"  align="center" style="text-align: center;"> </td>
		<td width="10%"  align="center" style="text-align: center;"></td> 
		...
		<td width="10%"  align="center" style="text-align: center;"></td>
		<td width="10%"  align="center" style="text-align: center;"></td>
		<td width="10%"  align="center" style="text-align: center;"><h3>Total Patients:</h3></td>
		<td width="10%"  align="center" style="text-align: center;"><h3><?php echo h($totalPatients); ?></h3></td>  
	</tr>
</table>
