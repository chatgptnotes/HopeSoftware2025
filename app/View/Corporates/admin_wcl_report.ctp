...
<div class="inner_title">
	<h3 style="float: left;">WCL Reports</h3>
     <div style="float:right;">
		<span style="float:right;">
		<?php
			echo $this->Form->create('surgeonreport',array('url'=>array('controller'=>'Corporates','action'=>'wcl_report','admin'=>'TRUE'),'id'=>'surgeonreport','type'=>'get', 'style'=> 'float:left;')); 
	...
	<table cellpadding="0" cellspacing="0" border="0" class="tdLabel2" style="color: #b9c8ca;">
		<tr>
			<td style="color:#000;">
				...
				<span>
		    		<?php echo __("Date From : ").$this->Form->input('from', array('id'=>'fromDate','value'=>$this->request->query['from'],'label'=>false,
		    			'div' => false, 'error' => false)); ?>
		    	</span>
		    	<span>
		    		<?php echo __("To Date : ").$this->Form->input('to', array('id'=>'toDate','value'=>$this->request->query['to'],'label'=>false,
		    			'div' => false, 'error' => false));?>
		    	</span>
	 ...
	 ?>
        <tr id="row_<?php echo $patient_id; ?>" class="rowselected">
			...
			<td width="149px"  align="center"	style="text-align:center;">
			     	<?php 
			     	echo $result['Patient']['name_of_ip'];  
			       ?>
		     </td>
			     	
		    <td width="144px"  align="center"	style="text-align:center;">
			     	<?php echo $result['Patient']['relation_to_employee']."<br>";  ?>
	          </td>
