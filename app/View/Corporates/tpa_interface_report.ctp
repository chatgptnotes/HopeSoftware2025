	...
	<table width="80%" cellpadding="0" cellspacing="1" border="0" class="tabularForm" align="center"> 
		<tr>
		  	<thead>
				...
				<th width="51px" valign="top" align="center" style="text-align:center;">Name of TPA</th>
				<th width="60px" valign="top" align="center" style="text-align:center;">Link to download pre-auth</th>
				 <th width="51px" valign="top" align="center" style="text-align:center;">Download Tariff</th>
				<th width="51px" valign="top" align="center" style="text-align:center;">Online Document List</th>
    ...
    ?>
     <tr>
    		...
    		<td width="55px" style="text-align:center;">
				<?php echo ucfirst($tariff['TariffStandard']['name']);?>
			</td>
    		
    		<td width="66px" style="text-align:center;">
				<?php
			echo $this->Html->link('Click to download pre auth form','http://www.apollomunichinsurance.com/Downloads/Maxima-Pre-Authorization-Form.pdf',array('target' => '_blank'));
		?> 
			</td>
			<td width="66px" style="text-align:center;">
				<?php //http://www.chemicals.nic.in/cghsrate.pdf
			echo $this->Html->link('Click to download Tariff List','http://msotransparent.nic.in/writereaddata/cghsdata/mainlinkfile/File701.pdf',array('target' => '_blank'));
		?> 
			</td>
			<td width="66px" style="text-align:center;">
				<?php
			echo $this->Html->link('link',array('controller'=>'PatientDocuments','action'=>'index'),array('target' => '_blank'));
		?> 
			</td>
	    	
			<!-- <td width="66px" style="text-align:center;"><?php if(!empty($this->params->query)){
			echo $this->Html->link($data['surgery_count'],array('controller'=>'PatientDocuments','action'=>'index','null',$key,
			'?'=>$this->params->query),array('target' => '_blank'));
		}else{
		echo $this->Html->link($data['surgery_count'],array('controller'=>$this->params->controller,'action'=>$this->params->action,'null',$key),array('target' => '_blank'));
		}?> </td> -->
