...
function iColorShow(i,i2){
	if(document.forms['preference']) {
		if(document.forms['preference'].elements['defaultSet'+i]){ // added by mayank
			document.forms['preference'].elements['defaultSet'+i].checked=false;
		}
	}
