...
<form name="instrumentfrm" id="instrumentfrm" action="<?php echo $this->Html->url(array("controller" => "instruments", "action" => "add")); ?>" method="post" >
	...
	<td>
        <?php 
        echo $this->Form->input('DeviceMaster.code_value', array( 'id' => 'instrumentcode', 'label'=> false, 'div' => false, 'error' => false));
        ?>
	</td>
	</tr>
	<tr>
