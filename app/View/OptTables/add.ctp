<div class="inner_title">
 <h3><?php echo __('Add OR Table', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="opttablefrm" id="opttablefrm" action="<?php echo $this->Html->url(array("action" => "add")); ?>" method="post" onSubmit="return Validate(this);" >
