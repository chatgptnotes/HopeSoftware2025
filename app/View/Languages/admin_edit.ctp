...
<h3><img src="images/appointment_icon.png" /> &nbsp; <?php echo __('Edit Language', true); ?></h3>
...
<script>
	...
	jQuery("#LanguageSuperadminEditForm").validationEngine();
	});
...
<?php echo $this->Form->create('Language');?>
	...
	<tr>
		...
		<?php echo __('Language Name'); ?><font color="red">*</font>
		</td>
		<td >
	<?php
        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "Language name is requred.",
