...
<div class="inner_title">
	<h3>&nbsp; <?php echo __('OR', true); ?></h3>
	<span style="float:right;margin: -24px 0; padding:0">
	<?php echo $this->Html->link(__('Preference Card'), array('controller' => 'Preferences', 'action' => 'user_preferencecard'), array('escape' => false,'class'=>'blueBtn'));?>
	<?php echo $this->Html->link(__('Search OR Appointment'), array('controller' => 'OptAppointments', 'action' => 'search_otevent'), array('escape' => false,'class'=>'blueBtn'));?>
	<?php echo $this->Html->link(__('OR Item Requisition'), array('controller' => 'opts', 'action' => 'ot_replace_list'), array('escape' => false,'class'=>'blueBtn'));?>
  </span>
</div>
<div class="clr">&nbsp;</div>
<style>
...
echo $this->Form->create(null, array('url' => array('controller'=>'opt_appointments','action'=>'search'),'type'=>'get'));?>	
...
<?php if(isset($data) && !empty($data)){  ?>
		<tr class="row_title">
			...
			<td class="table_cell"><strong><?php echo  __('Gender'); ?></strong></td>
		</tr>
	  <?php $toggle =0;
	      if(count($data) > 0) {
			...
			<td class="row_format"><?php echo $this->Html->link(ucfirst($patients[0]['lookup_name']), array('action' => 'patient_information', $patients['Patient']['id']), array('escape' => false));?></td>							  
			...
			<td class="row_format"><?php echo $this->DateFormat->formatDate2Local($patients['Patient']['form_received_on'],Configure::read('date_format'),true);?></td>	   
						<!-- <td align="center"><?php echo $this->Html->link($this->Html->image('icons/uerInfo.png',array('style'=>'height:20px;width:18px;')), array('action' => 'patient_information', $patients['Patient']['id']), array('escape' => false));?></td> -->
			<td class="row_format"><?php if(strtolower($patients['Patient']['sex'])=='male'){
