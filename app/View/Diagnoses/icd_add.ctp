...
<div>&nbsp;</div>
<?php 
			echo $this->Form->create('Diagnoses', array('controller'=>'diagnoses','action'=>'icd_add','id'=>'diagnosesFrm',
												    	'inputDefaults' => array(
												        'label' => false,
...
?>
					<table width="100%" cellpadding="0" cellspacing="5" border="0" align="center">
                       <tr>
                            ...
                            <?php 
                            	if(isset($test_name) && !empty($test_name)){
                            		...
                            		$read_only = '';
                            		$test_name = isset($this->data['Laboratory']['name'])?$this->data['Laboratory']['name']:'';
                            	}
                            	echo $this->Form->input('Diagnoses.name', array('class' => 'textBoxExpnd validate[required,ajax[ajaxTestNameCall],custom[mandatory-enter]]','value'=>$test_name,'id' => 'name1','readonly'=>$read_only));
                            	echo $this->Form->hidden('Diagnoses.id', array('id'=>'id'));
                       ...
                       <!--   <tr>
							...
							<td  align="left"> 
								<?php 
								echo $this->Form->input('Diagnoses.test_group_id',
                       ...
                       <tr>
						...
						<td  align="left"  > 
							<?php
								echo $this->Form->input('Diagnoses.service_group_id',
					...
					<tr>
						...
						<td  align="left"  >
							<?php 
									...
									echo $this->Form->input('Diagnoses.tariff_list_id', array('options'=>$tariffList,'label'=>false,'style'=>'width:64%;', 
                      	...
                      	<tr>
                                ...
                                <td width="50%" align="right">
                                	...
                                	<?php
                                		...
                                		echo $this->Html->link(__('Cancel'), array('action' => 'search_icd'), array('escape' => false,'class' => 'grayBtn'));
                                	?>
                                </td>
                            </tr>
                      </table>  
