...
<?php
 	echo $this->Html->link(__('Laboratory Sub Speciality', true),array('action' => 'view_groups'), array('admin'=>true,'escape' => false,'class'=>'blueBtn'));
 		echo $this->Html->link(__('Add Diagnoses', true),array('controller' => 'diagnoses','action' => 'add'), array('admin'=>true,'escape' => false,'class'=>'blueBtn'));
...
?>
  ...
  <table border="0">
	<tr id="tariff-opt-area">
		<?php       echo $this->Form->create('',array('url'=>array('action'=>'icd', 'admin' => true), 'id'=>'labfrm','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false
		)));
		?>
		<td align="left" ><?php echo $this->Form->input('', array('name'=>'sctName','type'=>'text','id' => 'lab_name','style'=>'width:150px;','autocomplete'=>'off')); ?></td>
		<td align="left"><?php echo $this->Form->submit('Search', array('div'=>false,'label'=>false,'error'=>false,'class'=>'blueBtn'));?></td>
		<td><?php echo $this->Html->link($this->Html->image('icons/refresh-icon.png'),array('action'=>'icd', 'admin' => true),array('escape'=>false, 'title' => 'refresh'));?></td>
  ...
  ?>
   ...
   <td>
	   <?php 
			...
			echo $this->Html->link($this->Html->image('icons/edit-icon.png'), array('action' => 'edit', $data['SnomedMappingMaster']['id']), 
				array('escape' => false,'title' => 'Edit', 'alt'=>'Edit'));
			echo $this->Html->link($this->Html->image('icons/'.$imgSrc), array('action' => 'change_status', $data['SnomedMappingMaster']['id'],$status), 
			...
			echo $this->Html->link($this->Html->image('icons/delete-icon.png'), array('action' => 'delete', $data['SnomedMappingMaster']['id']), 
...
<script>
$("#lab_name").autocomplete("<?php echo $this->Html->url(array("controller" => "app", "action" => "testcomplete","SnomedMappingMaster",'id',"sctName",'null',"admin" => false,"plugin"=>false)); ?>", {
	width: 250,
	selectFirst: true,
