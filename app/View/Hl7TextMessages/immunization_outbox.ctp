...
<div class="inner_title" >
	...
	<span style="margin-right: 962px;margin-bottom: 5px;" class="inner_t" >
		<?php echo __(' Outbox'); ?>
...
<table class="table_first" width="100%"  cellspacing='0' cellpadding='0'>
	<tr>
		<td valign="top" width="5%">
				...
				<?php echo $this->element('mailbox_immunization');?>
			</div>
		</td>
...
<!-- 			</div> -->
			...
			<td class="row_format is_read" id="from_<?php echo $messageId;?>"><a href="#" onclick="openMessage('<?php echo $messageId; ?>','<?php echo $isPatient; ?>')"><?php echo $message['Hl7Message']['patient_id']; ?></a></td>
			   ...
			   <td class="row_format is_read" id="time_<?php echo $messageId;?>"><a href="#" onclick="openMessage('<?php echo $messageId; ?>','<?php echo $isPatient; ?>')"><?php echo 
			                   	  	  	$this->DateFormat->formatDate2LocalForReport($message['Hl7Message']['create_time'],Configure::read('date_format'),true); ?></a></td>
			<?php }else{ ?>
			<td class="row_format is_read" id="from_<?php echo $messageId;?>"><a href="#" onclick="openMessage('<?php echo $messageId; ?>','<?php echo $isPatient; ?>')"><?php echo $message['Hl7Message']['patient_id']; ?></a></td>
			   <td class="row_format is_read" id="subject_<?php echo $messageId;?>"><a href="#" onclick="openMessage('<?php echo $messageId; ?>','<?php echo $isPatient; ?>')"><?php 
			   echo substr($message['Hl7Message']['message'], 0, 40);
			...
			<table><tr><td><a href="#" onclick="goToTop()"><?php echo  __('Go to top'); ?>
									</a></td></tr></table>
			<!-- 
...
<script>
var getMessageUrl = "<?php echo $this->Html->url(array("controller" => "Hl7TextMessages", "action" => "openImmunizationOutboxMessage","admin" => false)); ?>";
