...
<div class="inner_title" >
	...
	<span style="margin-right: 970px;margin-bottom: 5px;" class="inner_t" >
		<?php echo __(' Outbox'); ?>
...
<script>
var getMessageUrl = "<?php echo $this->Html->url(array("controller" => "Hl7TextMessages", "action" => "openAdtOutboxMessage","admin" => false)); ?>";
