 <div class="inner_title">
                      <h3>Store Requisition Slip - View</h3>
                      <span><?php  echo $this->Html->link(__('Back'), array('action' => 'store_requisition_list'), array('escape' => false,'class'=>"blueBtn"));?></span>
 </div>
 <?php
           ...
           <!-- billing activity form start here -->
                   ...
                   <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tabularForm">
                      <tr>
                      		<th colspan="5">STORE REQUISITION &amp; RETURNED SLIP</th>
                      </tr>
                       <tr>
                       <td width="200px">Requisition For:</td>
					   	<td><?php
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0" class="tabularForm" id="tabularForm">
                      <tr>
                            ...
                            <th width="110" align="center">Issue Quantity</th>
                            <th width="110" align="center">Used Quantity</th>
                            <th width="110" align="center">Retuned Quantity</th>
                        	<th width="100" align="center">Remark</th>
                        	<th width="100" align="center">Return Remark</th>                       	
					 ...
					 ?>
                      <tr id="row<?php echo $i;?>">
                        <td> <?php echo $value['StoreRequisitionParticular']['item_name'];?> </td>
                        ...
                        <td> <?php echo $value['StoreRequisitionParticular']['used_qty'];?> </td>
                        <td> <?php echo $value['StoreRequisitionParticular']['returned_qty'];?> </td>
                        <td> <?php echo $value['StoreRequisitionParticular']['remark'];?> </td>
                        <td> <?php echo $value['StoreRequisitionParticular']['return_remark'];?> </td>
                      <?php
					   if($i>1){
					   ?>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="tdLabel2" style="border:1px solid #3E474A; padding:10px;">
                    	<tr>
                       	  <td width="250" align="left" valign="top">
                                ...
                                <tr>
                                  <td height="22" colspan="2" valign="top"><b>Requisition By : </b></td>
                                  </tr>
                                  <tr>
                          ...
                          <td width="30">&nbsp;</td>
                            <td width="250" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr> 
                                <td height="22" colspan="2" valign="top"><b> Issue By : </b></td>
                              </tr>
                              <tr>
                                <td width="60" height="25">Name</td>
                          ...
                          <td width="30">&nbsp;</td>
                            <td width="250" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="22" colspan="2" valign="top"> <b>Entered By : </b></td>
                              </tr>
                              <tr>
                                <td width="60" height="25">Name</td>
