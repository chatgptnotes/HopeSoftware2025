...
<div class="container-fluid ">
	...
	<a class="btn btn-primary custom-btn" href="<?php echo $this->Html->url(array('controller' => 'Appointments', 'action' => 'marketing')); ?>"class="font-weight-bold">Marketing Visit Records</a>
    <!-- Filter Section -->
    <div class="row mb-3">
        <div class="col-md-6">
