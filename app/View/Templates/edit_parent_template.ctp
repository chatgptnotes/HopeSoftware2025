...
<div class="inner_title">
	<h3>
		<?php echo __('Edit Parent Category', true); ?>
	 </h3>
	<span> <div style="float:right;"> <?php
			
			echo $this->Html->link(__('Back', true),array('controller' => 'Templates', 'action' => 'sortParentCategory'), array('escape' => false,'class'=>'blueBtn'));
			?>
			</div>
			</span>
</div>
...
<?php } ?>
	...
	<?php 
		echo $this->Form->create('templatecategoryfrm',array('id'=>'templatecategoryfrm','url'=>array('controller'=>'Templates',"action" => "editParentTemplate",$id,$template_category_id),'inputDefaults'=>array('div'=>false,'label'=>false,)));
	?>
	<table border="0" class="table_format" cellpadding="0" cellspacing="0"
		...
		<tr>
			...
			echo $this->Form->hidden('Template.template_category_id',array('value'=>$template_category_id));
		...
		<tr>
			...
			<td><?php 
				echo $this->Form->input('Template.note_template_id',array('options'=>$notesTemplate)); 
			?>
			</td>
		</tr>
		<tr>
