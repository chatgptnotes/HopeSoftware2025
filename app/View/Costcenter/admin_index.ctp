<div class="inner_title">
	<h3>
		<?php echo __('Cost Center Management', true); ?>
	</h3>

	<span> <?php 
	echo $this->Html->link(__('Add Cost Center', true),array('action' => 'add'), array('escape' => false,'class'=>'blueBtn'));
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0"
	...
	<tr class="row_title">
		<td class="table_cell"><strong><?php echo ( __('Id', true)); ?> </strong>
		</td>

		<td class="table_cell"><strong><?php echo (__('Specialty', true)); ?> </strong>
		</td>
		<td class="table_cell"><strong><?php echo (__('Effective Date', true)); ?>
		</strong></td>

		<td class="table_cell"><strong><?php echo (__('Is Active', true)); ?>
		</strong></td>
	...
	<tr <?php if($cnt%2 == 0) echo "class='row_gray'"; ?>>
		...
		<td class="row_format"><?php echo "Radiolgy"; ?>
		</td>
		<td class="row_format"><?php echo "10/05/2013"; ?>
		</td>
		<td class="row_format"><?php echo "No"; ?>
		</td>
		<td class="row_format"><?php
		echo $this->Html->image('icons/view-icon.png');
		echo $this->Html->link($this->Html->image('icons/edit-icon.png'), array('action' => 'admin_edit'), array('escape' => false,'title' => 'Edit', 'alt'=>'Edit'));

		//echo $this->Html->image('icons/edit-icon.png');
		echo $this->Html->image('icons/delete-icon.png');?></td>
		<!-- <td>
   <?php 
   ...
   ?>-->
	...
	<tr <?php if($cnt%2 == 0) echo "class='row_gray'"; ?>>
		<td class="row_format"><?php echo '2'; ?></td>

		<td class="row_format"><?php echo "Pharmacy"; ?>
		</td>
		<td class="row_format"><?php echo "10/23/2013"; ?>
		</td>
		<td class="row_format"><?php echo "No"; ?>
		</td>
		<td class="row_format"><?php
   ...
   ?>-->
	...
	<tr>
		<TD colspan="8" align="center">
			...
			<!-- Shows the next and previous links --> <?php //echo $this->Paginator->prev(__('« Previous', true), null, null, array('class' => 'disabled')); ?>
