...
<!-- 	   <tr>
		...
		<tr>
			...
			<?php if( isset($data['Patient']['id'])){	?>
				<table width="90%" border="0" cellspacing="0" cellpadding="0" 	style="float: left">
					<tr>
						<td width = "50px"></td>
						<td width="70px" class="" style="text-align: left;font-size: 13px;"><?php echo "Prescribed by : "; ?></td>
						<td width="10"></td>
					...
					<tr>
						<td width = "50px"></td>
						<td width="70px" class="" style="text-align: left;font-size: 13px;"><?php echo "Patient Name : "; ?></td>
						<td></td>
					...
					<tr>
					    <td width = "50px"></td>
					    <td width="70px" class="" style="text-align: left;font-size: 13px;"><?php echo "Patient Type : "; ?></td>
						<td></td>
					...
					<tr>
						<td width = "50px"></td>
						<td width="70px" class="" style="text-align: left;font-size: 13px;"><?php echo __("Ward/Room Type: "); ?></td>
						<td></td>
			...
			<table width="90%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="10"></td>
					<td class="" style="font-size: 13px;"><?php echo $data['PharmacySalesBill']['customer_name'];?></td>

				</tr>
				<tr>
					<td width="120">Prescribed by  : </td>
					<td width="10"></td>
					<td class="" style="font-size: 13px;"><?php echo $data['PharmacySalesBill']['p_doctname'];?></td>
		...
		<!-- 	<table><tr><td height="15px"></td></tr></table> -->
			...
			<table width="90%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="50%" class="" style="text-align: left;font-size: 13px;"><?php  if(strtolower($data['PharmacySalesBill']['payment_mode'])== 'cash'){ /* Sales Bill Receipt No. */
					        echo "CASH MEMO NO."; }else{
						    echo "CREDIT MEMO NO.";
					}?></td>
					<td width="10%">:</td>
					<td class="" style="font-size: 13px;"><?php echo $data['PharmacySalesBill']['bill_code'];?></td>
				</tr>
				<tr>
	...
	<table width="100%" style="padding-top:6px;">
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				style="float: left">
				<tr>
					<td width="70px" class="lableFont"><?php echo "$nbsp"; ?></td>
					<td width="10"></td>
					<td class="lableFont"><?php echo "Dr. ".$data['DoctorProfile']['doctor_name'];?></td>
				</tr>
				<tr>
					<td width="70" class="lableFont"><?php echo "$nbsp"; ?></td>
					<td></td>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td width="70px" class="lableFont"><?php echo "$nbsp"; ?></td>
							<td width="10"></td>
							<td class="lableFont"><?php echo "Dr. ".$data['PharmacySalesBill']['p_doctname'];?></td>
						</tr>
						<tr>
							<td width="70" class="lableFont"><?php echo "$nbsp"; ?></td>
							<td></td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="30" class="lableFont"><?php echo "$nbsp"; ?></td>
					<td width="10"></td>
					<td class="lableFont"><?php  echo ($data['PharmacySalesBill']['bill_code'])?$data['PharmacySalesBill']['bill_code']:$data['PharmacyDuplicateSalesBill']['bill_code'];?></td>
				</tr>
				<tr>
					<td class="lableFont"><?php echo "&nbsp"; ?></td>
					<td></td>
					<td class="lableFont"><?php 
				/*if($data['PharmacySalesBill']['modified_time']){
					echo $this->DateFormat->formatDate2Local($data['PharmacySalesBill']['modified_time'],Configure::read('date_format'),true);
				}else*/
				if($data['PharmacySalesBill']['create_time']){ 
					echo $this->DateFormat->formatDate2Local($data['PharmacySalesBill']['create_time'],Configure::read('date_format'),false);
				...
				<tr>
					...
					<td class="lableFont"><?php 
						if($data['PharmacySalesBill']['payment_mode']){	
							echo ucfirst($data['PharmacySalesBill']['payment_mode']);
						}else{
