...
?>
 <form action='<?php echo $this->Html->url(array('action' => 'pharmacy_details','direct_return','search'));?>'>
<table border="0" class="table_format"  cellpadding="0" cellspacing="0" width="100%" style="text-align:center;">
   <tr>
      ...
      <td></td>
      <td align="right"><?php echo $this->Html->link($this->Html->image('icons/refresh-icon.png'),array('action' => 'pharmacy_details','direct_return'), array('escape' => false)); ?>
   </tr>
