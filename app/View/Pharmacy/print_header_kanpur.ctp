...
<div>
	     <table width='100%' align="center"  border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px">
	       <tr>
	         <td width='25%'>&nbsp;</td>
	   ...
	   <table  width='100%' align="center"  border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px;padding-bottom: 15px">
	       <tr><td height="25px">&nbsp;</td></tr>
	       <tr>
	         <td colspan="2" align="center" style="text-align: center;" class="boxBorderBotSolid">
	           <img src="<?php echo $this->Html->url('/img/pharmacy_header.png'); ?>" alt="Hope Hospital Pharmacy Header" style="width: 100%; max-width: 100%; height: auto;" />
	         </td>
	       </tr>
	   </table> 
</div>
