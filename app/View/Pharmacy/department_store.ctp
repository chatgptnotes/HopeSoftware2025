...
<ul
	...
	<li>  <?php echo $this->Html->link($this->Html->image('/img/icons/add_manufacturer.png', array('alt' => 'Manufacturers')),array('controller'=>'Store','action' => 'manufacturingCompany'), array('escape' => false)); ?>
 	...
 	<li>  <?php echo $this->Html->link($this->Html->image('/img/icons/store-requisition-issue-slip.jpg', array('alt' => 'Sales Return')),array('controller'=>'InventoryCategories',"action" => "store_requisition_list",'plugin' => false), array('escape' => false)); ?>
