<?php 
  if($this->Session->read('website.instance')=="kanpur" || $this->Session->read('website.instance')=="vadodara" ) 
   { ?>
<tr>
	<td width="100%" valign="top" style="border-right: 0px solid #333333; padding: 8px 5px;">
	<?php //debug($data);?>
	<?php if( isset($data['InventoryPharmacySalesReturn']['customer_name'])){	?>
	<table width="100%">
		<tr>
			<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td width="130" class="lableFont" style="text-align: right;"><?php echo "Date : "; ?></td>
					<td></td>
		...
		<!-- 		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="100" class="lableFont" style="text-align: left;"><?php echo "Return Reciept No."; ?></td>
					<td width="10">:</td>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="10"></td>
					<td class="lableFont"><?php //echo $data['PharmacySalesBill']['bill_code'];?></td>
				</tr>
				<tr>
					<td class="lableFont"><?php echo "&nbsp"; ?></td>
					<td></td>
