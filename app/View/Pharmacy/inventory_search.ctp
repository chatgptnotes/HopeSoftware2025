...
?>
<form accept-charset="utf-8" method="get" id="inventory_search" action="">
...
<div class="inner_title">
 ...
 <h3> &nbsp; <?php echo __('Pharmacy Management - Supplier List', true); ?></h3>
	<span >
	<?php 
	echo $this->Html->link(__('Add Supplier'), array('action' => 'add_supplier'), array('escape' => false,'class'=>'blueBtn'));
	echo $this->Html->link(__('Back'), array('action' => 'supplier_list'), array('escape' => false,'class'=>'blueBtn'));
...
<table border="0" class="table_format"  cellpadding="0" cellspacing="0" width="100%" >
	<tbody>
		...
		<tr class="row_title">				 
			...
			<td><label style="width:106px;">Supplier Code :</label></td>
			<td>											 
		    	<?php 
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="100%" style="text-align:center;">
  ...
  <tr class="row_title">
   ...
   <td class="table_cell"><strong><?php echo  __('Supplier Name', true) ; //echo $this->Paginator->sort('hasspecility', __('Item Name', true)); ?></th>

    <td class="table_cell"><strong><?php echo __('Supplier Code', true); //echo $this->Paginator->sort('is_active', __('Pack', true)); ?></td>
   <td class="table_cell"><strong><?php echo __('DL No.', true); ?></td>
   <td class="table_cell"><strong><?php echo __('CST No.', true); ?></td>
   <td class="table_cell"><strong><?php echo __('S.Tax No.', true); ?></td>
   <td class="table_cell"><strong><?php echo __('Phone', true); ?></td>
  ...
  <td class="row_format"><?php echo $supplier['InventorySupplier']['dl_no']; ?> </td>
  <td class="row_format"><?php echo $supplier['InventorySupplier']['stax_no']; ?> </td>
  <td class="row_format"><?php echo $supplier['InventorySupplier']['cst']; ?> </td>
    <td class="row_format"><?php echo $supplier['InventorySupplier']['phone']; ?> </td>
   <td>
   <?php 
