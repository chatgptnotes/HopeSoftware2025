...
<?php } ?>
 <div class="inner_title">
    <h3> &nbsp; <?php echo __('Specialty Management -Add Outward', true); ?></h3>
    <span><?php
...
<div class="clr ht5"></div>
                     ...
                     Date<font color="red">*</font>:&nbsp;<input type="text" id="date" name="date" class="validate[required]" >
	               </div>
<div class="clr ht5"></div>
<div class="clr ht5"></div>
  <div class="clr ht5"></div>
                   <table width="100%" cellpadding="0" cellspacing="1" border="0" class="tabularForm" id="item-row">
                  	<tr>
                          ...
                          <th width="120" align="center" valign="top"  style="text-align:center;">Product Name<font color="red">*</font></th>
                          <th width="112" align="center" valign="top"  style="text-align:center;">Product Code<font color="red">*</font></th>
                          ...
                          <th width="60" valign="top" style="text-align:center;">Outward<font color="red">*</font></th>
                          <th width="1"></th>
                     	</tr>

                        <tr id="row1">
                          <td align="center" valign="middle" class="sr_number" width="20">1</td>
                          <td align="center" valign="middle" width="200">
                                <input name="item_name[]" id="item_name1" type="text" class="textBoxExpnd validate[required] item_name"  tabindex="6" value="" style="width:65%;"  fieldNo='1' onkeyup="checkIsItemRemoved(this)"/>
						  <input name="item_id[]" id="item_id1" type="hidden"   value=""/>
						  </td>
                           <td align="center" valign="middle"><input name="item_code[]" type="text" class="textBoxExpnd validate[required] item_code" id="item_code1" tabindex="1" value="" style="width:80%;" fieldNo="1" onkeyup="checkIsItemRemoved(this)"/></td>
                          <td align="center" valign="middle" id="manufacturer1" style="text-align:center;">&nbsp;</td>
                          <td align="center" valign="middle" id="pack1" style="text-align:center;">&nbsp;</td>
                          <td align="center" valign="middle" id="stock1" style="text-align:center;">&nbsp;</td>

                         <td width="60"><input name="outward[]" type="text" id="outward1" class="textBoxExpnd validate[required,custom[number]]" tabindex="9" value="" style="width:65%;" /></td>
                            </td>
...
function repeatItem(id){
	...
	jQuery("#InventoryOutwardInventoryOutwardForm").validationEngine();
	});
(function($){
