...
<div class="inner_title">
	<h3>
		&nbsp;
		<?php echo __('Pharmacy Management - Add Supplier', true); ?>
	</h3>
...
<table align="center" width="95%"  border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<td><?php 
		echo $this->Form->checkbox('InventorySupplier.is_implant',array('id'=>'is_implant','class'=>''));
		?>
		</td>
	</tr>
	<tr>
		<td class="tdLabel" id="boxSpace">Account Group</td>
		<td><?php echo $this->Form->input('InventorySuppiler.accounting_group_id',array('type'=>'select','options'=>$group,'value'=>$groupId,'class'=>'validate[required]','label'=> false, 'div' => false, 'error' => false,'empty'=>'Please Select'))?></td>
	</tr>
	</tr>
     <tr>
		<th class="tdLabel" id="boxSpace" colspan="5">Bank account details</th>
	</tr>
	<tr>
