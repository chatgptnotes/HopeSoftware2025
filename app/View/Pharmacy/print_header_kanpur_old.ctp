...
<div>
	     <table width='90%' align="center"  border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px">
	       <tr>
	         <td width='25%'>&nbsp;</td>
	         <?php if($section == "InventoryPharmacySalesReturnsDetail" || $section == "InventoryPharmacyDirectSalesReturnsDetail" || $section == 'DirectSalesReturn'){?>
	         <td  width="25%" style="color: red;font-size: 18px;text-align: center;"><u>Sales Return Receipt </u></td>
	         <?php }else{?>
	         <td  width="25%" style="color: red;font-size: 18px;text-align: center;"><u>Sales Bill Receipt </u></td>
	         <?php }?>
	         <td width="25%">&nbsp;</td>
	       </tr>
	       
	        <tr>
	         <td class="boxBorderBotSolid">&nbsp;</td>
	         <td class="boxBorderBotSolid" style="font-size: 15px;text-align: left;font-weight: bold;">TIN No. 09537518372  </td>
	         <td class="boxBorderBotSolid" style="font-size: 15px;text-align: right;font-weight: bold;">DL No. 20-175/11.21-175/11</td> 
	       </tr>
	       
	       
	     </table>      
	   <table  width='90%' align="center"  border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px;padding-bottom: 15px">       
	       <tr><td height="25px">&nbsp;</td></tr>
	       <tr> 
	         <td align="right" style="font-size: 15px; text-align: center; font-weight: bold; " class="boxBorderBotSolid"><?php echo $this->Html->image('icons/Roman_logo.png');?></td>
	         <td align="right" style="font-size: 15px; text-align: right; font-weight: bold; " valign="bottom" class="boxBorderBotSolid" >117/N/56, Avon Market, kakadeo, Kanpur&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Pin-208025 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Tel.-0512-6554229 </td>
	       </tr>
	   </table> 
</div>
...
<tr>
	...
	<table width="100%"> 
		...
		<tr>
			...
			<?php }else{ ?>
					<?php if ($section == "InventoryPharmacyDirectSalesReturnsDetail" || $section == "PharmacySalesBill"){
						$doctorName = $data['PharmacySalesBill']['p_doctname'];
						$patientName = $data['PharmacySalesBill']['customer_name'];
					}else if($section == "DirectSalesReturn"){
						$doctorName = $data['InventoryPharmacySalesReturn']['doctor_name'];
						$patientName = $data['InventoryPharmacySalesReturn']['customer_name'];
					}
						?>
			<table align="center"  width="90%" border="0" cellspacing="0" cellpadding="0" 	style="float: left">
					<tr>
						<td width="130px" class="" style="text-align: left;font-size: 13px;"><?php echo "Doctor Name : "; ?></td>
						<td class="" style="font-size: 13px;">
						<?php echo  $doctorName ;?></td> 
					</tr>
					<tr> 
						<td width="130" class="" style="text-align: left;font-size: 13px;"><?php echo "Patient Name : "; ?></td>
						<td class="" style="font-size: 13px;"><?php echo $patientName;?></td>
					</tr> 
				</table> 
			<?php
			}
			...
			<table width="90%" border="0" cellspacing="0" cellpadding="0" border="0">
				<tr>
				  ...
				  <?php }else{?>
					...
					<td width="50%" style="text-align: right; font-size: 13px;"><?php  if($data['PharmacySalesBill']['payment_mode']=='Cash'){ /* Sales Bill Receipt No. */
					        echo "CASH MEMO NO."; 
					        echo "&nbsp : &nbsp";
				...
				<?php if($data['PharmacySalesBill']['by_nurse'] == 1){ ?>
				<tr>
						<td width="50%" class="" style="text-align: left;font-size: 13px;"><?php echo __("Bed No: ");
						echo "&nbsp : &nbsp";
