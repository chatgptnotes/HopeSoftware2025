...
<div>	<!--  <div align="right" id="printBtn"><a class="blueBtn" href="#" onclick="this.style.display='none';window.print();">Print</a></div> -->
...
<table width="800">
	...
	<table align="center" border="0">
		<tr>
	         <?php if($section == "InventoryPharmacySalesReturnsDetail"){?>
	         <td style="color: red;font-size: 18px;text-align: center;"><u>Sales Return Receipt </u></td>
	         <?php }else{?>
	         <td style="color: red;font-size: 18px;text-align: center;"><u>Sales Bill Receipt </u></td>
	         <?php }?> 
		</tr>
	</table>	
<?php } ?>
		...
		<!-- 		 <tr style="height: 30px;">
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px">
					     <tr>
					      ...
					      <td width="18%" class="boxBorderBot boxBorderRight boxBorderTop" style="text-align: center ;">DESCRIPTION</td>
		 ...
		 <?php }//EOF counter 10 ?>		
			...
			<tr>
				...
				<td valign="top" class="boxBorderRight"
					style="font-size: 14px;font-weight: 600;text-align: center; "><?php echo $productName; ?>&nbsp;</td>
				<td valign="top" class="boxBorderRight"
				...
				<td valign="top" class="boxBorderRight"
					...
					<?php echo number_format($price/$pack,2); ?>
				</td>
	  	...
	  	<tr>
			...
			?>
		     ...
		     <tr>
		       ...
		       <td width="250"><?php    
		       if($section == "InventoryPharmacyDirectSalesReturnsDetail" || $section == "InventoryPharmacySalesReturnsDetail"){ 
			...
			?>
				<?php
					//echo $this->Number->currency(($item['PharmacySalesBill']['total']));
					//echo $this->Number->currency($grandtotal);
				    echo $this->Number->currency(round($grandtotal - $discount + $totalTax));	//round by Swapnil
				?></td>
		     </tr> 
