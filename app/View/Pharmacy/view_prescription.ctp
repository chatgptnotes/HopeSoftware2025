	...
	<tr>
		<td valign="top">
			<table width="390" border="0" cellspacing="" cellpadding="0"
				align="center">
				<tr>
					<td width="20px" valign="top"><div style="float: left"><?php echo  $this->Html->image('Nabh_sm.jpeg',array('width'=>120,'height'=>60)) ;?>
						</div> 
					</td>
					<td style="text-align: center;font-size: 16px;"><strong><u><?php echo 'Prescription'; ?></u></strong></td>
					<td width="20px">
						<div style="float: right">
							<?php echo  $this->Html->image('hope_logo.jpeg',array('width'=>120,'height'=>60)) ;?>
						</div>
					</td>
