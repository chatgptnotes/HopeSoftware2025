...
<h3>&nbsp; <?php echo __('Pharmacy Current Stock Reports', true); ?></h3>
<span><?php
...
<br />
 <form name="reportfrm" id="reportfrm" action="<?php echo $this->Html->url(array("controller" => $this->params['controller'], "action" => "admin_pharmacy_current_stock_reports/", )); ?>" method="post" >
 <table align="center"> 
 	<tr>
	...
	<tr>
	 <td colspan="8" align="right"><?php echo __('Empty Stock'); ?></td>
	 <td><b>:</b></td>
	 <td colspan="8" align="left">
	  <?php 
             echo $this->Form->checkbox('PharmacySale.empty_stock', array('id'=>'show_item','label'=> false, 'div' => false, 'error' => false));
          ?>
	 </td>
	</tr>
	<tr>
	 <td colspan="8" align="right"><?php echo __('Expired Product'); ?></td>
	 <td><b>:</b></td>
	 <td colspan="8" align="left">
	  <?php 
             echo $this->Form->checkbox('PharmacySale.expired_product', array('id'=>'expired_product','label'=> false, 'div' => false, 'error' => false));
          ?>
	 </td>
	</tr>
 </table>
