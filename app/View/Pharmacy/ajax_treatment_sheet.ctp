...
.tdDeco{
    background-color:#4279E1 !important; color: #fff !important;"
}
.tdwhite{
...
<section style="width: 100%; margin: 0 auto;">
    ...
    echo $this->Form->hidden('patient_id',array('value'=>$patientData['Patient']['id'],'id'=>'patientId'));  ?>
  <!--   <table>
        <tr>
        ...
        <tr>
            <td width="7%" valign="top" style="">
                 <div class="left-menu" style="clear: both;">
                    ...
                    <?php if(!empty($dateListing)){ //debug($dateListing);
                        ...
                        foreach($dateListing as $key => $val){ 
                            ...
                            if(in_array($val,$dateChangeForamt)){
                                $style="style=background-color:#4279E1";
                            }else{
                                $style="";
                            }
                            echo "<li ".$style." class='dateList".$cls."' id='dateList_".$key."'><a href='javascript:void(0);'>".$val."</a></li>";
                        }
                    } ?>
                    </ul>
                </div>
            ...
            <td width="92%" valign="top" id="content-list" class="right">
                ...
                <?php if(!empty($activeDate)) { ?>
                    ...
                    <table width="100%" class="tabularForm">
                        <thead>
                            <tr>
                                <td align="left" width="2%" class="tdDeco"><?php echo __("#"); ?></td>
                                <td align="left" width="30%" class="tdDeco"><?php echo __("Drug Name"); ?><font color="red">*</font></td>
                                 <td align="left" width="30%" class="tdDeco"></td>
                                <td align="center" width="10%" class="tdDeco"><?php echo __("Dosage"); ?></td> 
                                <td align="center" width="15%" class="tdDeco"><?php echo __("Route"); ?></td>
                                <td align="right" width="10%" class="tdDeco"><?php echo __("Qty"); ?><font color="red">*</font></td> 
                                <td align="right" width="10%" class="tdDeco"><?php echo __("Stock"); ?></td>  
                                <td align="right" width="10%" class="tdDeco"><?php echo __("MRP"); ?></td> 
                                <td align="right" width="10%" class="tdDeco"><?php echo __("Amount"); ?></td>  
                                <td align="left" width="5%" class="tdDeco">#</td> 
                            </tr>
                        </thead>
                        <tbody id="prescribeTable" >
                            <tr class="row" id="row_1">
                                <td class="tdwhite"><?php echo $this->Form->input('',array('type'=>'checkbox','div'=>false,'label'=>false,'name'=>"data[TreatmentMedicationDetail][1][is_show]",'title'=>'check to show in treatment sheet','hiddenField'=>false,'value'=>'0','onclick'=>"if(this.checked){ $(this).val(1); }else{ $(this).val(0); }")); ?></td>
                                <td class="tdwhite"><?php echo $this->Form->input('',array('type'=>'text','div'=>false,'label'=>false,'class'=>'item validate[required,custom[mandatory-enter]]','id'=>'item_1','name'=>"data[TreatmentMedicationDetail][1][item_name]",'style'=>'width:100%')); 
                                          ...
                                          echo $this->Form->hidden('',array('id'=>'pack','class'=>'pack','value'=>'','name'=>"data[TreatmentMedicationDetail][1][pack]")); ?></td>
                                ...
                                <td class="tdwhite"><?php echo $this->Form->input('',array('type'=>'text','div'=>false,'label'=>false,'class'=>'routes','id'=>'routes_1','name'=>"data[TreatmentMedicationDetail][1][routes]",'style'=>'width:100%')); ?></td> 
                                <td class="tdwhite"><?php echo $this->Form->input('',array('type'=>'select','div'=>false,'label'=>false,'class'=>'dosage','id'=>'dosage_1','name'=>"data[TreatmentMedicationDetail][1][dosage]",'style'=>'width:100%','empty'=>'Select','options'=>Configure :: read('route_administration'))); ?></td>  
                                <td class="tdwhite"><?php echo $this->Form->input('',array('type'=>'text','div'=>false,'label'=>false,'class'=>'quantity validate[required,custom[mandatory-enter]]','id'=>'quantity_1','name'=>"data[TreatmentMedicationDetail][1][quantity]",'style'=>'width:100%')); ?></td> 
                                <td align="right" class="stock tdwhite" id="stock_1"></td> 
                                <td align="right" class="dispMrp tdwhite" id="dispMrp_1"></td> 
                                <td align="right" class="amount tdwhite" id="amount_1"></td> 
                                <td class="tdwhite"><?php echo $this->Html->link($this->Html->image("/img/icons/cross.png",array("align"=>"right","title"=>"Remove","alt"=>"Remove","class"=>"icd_eraser")),"javascript:void(0);",array('class'=>'removeBtn','id'=>'removeBtn_1','escape'=>false)); ?></td> 
                            </tr>
                        </tbody>
                        <tbody>
                            <tr>
                                <td colspan="7" align="right" class="tdwhite">
                                    <?php echo __('Total'); ?>
                                </td>
                                <td id="total_amount" align="right" class="tdwhite"></td>
                                <td class="tdwhite"></td>
                            </tr>
                        </tbody>
                        <tbody>
                            <tr>
                                <td colspan="9" align="left" class="tdwhite">
                                    <div style="float: left;"><input type="button" id="addButton" value="Add Row"></div>
                                    <div style="float: right;"><input type="button" id="submitBtn" class="blueBtn" value="Submit"></div>
                                </td> 
                            </tr>
                        </tbody>
                    </table>
                		...
                		<td width="49%" valign="top">
			                ...
			                <?php //foreach($treatmentData as $sKey => $sVal) { ?>
			                    <table width="100%" class="tabularForm" style="margin-top: 15px;">
			                        ...
			                        <thead>
			                            <tr>
			                                <td align="left" width="" class="tdDeco"><?php echo __("Sr.No"); ?></td>
			                                <td align="left" width="" class="tdDeco"><?php echo __("Drug Name"); ?></td>
			                                <td align="center" width="" class="tdDeco"><?php echo __("Route"); ?></td> 
			                                <td align="center" width="" class="tdDeco"><?php echo __("Dosage"); ?></td>
			                                <td align="center" width="" class="tdDeco"><?php echo __("Quantity"); ?></td> 
			                            </tr>
			                        </thead>
			                        <tbody>
			                            <?php $cnt =1; foreach ($treatmentData as $key => $value) { ?>
			                            <tr>
			                                <td align="center" class="tdwhite"><?php echo $cnt++; ?></td>
			                                <td align="left" class="tdwhite"><?php echo $value['PharmacyItem']['name']; ?></td>
			                                <td align="center" class="tdwhite"><?php echo $value['TreatmentMedicationDetail']['routes']; ?></td>
			                                <td align="center" class="tdwhite"><?php echo $dosage[$value['TreatmentMedicationDetail']['dosage']]; ?></td>
			                                <td align="center" class="tdwhite"><?php echo $value['TreatmentMedicationDetail']['quantity']; ?></td>
			                            </tr>
			                            <?php } ?>
			                            <tr>
			                            	<td colspan="5" align="right" class="tdwhite">
    ...
    $(document).ready(function(){ 
        ...
        $(".dateList").click(function (event) {
          ...
          //  window.location.href = ("<?php echo $this->Html->url(array('action'=>'treatmentSheet')); ?>"+"/"+$("#patientId").val()+"/"+id);
            ...
            var ajaxUrl = "<?php echo $this->Html->url(array("controller" => "Pharmacy", "action" => "ajaxTreatmentSheet","admin" => false)); ?>"+"/"+$("#patientId").val()+"/"+id;
            $.ajax({
                beforeSend : function() {},
                type: 'POST',
                url: ajaxUrl,
...
//        }
    ...
    $("#addButton").on('click',function(event){
        ...
        var field = '';
            ...
            field +=    "</td>";
             ...
             field += '<td style="padding:0px;"> <input type="hidden" name="genericName" id="genericName'+counter+'" class="genericName" value="" fieldNo="'+counter+'"/> <a href="javascript:void(0);" style="padding: 0px;" id="Generic" onclick="showGeneric('+counter+');"><?php echo $this->Html->image('icons/generic.png', array('title' => 'Generic', 'alt' => 'Generic', 'class' => 'showGeneric')); ?></a></td>';
            field +=    "<td>";
    ...
    $("#submitBtn").click(function(){ 
        ...
        blurElement('#content-list',1);
        var ajaxUrl = "<?php echo $this->Html->url(array("controller" => "Pharmacy", "action" => "ajaxTreatmentSheet","admin" => false)); ?>"+"/"+$("#patientId").val();
            var formData = $('#treatMentSheet').serialize();
            $.ajax({
                beforeSend : function() {},
                type: 'POST',
                url: ajaxUrl,
