...
<form name="optitemfrm" id="optitemfrm"
	action="<?php echo $this->Html->url(array("action" => "edit", $this->request->data['OtItem']['id'])); ?>"
	method="post">
	<?php 
	...
	<table border="0" class="table_format" cellpadding="0" cellspacing="0"
		...
		<tr>
			...
			<td><?php 
			echo $this->Form->input('OtItem.name', array('class' => 'validate[required,custom[name]]','id' => 'pharmacy_item', 'label'=> false, 'div' => false, 'error' => false, 'value' => $this->request->data['PharmacyItem']['name']));
			?>
