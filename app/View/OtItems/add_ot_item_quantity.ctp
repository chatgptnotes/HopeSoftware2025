<div class="inner_title">
 <h3><?php echo __('Add OR Item Quantity', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="optitemquantityfrm" id="optitemquantityfrm" action="<?php echo $this->Html->url(array("action" => "add_ot_item_quantity")); ?>" method="post" >
