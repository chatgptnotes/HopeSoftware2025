...
<div class="inner_title">
	<h3>
		&nbsp;
		<?php echo __('Over Due Rad Test Results', true); ?>
	</h3>
</div>
<div class="clr">&nbsp;</div>
<?php echo $this->Form->create('',array('action'=>'radOverdueTestReport','type'=>'get','id'=>'radOverdueTestReportForm',
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0"
	...
	</td> <?php $labTime = substr($this->DateFormat->formatDate2LocalForReport($labs['RadiologyTestOrder']['create_time'],Configure::read('date_format'),true),-9); ?>
...
$(function() {
	 	$("#radOverdueTestReportForm").validationEngine({
