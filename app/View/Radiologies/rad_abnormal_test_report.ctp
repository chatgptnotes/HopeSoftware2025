<?php $this->request->data['Rad'] = $this->request->query;?>
<div class="inner_title">
	<h3>
		&nbsp;
		<?php echo __('Abnormal Rad Test Results', true); ?>
	</h3>
</div>
<div class="clr">&nbsp;</div>
<?php echo $this->Form->create('',array('action'=>'radAbnormalTestReport','type'=>'get','id'=>'radAbnormalTestReportForm',
...
<table border="0" class="table_format_body" cellpadding="0"
	...
	<tr class="row_title">
		...
		<td class="table_cell"><strong><?php echo $this->Form->input('Rad.from_date', array('type'=>'text','class' => 'date validate[required,custom[mandatory-date]] textBoxExpnd','id' => 'from_date'));?>
		</strong>
		</td>
		<td id="boxSpace" class="tdLabel" width="10%" valign="middle"><?php echo __("To Date");?>
			<font color="red">*</font>
		</td>
		<td class="table_cell" colspan="3"><strong><?php echo $this->Form->input('Rad.to_date', array('type'=>'text','class' => 'date validate[required,custom[mandatory-date]] textBoxExpnd','id' => 'to_date'));?>
		</strong>
		</td>
		<td id="boxSpace" class="tdLabel" width="10%" valign="middle"><?php echo __("Patient Name");?>
		</td>
		<td class="table_cell" colspan="3"><strong><?php echo $this->Form->input('Rad.lookup_name', array('type'=>'text','class' => 'textBoxExpnd','id' =>'lookup_name'));?>
		</strong> <?php echo $this->Form->hidden('Rad.patient_id',array('id'=>'patient_id'));?>
		</td>
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0"
	...
	<?php $labTime = substr($this->DateFormat->formatDate2LocalForReport($labs['RadiologyTestOrder']['create_time'],Configure::read('date_format'),true),-9); ?>
	<td class="tdLabel" align="left"><?php echo $this->DateFormat->formatDate2Local($labs['RadiologyTestOrder']['start_date'],Configure::read('date_format'),false).' '.$labTime; ?>
	</td>
	<td class="tdLabel" align="left"><?php echo $this->DateFormat->formatDate2Local($labs['RadiologyResult']['result_publish_date'],Configure::read('date_format'),true); ?>
	</td>
	</tr>
	<?php } ?>
	<tr>
...
$(function() {
	 	$("#radAbnormalTestReportForm").validationEngine({
