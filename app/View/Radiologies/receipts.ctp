...
<div id="search-filter">
	<?php echo $this->Form->create('Radiology',array('id'=>'patient-search','action'=>'receipts','type'=>'get','inputDefaults'=>array('label'=> false, 'div' => false, 'error' => false)));?>	
						 ...
						 <tr class="">
							...
							<td class="row_format" >
								<?php
									...
									echo $this->Html->link(__('Back'),array('action'=>'index'),array('escape'=>false,'class'=>'blueBtn','id'=>'reset'));
								?>
							</td> 
						 </tr>
					</table>
				      		...
				      		foreach($data as $patients){
								  ...
								  ?>								  
								   ...
								   <?php	 
								   		...
								   		array('controller'=>'radiologies','action' => 'radiology_test_payment_receipt',$patients['Patient']['id']), array('escape'=>false));
								   ?>
