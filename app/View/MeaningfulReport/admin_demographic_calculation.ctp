...
<h3> &nbsp; <?php echo __('Demographic', true); ?></h3>
<span>
<?php
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="100%">
 ...
 <tr class="row_title">
  ...
  ?>
   ...
   <td class="row_format">
   <?php echo $this->Html->link(__('More Details'),array('action'=>'doctor_demographic_calculation',$user['User']['id'], '?' => "from=$from&to=$to"),array('escape'=>false, 'title' => 'More Details', 'alt' => 'More Details'));?>
   </td>
  </tr>
  <?php endforeach;  ?>
   <tr>
