	...
	<table width="53%" align="center" class="formFull" cellpadding="0" cellspacing="0">
		...
		if(!empty($patientList)){
			echo "<tr class='row_gray'>
				<th  width='2%'>Sr.no</th>
				<th  width='10%' style='text-align: left;'>Physician Name</th>
				<th  width='15%' style='text-align: left;'>Patient Seen</th>
				...
				foreach($patientList as $data){
					...
					<td class='tdLabel' style="text-align: center;"><?php echo $this->DateFormat->formatDate2Local($data['Appointment']['date'],
