<div class="inner_title">
	<h3>
		&nbsp;
		<?php  echo __('Patient Wise Physician List', true); ?></h3>
...
<?php echo $this->Form->create('patientWiseList',array('id'=>'patientWiseList','type'=>'get','url'=>array('controller'=>'MeaningfulReport','action'=>'patient_wise_list','admin'=>false),
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0" align="center" width=85%
	...
	<tr class="row_title">
		...
		<td class="table_cell"><strong><?php echo __('Physician Seen'); ?> </strong></td>
...
<?php 
	...
	if($this->params->paging['Appointment']['page']==1) {
		...
		$srno= ($this->params->paging['Appointment']['limit']*$this->params->paging['Appointment']['page'])-2 ;
	}
