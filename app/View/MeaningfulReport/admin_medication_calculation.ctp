...
<h3> &nbsp; <?php echo __('Medical List Calculation', true); ?></h3>
<span>
<?php
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="100%">
 ...
 <tr class="row_title">
  ...
  ?>
   ...
   <td class="row_format">
   <?php echo $this->Html->link(__('More Details'),array('action'=>'doctor_medication_calculation',$user['User']['id']),array('escape'=>false, 'title' => 'More Details', 'alt' => 'More Details'));?>
   </td>
  </tr>
  <?php endforeach;  ?>
   <tr>
