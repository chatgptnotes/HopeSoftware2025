<div class="inner_title">
	<h3>
		&nbsp;
		<?php  echo __('Patient Wise Physician List', true); ?>
	</h3>
	<span><?php 
...
<?php echo $this->Form->create('physicianWiseList',array('type'=>get,'id'=>'physicianWiseList','url'=>array('controller'=>'MeaningfulReport','action'=>'physician_wise_list','admin'=>false),
...
echo "<b>Please Select Date or Doctor To Get The List</b>";
}?>
</table>
<script>
