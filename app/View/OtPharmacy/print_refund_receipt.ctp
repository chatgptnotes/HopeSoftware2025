	...
	<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="100%" style="padding-top:<?php echo $paddingTop;?>; padding-left:<?php echo $paddingLeft;?>;">
		  ...
		  <tr>
		  	...
		  	<td> <?php /*  if($billingData['Billing']['refund']==1){
				  			...
				  			echo $this->RupeesToWords->no_to_words($billingData['OtPharmacySalesBill']['paid_amount']); 
						//}?></td>
		  </tr>
		 ...
		 <?php $display='';
		  ...
		  <tr style="display:<?php echo $display; ?>">
		  	<td>Remarks :</td>
		  	<td> <?php echo $billingData['Billing']['remark']; ?></td>
		  </tr>
		<?php }?>
		  <tr>
		  	<td>Date :</td>
		  ...
		  <tr>
		  	<td><?php 
					if($billingData['OtPharmacySalesBill']['discount'])
		  			echo __("Discount : ") .$billingData['OtPharmacySalesBill']['discount'];?>
		  	</td>
		  </tr>
		  	...
		  	<td><?php 
		  		/* if($billingData['Billing']['refund']==1){
					echo $billingData['Billing']['paid_to_patient']."/-";
		  			...
		  			echo $billingData['OtPharmacySalesBill']['paid_amount']."/-"; 
				//}
