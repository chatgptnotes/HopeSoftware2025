	  	...
	  	<tr>
			...
			?>
		     ...
		     <tr>
		       ...
		       <td width="250"><?php if($section == "InventoryPharmacyDirectSalesReturnsDetail" || $section == "InventoryPharmacySalesReturnsDetail"){ echo __("RETURN AMOUNT :"); } else { echo __("PLEASE PAY :"); }?>
		       <?php
				if(isset($taxSection) && isset($data[$taxSection]['tax'])){
			?>
