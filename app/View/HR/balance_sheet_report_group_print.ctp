...
<?php 
	...
	$getExpense=$this->General->multilevelMenuGroup(0,$accountingGroupListExpense, $InnerArr,$getAccountingGroupName,$groupeExpIncData,Configure::read('expense_label'),$recurciveBalParentExpense,$recurciveBalChildExpense);

	ksort($accountingGroupListIndirectExpense);ksort($recurciveBalParent);ksort($recurciveBalChild);
	$getIndirectExpense=$this->General->multilevelMenuGroup(0,$accountingGroupListIndirectExpense, $InnerArr,$getAccountingGroupName,$groupeExpIncData,Configure::read('indirect_expenses_label'),$recurciveBalParentExpense,$recurciveBalChildExpense);

	ksort($accountingGroupListIncome);ksort($recurciveBalParent);ksort($recurciveBalChild);		
	$getIncome=$this->General->multilevelMenuGroup(0,$accountingGroupListIncome, $InnerArr,$getAccountingGroupName,$groupeExpIncData,Configure::read('income_label'),$recurciveBalParent,$recurciveBalChild);
	//debug($getIncome[1]);
	ksort($accountingGroupListIndireactIncome);ksort($recurciveBalParent);ksort($recurciveBalChild);
	$getIndirectIncome=$this->General->multilevelMenuGroup(0,$accountingGroupListIndireactIncome, $InnerArr,$getAccountingGroupName,$groupeExpIncData,Configure::read('indirect_income_label'),$recurciveBalParent,$recurciveBalChild);	
...
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#008000;padding-left:19px;font-size: 15px !important;"><?php echo "Gross Profit c/o";  ?></td>
...
<?php  if($getProfitLossFlag){?>
<tr> 
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#d9261c;padding-left:19px;font-size: 15px !important;"><?php echo "Gross Loss c/o";  ?></td>
...
<tr> 
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#008000;padding-left:18px;font-size: 15px !important;"><?php echo "Gross Profit b/f";  ?></td>
...
<tr>
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#D9261C;padding-left:19px;font-size: 15px !important;"><?php echo "Nett Loss";  ?></td>
