...
header ("Content-Disposition: attachment;  filename=\"Balance Sheet Report".$this->DateFormat->formatDate2Local(date('Y-m-d H:i:s'),Configure::read('date_format'), true).".xls");
...
<tr> 
<td  style="font-weight:bold;" valign="top">Particulars</td>
<td  style="border-right:solid 1px #000000;font-weight:bold;float:right;" ><?php echo $getLocName;?></br> 
<?php echo $getLocAdd1;?></br>
<?php echo $getLocAdd2;?>-
<?php echo $location_zipcode;?>,
<?php echo $location_country;?></td>
<td style="font-weight:bold;"  valign="top">Particulars</td>
<td style="font-weight:bold;float:right;"><?php echo $getLocName;?></br> 
<?php echo $getLocAdd1;?></br>
<?php echo $getLocAdd2;?>-
<?php echo $location_zipcode;?>,
<?php echo $location_country;?></td>
...
<!-- <tr bgcolor="#a7a7a8" >
<td style="padding-left:10px;font-weight:900;color:#FFFFFF;" bgcolor="#a7a7a8">Opening Stock</td>
...
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#008000;padding-left:10px;font-size: 15px !important;"><?php echo "Gross Profit c/o";  ?></td>
...
<tr> 
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#D9261C;padding-left:10px;font-size: 15px !important;"><?php echo "Gross Loss b/f";  ?></td>
...
<tr>
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#008000;padding-left:10px;"><?php echo "Nett Profit";  ?></td>
...
<!-- <tr>
<td style="font-weight:900;padding-top:5px;padding-left:10px;font-size: 15px !important;">Closing Stock</td>
<td style="font-weight:900;float:right;font-size: 15px !important;"><?php echo "10,000.00";?></td>
</tr> -->

<?php  if($getProfitLossFlag){?>
<tr> 
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#d9261c;padding-left:10px;font-size: 15px !important;"><?php echo "Gross Loss c/o";  ?></td>
...
<tr> 
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#008000;padding-left:10px;font-size: 15px !important;"><?php echo "Gross Profit b/f";  ?></td>
...
<tr>
<td style="font-weight:lighter;font-style:italic;padding-top:5px;color:#D9261C;padding-left:10px;font-size: 15px !important;"><?php echo "Nett Loss";  ?></td>
...
<td width="46%" style="border-right:solid 1px #000000;font-weight:900;padding-left:20px;float:right;font-size: 15px !important;" align="right"><?php 
