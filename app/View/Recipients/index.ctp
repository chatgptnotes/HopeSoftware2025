...
<table border="0" class=" "  cellpadding="0" cellspacing="0" width="500px" align="center">
	<tbody> 		    			 				    
		<tr class="row_title">				 
			...
			<td class=" ">											 
		    	<?php 
		    		 echo $this->Form->input("keyword", array("label" => "",'class' => 'drugText ',"type" => "search",'autocomplete'=>false));
		    	?>
		  	</td>
...
<?php //if(isset($data) && !empty($data)){  ?>
				  ...
				  <td class="table_cell"><strong><?php echo __('Sr. No.'); ?></strong></td>
					   ...
					   <td class="table_cell"><strong><?php echo  __('Active'); ?> </strong></td>
				  ...
				  <?php  $page = (isset($this->params->named['page']))?$this->params->named['page']:1 ;
				     ...
				     if(count($recipients) > 0) {
				      		...
				      		foreach($recipients as $patients){
				       $cnt++;
						$srNo++;
							    if($toggle == 0) {
								  ...
								  <td class="row_format"><?php  if(!empty($patients['Recipient']['is_generated'])) { 
									echo $this->Html->image('icons/active.png');} ?> </td>  
								   ...
								   echo $this->Html->link($this->Html->image('icons/edit-icon.png'),'#',array('onclick'=>"edit('".$patients['Recipient']['id']."')",'class'=>"",'escape' => false ));
								    echo $this->Html->link($this->Html->image('icons/view-icon.png'),'#',array('onclick'=>"preview('".$patients['Recipient']['id']."','".$patients['Recipient']['patient_id']."')",'class'=>"",'escape' => false ));
