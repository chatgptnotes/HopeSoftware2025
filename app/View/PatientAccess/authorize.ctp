...
<?php echo $this->Form->create('',array('action'=>'authorize','type'=>'post','id'=>'authorizefrm'));?>
<body>
...
<div style="text-align: center; float: left;padding-top:7px">
...
$('#confrim').click(function(){
	confirm("You Really want to allow changes");
		  ...
		  var ajaxUrl = "<?php echo $this->Html->url(array("controller" => "PatientAccess", "action" => "confrimChange","admin" => false)); ?>";
