...
<table class="table_first" width="100%"  cellspacing='0' cellpadding='0'>
	<tr>
		...
		<td class="td_second" valign="top">
			...
			<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="80%">
				<tr class="row_title">
					<td class="table_cell tdLabel"><strong><?php echo __('Type') ?> </strong></td>
					<td class="table_cell tdLabel"><strong><?php echo __('To') ?> </strong></td>
					<td class="table_cell tdLabel"><strong><?php echo __('Subject') ?> </strong></td>
					<td class="table_cell tdLabel"><strong><?php echo __('File') ?> </strong></td>
					<td class="table_cell tdLabel"><strong><?php echo __('Date') ?> </strong></td>
					<td class="table_cell tdLabel"><strong><?php echo  __('Action'); ?> </strong>
					</td>
				</tr>
				<?php //debug($specialist);
			$toggle =0;
			if(count($specialist) > 0) {
				foreach($specialist as $message){
			if($toggle == 0) {
			...
			?>
				...
				<td class="row_format is_read" id="from_<?php echo $messageId;?>">
				<?php echo $message['TransmittedCcda']['to']; ?>
				</td>
				<td class="row_format is_read" id="subject_<?php echo $messageId;?>">
				<?php echo $message['TransmittedCcda']['subject']; ?>
				
				</td>
				<td class="row_format is_read" id="message_<?php echo $messageId;?>"><?php  
				...
				<td class="row_format is_read" id="time_<?php echo $messageId;?>">
				<?php echo $this->DateFormat->formatDate2Local($message['TransmittedCcda']['referral_date'],Configure::read('date_format'),false); ?>
				</td>
				<td class="row_format is_read"><?php 
					echo $this->Html->link($this->Html->image("icons/view-icon.png",array('alt'=>'View Message','title'=>'View Message')),'#',
					 array('onclick'=>"view_message('".$message['TransmittedCcda']['id']."')",'escape' => false,'style'=>'display:block;' )); ?> 
											  </td>
				<?php } 
				}?>
				<tr>
