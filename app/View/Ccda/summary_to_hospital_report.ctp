...
<table class="table_first" width="100%"  cellspacing='0' cellpadding='0'>
	<tr>
		...
		<td class="td_second" valign="top">
			...
			<table border="0"
				class="table_format" cellpadding="0" cellspacing="0" width="80%" style="float:right;">
				<tr class="row_title">
					<td class="table_cell tdLabel" align="center"><strong><?php echo __('Type') ?> </strong></td>
			...
			?>
				...
				<td class="row_format is_read" id="from_<?php echo $messageId;?>"><a
					href="#"><?php echo $message['TransmittedCcda']['to']; ?>
				</a></td>
				<td class="row_format is_read" id="subject_<?php echo $messageId;?>"><a
					href="#" ><?php echo $message['TransmittedCcda']['subject']; ?>
				</a>
				</td>
				...
				<td class="row_format is_read"> <?php echo $this->Html->link($this->Html->image("icons/view-icon.png",array('alt'=>'View CCDA','title'=>'View CCDA')),'#',
