...
<div class="mid_section" style="width: 100%; float: left;">
	...
	<table border="0" class="table_format" cellpadding="0" cellspacing="0"
		...
		<tr class="row_title">
			...
			<td class="table_cell tdLabel"><strong><?php echo __('Name of Hospital/ER') ?> </strong>
			</td>
			<td class="table_cell tdLabel"><strong><?php echo __('Transitioned Date') ?> </strong>
			</td>
			<td class="table_cell tdLabel"><strong><?php echo __('Status') ?> </strong>
			</td>
			<td class="table_cell tdLabel"><strong><?php echo __('Log of follow up call') ?> </strong>
			</td>
...
if(count($referralToHospital) > 0) { 
	foreach($referralToHospital as $messageData){  
        $message = $messageData['ReferralToHospital'] ;
        $transitionedDate  =$this->DateFormat->formatDate2Local($message['transitioned_date'],Configure::read('date_format'),true); 
          
		?>
		<tr>
		<td class="row_format is_read" id="from_<?php echo $messageId;?>"><a href="#"><?php echo $message['provider']; ?> </a></td>
		<td class="row_format is_read" id="from_<?php echo $messageId;?>"><a href="#"><?php echo $message['name_of_er']; ?> </a></td>
		<td class="row_format is_read" id="from_<?php echo $messageId;?>"> <a href="#"><?php echo $transitionedDate; ?> </a></td>
		<td class="row_format is_read" id="from_<?php echo $messageId;?>"><a href="#"><?php echo $message['status']; ?> </a></td>
