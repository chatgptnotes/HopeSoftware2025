...
<?php 
 ...
 <table width="100%" cellpadding="0" cellspacing="0" border="0"
	...
	<td>&nbsp;</td>
		...
		<td><strong><label><a href="javascript:view_consolidate_ccda('<?php echo $this->Session->read('patientId');?>')" >View Ccda</a> </label></strong></td>
	</tr>
	</table>
		...
		<td>
			<table border="0" class="table_format_body"  cellpadding="0" cellspacing="0" width="100%" >
				...
				<tr class="row_gray">
					...
					<td class="row_format">&nbsp;<?php echo $rec['SmokingStatusOncs']['description']; ?></td>
		...
		<td>
			<table border="0" class="table_format_body"  cellpadding="0" cellspacing="0" width="100%" >
				<tr class="row_title">
					...
					<td class="table_cell"><strong>Note</strong></td>
					
				</tr>
				<?php
				$count=0; 
				$toggle =0;
				//echo '<pre>';print_r($setAllergies[$counter]['NewCropAllergies']['allergies_id']); exit;
				//$CountOfPrescriptionRecord=count($setAllergies);
	 							for($counter=0;$counter <count($setAllergies);$counter++){
						if(($count % 2) == 0) {
							echo "<tr class='row_gray'>";
				...
				$count++;	 ?>
					...
					<td class="row_format">&nbsp;<?php echo $setAllergies[$counter]['NewCropAllergies']['allergies_id']; ?>
					<td class="row_format">&nbsp;<?php echo $setAllergies[$counter]['NewCropAllergies']['name'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $setAllergies[$counter]['NewCropAllergies']['rxnorm'];  ?></td>
					<td class="row_format">&nbsp;<?php if($setAllergies[$counter]['NewCropAllergies']['status'] == 'A') echo "Active";  ?></td>
					<td class="row_format">&nbsp;<?php echo $setAllergies[$counter]['NewCropAllergies']['AllergySeverityName'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $setAllergies[$counter]['NewCropAllergies']['note'];  ?></td>
		...
		<td>
			<table border="0" class="table_format_body"  cellpadding="0" cellspacing="0" width="100%" >
				<tr class="row_title">
					...
					<td class="table_cell"><strong>Info</strong></td>
				</tr>
				<?php
				$count=0; 
				$toggle =0;
				...
				$count++;	 ?>
					...
					<!-- <td class="row_format">&nbsp;<?php echo $counter+1; ?> -->
					<td class="row_format">&nbsp;<?php echo $allergiesSpecific[$counter]['NewCropPrescription']['drug_id']; ?></td>
					<td class="row_format">&nbsp;<?php echo $allergiesSpecific[$counter]['NewCropPrescription']['description'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $allergiesSpecific[$counter]['NewCropPrescription']['rxnorm'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $allergiesSpecific[$counter]['NewCropPrescription']['date_of_prescription'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $allergiesSpecific[$counter]['NewCropPrescription']['route'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $allergiesSpecific[$counter]['NewCropPrescription']['archive'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $allergiesSpecific[$counter]['NewCropPrescription']['dose'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $allergiesSpecific[$counter]['NewCropPrescription']['frequency'];  ?></td>
					<?php $name= $allergiesSpecific[$counter]['NewCropPrescription']['description'];?>
					<td  class="row_format">&nbsp; <?php echo $this->Html->image('/img/icons/infobutton.png',array('alt'=>'infoButton','title'=>'Info Button','onClick'=>"javascript:infomedication('$name')"));?></td>
				</tr>
			...
			<table border="0" class="table_format_body"  cellpadding="0" cellspacing="0" width="100%" >
				...
				$toggle =0;
				 ...
				 ?>
					...
					<td class="row_format">&nbsp;<?php echo $problem['NoteDiagnosis']['disease_status'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $problem['NoteDiagnosis']['created'];  ?></td>
					<?php $problem_patient= $problem['NoteDiagnosis']['SnomedName'][0];
					?>
					<td class="row_format">&nbsp; <?php  echo $this->Html->image('/img/icons/infobutton.png',array('alt'=>'infoButton','title'=>'Info Button','onClick'=>"javascript:icdwin('$problem_patient','$id')"));?></td>
				</tr>
...
<!-- Immunization Instruction Start -->   
 <table border="0" class="table_format_head"  cellpadding="0" cellspacing="0" width="100%" >
				<tr class="row_title">
					<td class="table_cell"><strong><?php echo __("Immunization Instructions")?></strong></td>
				</tr></table>	
		...
		<td>
			<table border="0" class="table_format_body"  cellpadding="0" cellspacing="0" width="100%" >
				<tr class="row_title">
					...
					<td class="table_cell"><strong>CPT Description</strong></td>
					<td class="table_cell"><strong>CVX Code</strong></td>
					<td class="table_cell"><strong>Status</strong></td>
					<td class="table_cell"><strong>Date</strong></td>
				...
				$toggle =0;
				 ...
				 ?>
					...
					<td class="row_format">&nbsp;<?php echo $vt['Imunization']['cpt_description'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $vt['Imunization']['cvx_code'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $vt['Immunization']['status'];  ?></td>
					<td class="row_format">&nbsp;<?php echo $vt['Immunization']['date'];  ?></td>
...
function infomedication(name) {
	...
	$
			.fancybox({
				...
				'transitionOut' : 'fade',
				'type' : 'iframe',
				'href' : "<?php echo $this->Html->url(array("controller" => "patients", "action" => "infomedication")); ?>" + '/' + name
						
			});}


function infolab(name) {
	//alert(name);
			$
			.fancybox({
				...
				'transitionOut' : 'fade',
				'type' : 'iframe',
				'href' : "<?php echo $this->Html->url(array("controller" => "patients", "action" => "infolab")); ?>" + '/' + name
