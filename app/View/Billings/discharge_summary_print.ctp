  <style>
        ...
        .bgtext:after {
			...
			.watermarked:after {
			  content: url('../../img/icons/discharge_cross.png');
			  display: block;
			  width: 100%;
			  height: 100%;
			  position: absolute;
			  top: 0px;
			  left: -112px;
			 /* background-image: url('../../img/icons/discharge_cross.png');
...
<div style="float:right;" id="printButton">
	...
	if($patient['Patient']['is_discharge'] == '1'){
		echo $this->Html->link('Print','#',array('onclick'=>'window.print();','class'=>'blueBtn','escape'=>false));
		$crossClass = "";
	}else{
		$crossClass = "watermarked";
	}

	?>
</div>
<div class="<?php echo $crossClass ;  ?>" style="">
 ...
 ?>
  ...
  <tr>
		<td colspan="2" height="25" align="left" valign="top" style=" border-bottom:1px solid #ccc; padding-bottom:10px;">
                    ...
                    echo nl2br($this->data['DischargeSummary']['investigation']) ; ?> </td>  
  </tr>
  <?php } ?>
  <!--
  <tr>
