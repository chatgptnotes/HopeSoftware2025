...
<table width="100%" cellpadding="0" cellspacing="1" border="0" style="clear:both" class="tabularForm" id="serviceGrid">
	...
	foreach($servicesData as $services){ 
		...
		<tr class="row" id=row_<?php echo $services['ServiceBill']['id']; ?>>
			...
			<td class='select' style="<?php echo $display;?>"><input class="checkbox1" type="checkbox" id="<?php echo "optCheck_".$i; ?>" name="check[]" value="<?php echo $services['ServiceBill']['id'];?>" <?php echo $disabled;?> tariffId="<?php echo $services['TariffList']['id'];?>">
			<?php }?>
			<td align="">
			...
			<td><?php echo $bloodBanks[$services['ServiceBill']['blood_bank']];?></td>
