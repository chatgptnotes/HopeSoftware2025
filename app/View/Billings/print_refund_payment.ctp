...
<body style="background:none;width:98%;margin:auto;">
	...
	<table border="0" class="<?php echo $class;?>" cellpadding="0" cellspacing="0" width="800px;" style="padding-top:<?php echo $paddingTop;?>;padding-left: 8px"  >
		...
		<tr>
			<td style="padding-left:30px;" class="bor_right <?php echo $cls_left_border;?>"><?php echo $patientData['Patient']['lookup_name'];?></td>
			<td align="center" class="<?php echo $cls_right_border;?>"><b><?php echo $this->Number->currency($billingData['Billing']['paid_to_patient']); ?></b></td>
		</tr>
		...
		<tr><td style="padding-left:30px;" class="bor_right <?php echo $cls_left_border;?>"><?php echo $billingData['Billing']['remark'];?><?php if($website == 'kanpur') echo "&nbsp;".$billingData['Billing']['id']; ?></td>
			<td class="bor_right <?php echo $cls_right_border;?>">&nbsp;</td>
		</tr>
		...
		<tr>
			<td style="padding-left:30px;" class="bor_right <?php echo $cls_left_border;?>"><?php 
				echo $this->RupeesToWords->no_to_words($billingData['Billing']['paid_to_patient']); ?></td>	
			<td class="bor_right <?php echo $cls_right_border;?>">&nbsp;</td>
		</tr>
		
		<tr>
			<td class="bor_right <?php echo $cls_left_border;?> <?php echo $cls_bot_border;?>">&nbsp;</td>
			<td align="center" class="border <?php echo $cls_right_border;?> "><b><?php echo $this->Number->currency($billingData['Billing']['paid_to_patient']); ?></b></td>
		</tr>
		<tr><td>&nbsp;</td></tr>
		<tr><td>&nbsp;</td></tr>
