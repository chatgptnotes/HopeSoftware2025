...
<h3>&nbsp; <?php echo __('Tarrif - Import Data', true); ?></h3>
<span>
 
 <?php
 echo $this->Html->link(__('Back', true),array('controller' => 'tariffs', 'action' => 'index', 'admin' => false), array('escape' => false,'class'=>'blueBtn'));
?>
</span>
</div>
...
?>
 <div align="center">
 <a style="text-decoration:underline;" href="<?php echo $this->Html->url('/files/service_import_structure.xls');?>">Click here for download the Format </a>
 </div> 
 <?php }else {?>
 	<div align="center">
