<div class="inner_title">
 <h3><?php echo __('Add Enterprise Rate', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="hospitalratefrm" id="hospitalratefrm" action="<?php echo $this->Html->url(array("action" => "add_hospital_rate", 'superadmin' => true)); ?>" method="post" >
