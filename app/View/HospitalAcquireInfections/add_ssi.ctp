...
<div class="inner_title">
	<h3>
		<?php echo __('Add Surgical Site Infections', true); ?>
	</h3>
</div>
...
<form name="surgicalsitefrm" id="surgicalsitefrm"
	action="<?php echo $this->Html->url(array("controller" => "hospital_acquire_infections", "action" => "add_ssi", "admin" => false,"superadmin" => false)); ?>"
	method="post">
	<?php echo $this->Form->input('SurgicalSiteInfection.patient_id', array('type' => 'hidden', 'value' => $patient['Patient']['id'])); ?>
	<div>&nbsp;</div>
	...
	<table width="100%" cellpadding="0" cellspacing="1" border="0"
		...
		<tr>
			...
			<td class="tddate"><?php 
			echo $this->Form->input('SurgicalSiteInfection.ssi_lastcontact', array('type' => 'text', 'id' => 'date_of_last_contact', 'label'=> false, 'div' => false, 'error' => false));
			?>
			</td>
		</tr>
		<tr>
