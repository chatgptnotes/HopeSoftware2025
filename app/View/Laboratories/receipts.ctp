...
<div class="inner_title">
	<h3><?php echo __('Laboratory Payment Receipt')?></h3>
</div>
...
<div id="search-filter">
	<?php echo $this->Form->create('Laboratory',array('id'=>'patient-search','action'=>'receipts','type'=>'get','inputDefaults'=>array('label'=> false, 'div' => false, 'error' => false)));?>	
	<table border="0" class="" cellpadding="0" cellspacing="0"
		width="870px" align="center">
		<tbody>
			<tr>
				<td width="50%" valign="top">
					<table border="0" class=" " cellpadding="0" cellspacing="0"
						...
						<tr class="">
							<td class="row_format" width="22%"><?php echo __('From') ?> :</td>
							<td class="row_format">											 
						    	<?php
						...
						<tr class="">
							<td class="row_format"><?php echo __('Patient Name') ?> :</td>
							<td class="row_format">											 
						    	<?php
						...
						<tr class="">
							<td class="row_format"><?php echo __('Patient ID') ?> :</td>
							<td class="row_format">											 
						    	<?php
				...
				<td width="50%" valign="top">
					<table border="0" class=" " cellpadding="0" cellspacing="0"
						width="100%">
						<tr class="">
							<td class="row_format" width="23%"><?php echo __('To') ?> :</td>
							<td class="row_format">											 
						    	<?php
						...
						<tr class="">
							<td class="row_format"><?php echo __('Lab Test Name') ?> :</td>
							<td class="row_format">											 
						    	<?php
											echo $this->Form->input ( 'lab_test_name', array (
													'value' => $labTestName,
													'id' => 'lab_test_name',
													'autocomplete' => false 
											) );
						...
						<tr class="">
							<td class="row_format"><?php echo __('MRN') ?> :</td>
							<td class="row_format">											 
						    	<?php
...
<?php if(isset($data) && !empty($data)){  ?>
	...
	<td class="row_format"><?php
			echo $this->DateFormat->formatDate2Local ( $patients ['LaboratoryTestOrder'] ['create_time'], Configure::read ( 'date_format' ), true );
			?> </td>
	...
	<td><?php
			...
			echo $this->Html->link ( $this->Html->image ( 'icons/view-icon.png', array (
					...
					'action' => 'lab_test_payment_receipt',
					$patients ['Patient'] ['id'] 
			), array (
					'escape' => false 
			) );
