...
<table border="0" class="table_format" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td colspan="3" align="right">
			<div id="printButton">
			  <?php
					echo $this->Html->link ( __ ( 'Print', true ), '#', array (
							'escape' => false,
							'class' => 'blueBtn',
	...
	<tr>
		...
		echo $this->RupeesToWords->no_to_words ( $receiptData ['LabTestPayment'] ['paid_amount'] );
	...
	<tr>
		<td>Remarks</td>
		<td>: <?php echo $receiptData['LabTestPayment']['remark']; ?></td>
	</tr>
	<tr>
		<td>Date</td>
		<td>: <?php
		
		if ($receiptData ['LabTestPayment'] ['create_time'])
			echo $this->DateFormat->formatDate2Local ( $receiptData ['LabTestPayment'] ['create_time'], Configure::read ( 'date_format' ), true );
	...
	<tr>
		<td>
		  		<?php
						...
						echo $this->Number->currency ( $receiptData ['LabTestPayment'] ['paid_amount'] ) . "/-";
						?>
		  </td>
		<td>Name & Sign of Patient &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Authorised
			Signatory</td>
	</tr>
</table>
