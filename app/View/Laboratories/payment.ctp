...
<div class="inner_title">
	<h3><?php echo __('Laboratory Payment');?></h3>
</div>
...
<div id="search-filter">
	<?php echo $this->Form->create('Laboratory',array('id'=>'patient-search','action'=>'payment','type'=>'get','inputDefaults'=>array('label'=> false, 'div' => false, 'error' => false)));?>	
	<table border="0" class="" cellpadding="0" cellspacing="0" width="80%"
		align="center">
		<tbody>
			<tr>
				...
				<td width="50%" valign="top">
					<table border="0" class=" " cellpadding="0" cellspacing="0"
						...
						<tr class="">
							<td class="row_format" id="testname"><label width="20"><?php echo __('Lab Test Name') ?> :</label></td>
							<td class="row_format">											 
						    	<?php
...
<?php if(isset($data) && !empty($data)){  ?>
		...
		<td class="table_cell" align="left"><strong><?php echo $this->Paginator->sort('Patient.create_time', __('Ordered On', true)); ?></strong></td>
		<!--
					   -->
	...
	<!--	   
			...
			if (trim ( $patients ['LaboratoryTokens'] ['ac_id'] ) == "" || trim ( $patients ['LaboratoryTokens'] ['sp_id'] == "" )) {
				echo "No";
			} else {
				echo "Yes";
			}
