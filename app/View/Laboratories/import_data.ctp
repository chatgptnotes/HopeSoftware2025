<div class="inner_title">
	<h3>&nbsp; <?php echo __('Laboratory - Import Data', true); ?></h3>
	<span>
...
?>
 <div align="center">
 <a style="text-decoration:underline;" href="<?php echo $this->Html->url('/files/laboratory_import_structure.xls');?>">Click here for download the Format </a>
 </div> 
 <?php } else {?>
  <div align="center">
 <a style="text-decoration:underline;" href="<?php echo $this->Html->url('/files/vadodara_lab_import_structure.xls');?>">Click here for download the Format </a>
 </div> 
 <?php }?>
<div class="clr ht5"></div>
<div class="clr ht5"></div>
...
<?php }else{?>
	...
	<tr>
		...
		<td><input name="submit" type="Submit" value="Submit" class="blueBtn save"
			tabindex="2" /></td>
	</tr>
<?php }?>
</table>
