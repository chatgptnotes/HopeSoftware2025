...
<div class="inner_title">
	<h3><?php echo __('Patient Enquiry'); ?></h3>
...
<div id="search-filter">
	<?php echo $this->Form->create('Laboratory',array('id'=>'patient-search','action'=>'lab_manager','type'=>'get','inputDefaults'=>array('label'=> false, 'div' => false, 'error' => false)));?>

	<table border="0" class=" " cellpadding="0" cellspacing="0" width="93%"
		align="center" style="margin-top: 20px;">
		<tbody>
			<tr class="row_title">
				<td class=" " align="right"><label style="padding-left: 10px;"><?php echo __('DOB') ?> :</label></td>
				<td class=" ">											 
		    	<?php
							echo $this->Form->input ( 'Person.dob', array (
									'type' => 'text',
									'class' => 'textBoxExpnd',
									'id' => 'dob_search',
									'label' => false,
				...
				<td class=" ">											 
		    	<?php
							echo $this->Form->input ( 'Person.ssn_us', array (
									'type' => 'text',
									'class' => 'textBoxExpnd',
									'id' => 'ssn_us_search',
									'label' => false,
				...
				<td class=" " align="right" width="8%"><label><?php echo __('Patient Name')?>
						:</label></td>
				<td class=" "><?php
				...
				<td class=" " align="right"><label><?php echo __('Visit ID')?>
						:</label></td>
				<td class=" "><?php
				...
				<!--		 
						 <tr class="row_title">				 
							...
							<td class="row_format">											 
						    	<?php
											echo $this->Form->input ( 'radiology_test_name', array (
													'value' => $radiologyTestName,
													'type' => 'text',
													'id' => 'radiology_test_name',
													'error' => false 
											) );
											?>
						  	</td>
						 ...
						 <tr class="row_title">				 
							<td class="row_format"><label><?php echo __('Histology Test Name') ?> :</label></td>
							<td class="row_format">											 
						    	<?php
											echo $this->Form->input ( 'histology_test_name', array (
													'value' => $histologyTestName,
													'type' => 'text',
													'id' => 'histology_test_name',
													'error' => false 
											) );
											?>
						  	</td>
...
<?php if(isset($data) && !empty($data)){  ?>
		...
		<!--
					   <td class="table_cell" align="left"><strong><?php echo $this->Paginator->sort('LabManager.order_id', __('Order ID', true)); ?></strong></td>
					   <td class="table_cell" align="left"><strong><?php echo $this->Paginator->sort('Laboratory.name', __('Tests', true)); ?></strong></td>
					   -->
		...
		<td class="table_cell" align="left"><strong><?php echo $this->Paginator->sort('LabManager.start_date', __('Ordered On', true)); ?></strong></td>
	...
	<!--<td class="row_format">
			...
			/*
			 * if(!empty($patients['LaboratoryTokens']['ac_id']) || !empty($patients['LaboratoryTokens']['sp_id'])){
			 * echo "Yes";
			 * }else{
			 * echo "No";
			 * }
	...
	<td class="row_action" align=""><?php
			// echo $this->Html->link($this->Html->image('icons/view-icon.png'), array('action' => 'lab_test_list',$patients['Patient']['id'],'?'=>array('return'=>'laboratories')), array('escape' => false));
