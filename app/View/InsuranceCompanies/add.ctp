...
<h3><?php echo __('Add Insurance Companies', true); ?></h3>
</div>
<script>
	jQuery(document).ready(function(){
	// binds form submission and fields to the validation engine
	jQuery("#InsuranceCompanyAddForm").validationEngine();
	});
...
<table border="0" cellpadding="0" cellspacing="0" width="60%"  align="center" class="table_format">
 ...
 <td id="changeStates">
   <?php  $states = '';
    echo $this->Form->input('InsuranceCompany.state_id', array('label' => false,'class' => 'validate[required,custom[mandatory-select]', 'id' => 'state_id',  'div' => false, 'error' => false,'empty'=> 'Select State', 'options' => $states));
   ?>
  </td>
 </tr>
 <tr>
  ...
  <td id="changeCities" >
   <?php $cities = '';
    echo $this->Form->input('InsuranceCompany.city_id', array('label' => false,'class' => 'validate[required,custom[mandatory-select]', 'id' => 'city_id',  'div' => false, 'error' => false, 'empty'=> 'Select City', 'options' => $cities));
   ?>
  </td>
 </tr>
 <tr>
  ...
  <td >
   <?php
     echo $this->Form->input('zip', array('label' => false,'class' => 'validate[required,custom[customzipcode]]', 'id' => 'zip',  'div' => false, 'error' => false));
   ?>
  </td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td >
   <?php
    echo $this->Form->input('fax', array('label' => false,'class' => 'validate[required,custom[customfax]]', 'id' => 'fax',  'div' => false, 'error' => false));
   ?>
  </td>
 </tr>
 <tr>
