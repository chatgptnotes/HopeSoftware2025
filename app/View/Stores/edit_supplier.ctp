...
<script>
	...
	jQuery("#PharmacyItemEditSupplierForm").validationEngine();
	});
...
<div class="inner_title">
	<h3>
		&nbsp;
		<?php echo __('Store Management - Edit Supplier', true); ?>
	</h3>
	<span> <?php 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<td><?php  echo $this->Form->input('InventorySupplier.accounting_group_id',array('type'=>'select','options'=>$group,'id'=>'group_id','label'=> false, 'div' => false, 'error' => false,'class'=>'validate[required,custom[mandatory-select]]','empty'=>'Please Select','value'=>$data['InventorySupplier']['accounting_group_id']))?></td>
	</tr>
    </table>
    </td>
    </tr>
