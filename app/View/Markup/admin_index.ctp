...
<h3><?php echo __('MarkUp Management', true); ?></h3>

<span>
<?php 
echo $this->Html->link(__('Add MarkUp', true),array('action' => 'add'), array('escape' => false,'class'=>'blueBtn'));
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="100%">
  ...
  <td class="row_format"><?php echo 1; ?></td>
    ...
    <td class="row_format"><?php echo "PHH SURGICAL MARKUP"; ?> </td>
   <td class="row_format"><?php echo "Yes" ?> </td>
   <td class="row_format"><?php 
	echo $this->Html->link($this->Html->image('icons/view-icon.png'), array('action' => 'view'), array('escape' => false,'title' => 'View', 'alt'=>'View'));
