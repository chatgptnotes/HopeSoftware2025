<div class="inner_title">
 <h3><?php echo __('Edit OR Room', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="optfrm" id="optfrm" action="<?php echo $this->Html->url(array("action" => "edit")); ?>" method="post" onSubmit="return Validate(this);">
        <?php 
              echo $this->Form->input('Opt.id', array('type' => 'hidden')); 
        ?>
