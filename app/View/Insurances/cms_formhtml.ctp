...
<body>
 ...
 <div class="main_box">
 <div style="position:absolute; top:91px; right:-33px;"><img src="image/top_strip.png" /></div>
        ...
        <div class="box_1" style="width:97px; float:left;">
         ...
         <div style="float:left;margin:15px 0 2px 2px;">
          <div style="width:23px; float:left;">
            <div style="float:left; width:15px; border:1px solid #f54d2d;height:18px; width:18px;color:#000;"></div>
          </div>
...
BLK LUNG</span>
        ...
        <div class="box_1" style="width:97px; float:left;">
         ...
         <div style="float:left;margin:15px 0 0 2px;;">
          <div style="width:18px; height:18px; float:left;border:1px solid #f54d2d;color:#000;">
      ...
      <div class="section_2" style="float:left; width:100%;border-right: 1px solid #f54d2d; border-bottom:1px solid #f54d2d">
          ...
          <div class="gender" style="float:left; text-align:center;">
            <span>SEX</span><br />
             <div style="width:50px; float:left;margin:15px 15px 0 0;">
               M 
               <div style=" float:right; height:19px; width:20px;border:1px solid #f54d2d;color:#000;">
                <img src="image/cross1.png"  />
               </div>
             </div>
             <div style="width:50px; float:left;margin-top: 15px;">
               F
               <div style=" float:right;border:1px solid #f54d2d; height:19px; width:20px;color:#000;">
        ...
        <div style="float:left;">
         ...
         <div class="patrelchkbx">
             ...
             <div class="checkfeild">
                  ...
                  <div style="border: 1px solid rgb(245, 77, 45); width: 20px; height: 19px; float: right;color:#000;">
             </div>
             </div>
             <div class="checkfeild">
       ...
       <div class="section_4" style="float:left; width:100%;border-right: 1px solid #f54d2d;">
        ...
        <div style="float:left;width:299px; margin-top:-1px;">
          ...
          <div style="float: left; width: 100%;margin: 10px 0px 0px 30px;">
           <div style="float: left; width: 20%; margin: 0px 0px 0px 0px;">
             <div style="border: 1px solid rgb(245, 77, 45); width: 20px; height: 19px; float: left;color:#000;">
             </div>
             <span style="float: left; margin: 2px 0px 0px 5px;">YES</span>
           </div>
           <div style="float: left; margin: 0px 0px 0px 23px;">
             <div style="width: 20px; height: 19px; float: left;border:1px solid #f54d2d;color:#000;">
              <!--<img src="image/cross1.png" />-->
             </div>
        ...
        <div style="float:left; width:90px;">
         ...
         <div style="border: 1px solid rgb(245, 77, 45); width: 40px; height: 19px; float: left; border-top:none;margin: 12px 0 0 18px;color:#000;">
             </div>
        </div>
         </div>
...
below.
           ...
           <div style="float:left; width:100%;padding-bottom: 5px;">
            <div class="signed_sec" style="float:left; width:386px;">
                 ...
                 <div class="birth_date">
                  ...
                  <div class="qual_sec" style="float: left; width: 53%; margin: 17px 0px 0px 30px;">
                   <span style="float:left;">QUAL</span>
                    <div id="birthtxtbox" style="border-right:1px dashed #f54d2d; height:20px; width:6px; float:left;color:#000;">
                    </div>
          ...
          <div style="float:left; width:299px;border-bottom:1px solid #f54d2d;">
            ...
            <div class="qual_sec" style="float: left; margin: 17px 0px 0px 7px; width: 38%;">
                 ...
                 <div class="birth_date">
                  <div class="inner_birth">
                   <span id="boxSpace" class="">MM</span>
                   <div id="birthtxtbox" style="border-right:1px dashed #f54d2d; height:20px; width:40px; float:left;color:#000;">
                  ...
                  <div class="inner_birth">
                   <span id="boxSpace" class="">YY</span>
                   <div id="birthtxtbox" style="height:20px; width:40px; float:left;color:#000;">
          ...
          <div class="patient_name" style="width:389px; float:left;border-right: 1px solid #f54d2d; border-bottom:1px solid #f54d2d;">
            ...
            <div style="float: left; height: 20px; width: 35px; border-right: 1px dashed rgb(245, 77, 45); margin: 7px 5px;color:#000;">
       </div>
      <div class="pnt_name" style="height:63px; line-height:39px; font-size:15px; color:#000; ">
        ...
        <div style="height:33px; width:70px; border-right:1px solid #f54d2d; float:left;padding: 3px 0 0 9px;">
		     NPI
             </div>
             <div style="height:20px; width:202px;float:left;color:#000;">
             </div>
            </div>
            <div class="top_one" style="float:left;border-bottom:1px solid #f54d2d; height:31px; ">
             <span style="float:left; height:27px; width:20px; border-right:1px solid #f54d2d; padding:2px;">17b.</span>
        <div style="height:31px; width:70px; border-right:1px solid #f54d2d; float:left;padding:1px 0 0 9px;">
		         NPI
             </div>
             <div style="height:20px; width:202px;float:left;color:#000;">
        ...
        MCMILLAN PARKWAY
          ...
          <div class="section_14" style="float:left; width:100%;border-right: 1px solid #f54d2d;border-top: 1px solid #f54d2d;">
           <div style="float:left; width:100%">
             ...
             <div style="float: left; width: 138px; margin-top: 8px;">
              ...
              <div  style="float: left; width: 30px; border-right: 1px dashed rgb(245, 77, 45); height: 20px;color:#000;">
              </div>
              <div style="float: left; width: 56px; height: 20px;color:#000;">
              </div>
             </div>
           </div>
           <div style="float:left; width:100%">
           <div class="part_1" style="float:left; width:100%; padding-bottom:10px">
            <div style="float:left; width:160px;">
             ...
             <div style="float:left; width:100px; height:15px; border-bottom: 1px solid #f54d2d;border-left: 1px solid #f54d2d;color:#000;">
             </div>
            </div>
            <div style="float:left; width:160px;">
          ...
          <div class="section_14" style="float:left; width:100%;border-right: 1px solid #f54d2d;border-top: 1px solid #f54d2d;color:#000;">
          ...
          <div class="num_img" style="position:absolute; margin-top:6px;left: -18px;"><img style="height: 245px;" src="image/number.png" /></div>
           ...
           <div style="float:left; width:320px;border-right: 1px solid #f54d2d;">
            <div style="float:left; width:240px;">
             <span style="float:left; width:100%;padding-bottom:25px;margin: 0px 0px 0px 5px;">25. FEDERAL TAX I.D. NUMBER</span>
              <div style="float:left; width:100%; color:#000; height:25px; line-height:25px; font-size:15px;">121234567</div>
            </div>
            <div style="width:80px; float:left">
             <span style="float:left; width:100%; padding-bottom:13px;">SSN EIN</span>
             <div style="float: left; width: 100%; margin-top: 5px;">
               <div style="height:19px; width:20px; border:1px solid #f54d2d; float:left;margin: 0 6px 5px 0;">
               </div>
           ...
           <div style="float:left; width:179px;border-right: 1px solid #f54d2d;">
            ...
            <div style="width:166px; float:left">
             ...
             <div style="float: left; width: 100%; margin-top: 5px;">
               ...
               <div style="height:19px; width:20px; border:1px solid #f54d2d; float:left;margin: 0 6px 5px 50px;">
               </div>
               <div style="height:25px; width:25px; float:left;">
                 <img src="image/cross1.png" />
               </div>
...
apply to this bill and are made a part thereof.)</p>
 <div style="float:left; width:100%; min-height:50px;color:#000;">
   <div style="float:left;color:#000;padding: 30px 0 0 10px;"><span style="float:left;">shuchi yadav aaa</span></div>
   <div style="float:right;color:#000;padding: 30px 5px 0 0px;">14/08/2014</div>
 </div>
 <div style="float:left; width:100%">
   ...
   <div style="float:right;padding: 0 15px 0 0;">
     DATE
           ...
           <div style="float:left; width:368px;border-right: 1px solid #f54d2d;">
            ...
            <div style="float: left; width: 100%; min-height: 88px;color:#000;">
            </div>
            <div style="float: left; width: 100%; border-top: 1px solid; border-right: 1px solid; height: 25px;">
            <div style="float:left; width:50%;border-right: 1px solid; height: 25px;color:#000;">
              <span style="float:left;margin:0 0 0 5px;">a.</span>
           
            </div>
            <div style="float: left; width:49%; background: none repeat scroll 0% 0% rgb(254, 231, 220); height: 25px; padding: 0px;color:#000;">
    ...
    <div class="right_side" style="width:400px; float:left; ">
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
      ...
      <div class="pnt_name" style="height:51px; line-height:35px; font-size:15px; color:#000; margin: 0 0 1px 5px;">
        UDGM14H06003
      </div>
     </div>
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
    ...
    <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
     <div style="float:left; width:334px;border-right:1px solid #f54d2d;">
         <span style="float: left; clear: left; margin: 0px 0px 0px 5px;">CITY</span>
          <div class="pnt_name" style="height:43px; line-height:35px; font-size:15px; color:#000; margin: 0 0 0 5px; float:left; clear:left;">
           AUSTIN
          </div>
          </div>
          <div style="float:left">
    ...
    <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
      ...
      <div class="patient_dob" style="float:left;">
          ...
          <div class="gender" style="float:left; text-align:center;">
            <span>SEX</span><br />
             <div style="width:50px; float:left;margin:15px 15px 0 0;">
               M 
               <div style=" float:right; height:18px; width:20px;border:1px solid #f54d2d;color:#000;">
     ...
     <div class="pnt_name" style="height:27px; line-height:35px; font-size:15px; color:#000; margin:0 0 0 5px; float:left;">
        MCMILLAN PARKWAY
      </div>
     </div>
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
      <span style="float: left; width: 100%; margin: 0px 0px 0px 5px;">d. IS THERE ANOTHER HEALTH BENEFIT PLAN?</span>
      <div style="float: left; width:42%;margin: 12px 0px 0px 30px;">
...
<div class="signed_sec" style="float: left; margin-top:15px; padding-bottom: 5px; width: 360px;">
       ...
       <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
        <div class="lab_section" style="float:left;">
         ...
         <div class="charges" style="float:left; width:150px;">
          ...
          <div style="float: left; border-left: 1px solid rgb(245, 77, 45); width: 60px; height: 25px; margin-top: 23px;color:#000;">
          </div>
          <div style="float: left; border-left: 1px solid rgb(245, 77, 45); width: 60px; height: 25px; margin: 22px 0px 0px 8px;color:#000;">
          </div>
         </div>
        </div>
       </div>
...
Plan
         ...
         <div style="float:left; width:100%;">
           <div style="width:70px; float:left;padding: 0px 0px 0px 13px;  height:20px;color:#000;">
          
          </div>
          <div style="width:23px; float:left;padding: 0px 0px 0px 13px; height:20px;color:#000;">
          
          </div>
          <div style="width:57px; float:left;padding: 0px 0px 0px 13px;  height:20px;color:#000;">
         
          </div>
          <div style="width:41px; float:left; border-right:1px solid #f54d2d;padding: 0px 0px 0px 13px; height:20px;color:#000;">
        
          </div>
          <div style="width:36px; float:left; border-right:1px solid #f54d2d;padding: 0px 0px 0px 13px;height:20px;color:#000;">
         
          </div>
          <div style="width:90px; float:left;padding: 0px 0px 0px 13px; height:20px;color:#000;">
          ...
          <div style="width:36px; float:left; border-right:1px solid #f54d2d;color:#000;border-top:1px dashed #f54d2d;padding: 0px 0px 0px 13px; background:#fff repeat-x; height:20px">
           NPI
          </div>
          <div style="width:90px; float:left;border-top:1px dashed #f54d2d;padding: 0px 0px 0px 13px; background:#fff repeat-x;color:#000; height:20px">
         ...
         <div style="float:left; width:100%;">
          ...
          <div style="width:23px; float:left;padding: 0px 0px 0px 13px; height:20pxcolor:#000;">
          
          </div>
          <div style="width:57px; float:left;padding: 0px 0px 0px 13px;  height:20px;color:#000;">
         
          </div>
          <div style="width:41px; float:left; border-right:1px solid #f54d2d;padding: 0px 0px 0px 49px; height:20px;color:#000;">
         ...
         <div style="float:left; width:100%;">
          ...
          <div style="width:36px; float:left; border-right:1px solid #f54d2d;border-top:1px dashed #f54d2d;color:#000;padding: 0px 0px 0px 13px; background:#fff repeat-x; height:20px">
           NPI
          </div>
         ...
         <div style="float:left; width:100%;">
          ...
          <div style="width:41px; float:left; border-right:1px solid #f54d2d;padding: 0px 0px 0px 13px;color:#000;height:20px">
        
          </div>
          <div style="width:36px; float:left; border-right:1px solid #f54d2d;padding: 0px 0px 0px 13px;color:#000;height:20px">
         
          </div>
          <div style="width:90px; float:left;padding: 0px 0px 0px 13px;color:#000;height:20px">
          ...
          <div style="width:36px; float:left; border-right:1px solid #f54d2d;border-top:1px dashed #f54d2d;padding: 0px 0px 0px 13px;color:#000; background:#fff repeat-x; height:20px">
           NPI
          </div>
          <div style="width:90px; float:left;border-top:1px dashed #f54d2d;padding: 0px 0px 0px 13px; background:#fff repeat-x; height:20px;color:#000;">
         ...
         <div style="float:left; width:100%;">
          ...
          <div style="width:23px; float:left;padding: 0px 0px 0px 13px; color:#000;height:20px">
          
          </div>
          <div style="width:57px; float:left;padding: 0px 0px 0px 13px;color:#000;  height:20px;">
    ...
    <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
      <div class="total_chrg" style="float:left; width:128px;border-right:1px solid #f54d2d;">
       ...
       <div style="float: left; width: 100%; padding-top: 25px;">
        ...
        <div style="float:left;height:25px; width:30px;color:#000;"></div>
       </div>
      </div>
 ...
 <div style="float:left; width:100%; border-top:5px solid #ed1c24;">
  ...
  <div style="position:absolute; top:850px; right:-37px;"><img src="image/bottom_strip.png" /></div>
 </div>
