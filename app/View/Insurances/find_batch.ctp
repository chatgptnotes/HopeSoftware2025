...
<table width="100%">
	<tr class="row_title">
		...
		<td width="1%" align="center"><?php echo __('Group Control Number')?>
		</td>
	...
	<tr class="">
		...
		<td width="1%" align="center"><?php echo  $this->Html->link($getBatch['Batch']['batch_name'],'javascript:void(0)',array('onclick'=>'getDetails('.$getBatch['Batch']['id'].')'));?>
		</td>
		<td width="1%" align="center"><?php echo $getBatch['Batch']['group_control_number'];?>
		</td>
		<td width="1%" align="center"><?php echo $getBatch['Batch']['member_in_batch'];?>
		</td>
		<td width="1%" align="center"><?php echo $this->Html->image('/img/icons/notes_error.png',array('alt'=>'Generate EDI','title'=>'Generate EDI',
				'id'=>$id,'class'=>'generate'));?> <span
			id='sendEDI<?php echo $id;?>' style='display: none'><?php echo $this->Html->image('/img/icons/notes_error.png',
					array('alt'=>'Generate EDI','title'=>'Generate EDI'));?>
				<?php if($getBatch['Batch']['file_created']=='1'){
					$display='block';
				}else{
$display='none';
}?> </span> <?php echo $this->Html->link($this->Html->image("icons/download.png",array('alt'=>'Download EDI','title'=>'Download EDI','width'=>'20','height'=>'18')),
...
<script>
		...
		function getDetails(ids){
			...
			.fancybox({
				...
				'transitionOut' : 'fade',
				'type' : 'iframe',
				'href' : "<?php echo $this->Html->url(array("controller" => "Insurances", "action" => "patientInBatch")); ?>"+"/"+ids,
