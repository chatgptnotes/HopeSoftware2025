<?php
	...
	$tcpdf->AddPage(); 
	$top=FULL_BASE_URL.Router::url("/").'theme/Black/img/icons/top_strip.png';
	
	//$pdf->SetXY(110, 200);
	//$tcpdf->Image('/theme/Black/img/icons/top_strip.png', '', '', 40, 40, '', '', 'T', false, 300, '', false, false, 1, false, false, false);
	
	//$bottom=Router::url('/theme/Black/img/icons/bottom_strip.png');
	//$cross=Router::url('/theme/Black/img/icons/cross.png');
	//$barcode=Router::url('/theme/Black/img/icons/barcode1.png');
	//$number=Router::url('/theme/Black/img/icons/number.png');
	
	$html='<style>
body{ background:#fff; margin:0px; padding:0px; color:#f54d2d; font-size:13px;}
...
.pica_textfeild .textBoxExpnd{ margin:0px; padding:0px;width: 95% !important; border: 1px solid #f54d2d;}
.picalbl .tdLabel{ margin:0px; padding:0px 0 0 2px !important; color:#f54d2d;}
.picalbl{ float:left;}
...
<body>
 ...
 <div class="main_box">
 <div style="position:absolute; top:91px; right:-33px;"><img src="'.$top.'" /></div>
  <div class="header" style="width:100%; float:left;">
    <div class="top_header" style="float:left; width:100%;">
     ...
     <div class="heading" style="float:left; margin-top:50px;">
       <h2 style="float:left; margin:0px; padding:0px;">A & I BENEFIT PLAN ADMINISTRATORS</h2>
     </div>
    </div>
     <div class="bottom_header" style="float:left; width:100%;">
       <div class="health_insu">
       <h1 style="margin:0px; padding:0px;">HEALTH INSURANCE CLAIM FORM</h1>
       </div>
   ...
   <div class="pica_section">
    <div class="pica_left">
         ...
         <div class="picalbl"><span id="boxSpace" class="tdLabel">PICA</span></div>
       </div>
        ...
        <div class="box_1" style="width:97px; float:left;">
         ...
         <div style="float:left;margin:15px 0 0 2px;">
          <div style="width:23px; float:left;">
            <input style="float:left; width:15px; border:1px solid #f54d2d" type="text" />
          </div>
...
BLK LUNG</span>
      ...
      <div class="section_2" style="float:left; width:100%;border-right: 1px solid #f54d2d; border-bottom:1px solid #f54d2d">
        <div class="patient_name" style="width:389px; float:left;border-right: 1px solid;">
         <span style="float:left;margin: 0px 0px 0px 5px;">2. PATIENT’S NAME (Last Name, First Name, Middle Initial)</span>
          <div class="pnt_name" style="height:59px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0px 0px 0px 5px;">
            RUTH, RILEY
          </div>
        </div>
            ...
            <div class="birtsection">
                 <div class="birth_date">
                  <div class="inner_birth">
                   <span id="boxSpace" class="tdLabel">MM</span>
                  ...
                  <div class="birth_date">
                  <div class="inner_birth">
                   <span id="boxSpace" class="tdLabel">DD</span>
                   <div id="birthtxtbox" style="border-right:1px dashed #f54d2d; height:20px; width:35px; float:left;">
                  ...
                  <div class="birth_date">
                  <div class="inner_birth">
                   <span id="boxSpace" class="tdLabel">YY</span>
                   <div id="birthtxtbox" style="border-right:1px dashed #f54d2d; height:20px; width:35px; float:left;">
          ...
          <div class="gender" style="float:left; text-align:center;">
            <span>SEX</span><br />
             <div style="width:50px; float:left;margin:15px 15px 0 0;">
               M 
               <div style=" float:right; height:20px; width:30px;">
                <img src="'.$cross.'"  />
               </div>
             </div>
             <div style="width:50px; float:left;margin-top: 15px;">
               F
               <div style=" float:right;border:1px solid #f54d2d; height:20px; width:30px;">
       ...
       <div class="section_3" style="float:left; width:100%;border-right: 1px solid #f54d2d; border-bottom:1px solid #f54d2d">
         <div class="patient_name" style="width:389px; float:left;border-right: 1px solid;">
         <span style="float:left;margin: 0px 0px 0px 5px;">5. PATIENT’S ADDRESS (No., Street)</span>
          <div class="pnt_name" style="height:43px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0px 0px 0px 5px; clear:left; float:left;">
           MCMILLAN PARKWAY
          </div>
        </div>
        <div style="float:left;">
         ...
         <div class="patrelchkbx">
             ...
             <div class="checkfeild">
                  ...
                  <div style="border: 1px solid rgb(245, 77, 45); width: 20px; height: 19px; float: right;">
             </div>
             </div>
             <div class="checkfeild">
       ...
       <div class="section_4" style="float:left; width:100%;border-right: 1px solid #f54d2d;">
        <div class="patient_name" style="width:389px; float:left;border-right: 1px solid #f54d2d; border-bottom:1px solid #f54d2d ;">
         ...
         <span style="float:left;margin: 0px 0px 0px 5px;">CITY</span>
          <div class="pnt_name" style="height:43px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0px 0px 0px 5px; float:left; clear:left;">
           AUSTIN
          </div>
          </div>
          <div style="float:left;">
        ...
        <div style="float:left">
         ...
         <div class="patient_name" style="width:389px; float:left;border-right: 1px solid #f54d2d; border-bottom:1px solid #f54d2d;">
          <div style="float:left; width:195px;border-right: 1px solid #f54d2d;">
          ...
          <div class="pnt_name" style="height:43px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0px 0px 0px 5px; float:left; clear:left;">
           <span style="color:#f54d2d;">(</span> 1234565<span style="color:#f54d2d;"> )</span>123456789
          </div>
          </div>
         </div>
         </div>
         <div class="section_6" style="float:left; width:100%;border-right: 1px solid #f54d2d;">
         <div class="patient_name" style="width:390px; float:left;border-right: 1px solid #f54d2d; border-bottom:1px solid #f54d2d;">
         <span style="float:left;margin: 0px 0px 0px 5px;">9. OTHER INSURED’S NAME (Last Name, First Name, Middle Initial)</span>
          <div class="pnt_name" style="height:35px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0px 0px 0px 5px; float:left; clear:left;">
            RUTH, RILEY
          </div>
        </div>
        ...
        <div style="float:left;width:299px; margin-top:-1px;">
          ...
          <div style="float: left; width: 100%;margin: 10px 0px 0px 30px;">
           <div style="float: left; width: 20%; margin: 0px 0px 0px 0px;">
             <div style="border: 1px solid rgb(245, 77, 45); width: 20px; height: 19px; float: left;">
             </div>
        ...
        <div style="float:left;width:158px; margin-top:-1px;">
        ...
        <div style="float:left;">
         ...
         <div style="border: 1px solid rgb(245, 77, 45); width: 40px; height: 19px; float: left; border-top:none;margin: 12px 0 0 18px;">
             </div>
        </div>
         </div>
        ...
        <div style="float:left; border-top:1px solid #f54d2d; width:299px; margin-top:-1px;border-bottom:1px solid #f54d2d;">
          <span style=" margin-left: 5px;">10d. CLAIM CODES (Designated by NUCC)</span>
          <div class="pnt_name" style="height:35px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0px 0px 0px 5px; float:left; clear:left;">
            RUTH, RILEY
          </div>
        </div>
         </div>
         <div class="section_11" style="float:left; width:100%;border-right: 1px solid #f54d2d;border-bottom:5px solid #f54d2d;">
         <span style="text-align: center; width: 100%; float: left; font-weight: bold;">READ BACK OF FORM BEFORE COMPLETING & SIGNING THIS FORM.</span>
          <div style="float:left; width:100%;margin: 0px 0px 0px 5px;">
...
below.
           ...
           <div style="float:left; width:100%;padding-bottom: 5px;">
            <div class="signed_sec" style="float:left; width:390px;">
            ...
            <div class="date_sec" style="float:left;">
          ...
          <div class="patient_name" style="width:390px; float:left;border-right: 1px solid #f54d2d; border-bottom:1px solid #f54d2d;">
            <span style="float:left;margin: 0px 0px 0px 5px;">14. DATE OF CURRENT ILLNESS, INJURY or PREGNANCY (LPM)</span>
            <div class="birtsection">
                 <div class="birth_date">
                  <div class="inner_birth">
                   <span id="boxSpace" class="tdLabel">MM</span>
          ...
          <div style="float:left; width:299px;border-bottom:1px solid #f54d2d;">
            ...
            <div class="qual_sec" style="float: left; margin: 17px 0px 0px 7px; width: 38%;">
                   <span style="float:left;">QUAL</span>
                    ...
                    <div class="pnt_name" style="font-size: 20px; color:#000; font-weight: bold; height:21px; line-height:21px;
                     margin: 0px; float: left; padding: 0px 0px 0px 5px; border-right:1px dashed #f54d2d; width:30px; ">
          </div>
                  </div>
      ...
      <div class="pnt_name" style="height:64px; line-height:39px; font-size:20px; color:#000; font-weight:bold;">
        MCMILLAN PARKWAY
      </div>
          </div>
          <div style="float:left;  width:299px;">
            <div class="top_one" style="float:left;border-bottom:1px dashed #f54d2d;background:#fee7dc repeat-x; height:32px;">
        ...
        <div style="height:31px; width:70px; border-right:1px solid #f54d2d; float:left;">
          ...
          <div class="pnt_name" style="height:48px; line-height:39px; font-size:20px; color:#000; font-weight:bold; width:100%;margin: 0px 0px 0px 5px; clear:left; float:left;">
        MCMILLAN PARKWAY
      </div>
          </div>
          <div class="section_14" style="float:left; width:100%;border-right: 1px solid #f54d2d;border-top: 1px solid #f54d2d;">
           <div style="float:left; width:100%">
             ...
             <div style="float: left; width: 138px; margin-top: 8px;">
              ...
              <div  style="float: left; width: 30px; border-right: 1px dashed rgb(245, 77, 45); height: 20px;">
              </div>
           ...
           <div class="part_1" style="float:left; width:100%; padding-bottom:10px">
            <div style="float:left; width:160px;">
             ...
             <div style="float:left; width:100px; height:15px; border-bottom: 1px solid #f54d2d;border-left: 1px solid #f54d2d;">
             </div>
            </div>
            <div style="float:left; width:160px;">
          ...
          <div class="num_img" style="position:absolute; margin-top:6px;left: -18px;"><img style="height: 245px;" src="'.$number.'" /></div>
           <div class="feild_sec" style="background:#fee7dc repeat-x; width:100%; float:left;">
            <div style="float:left; width:100%; margin-top:20px;border-bottom:1px solid #f54d2d;">
             <div style="float:left; padding: 0px 0px 0px 13px; width: 32px;height:21px; background:#fff;border-right: 1px dashed #f54d2d; ">
            ...
            <div style="float:left; padding: 0px 0px 0px 13px; width: 25px;height:21px; background:#fff;border-right: 1px solid #f54d2d; ">
              
            </div>
            <div style="float:left; padding: 0px 0px 0px 13px; width: 50px;height:21px; background:#fff;border-right: 1px solid #f54d2d; ">
              
            </div>
            <div style="float:left; padding: 0px 0px 0px 8px; width: 23px;height:21px; background:#fff;border-right: 1px solid #f54d2d; ">
              
            </div>
            <div style="float:left; padding: 0px 0px 0px 31px; width: 90px;height:21px; background:#fff;border-right: 1px solid #f54d2d; ">
              
            </div>
            <div style="float:left;padding: 0px 0px 0px 7px; width: 22px;height:21px; background:#fff;border-right: 1px solid #f54d2d; ">
            ...
            <div style="float:left; padding: 0px 0px 0px 7px; width: 25px;height:21px; background:#fff;border-right: 1px solid #f54d2d; ">
              
            </div>
            <div style="float:left; padding: 0px 0px 0px 13px; width: 66px;height:21px; background:#fff;border-right: 1px solid #f54d2d; ">
           ...
           <div style="float:left; width:320px;border-right: 1px solid #f54d2d;">
            <div style="float:left; width:240px;">
             <span style="float:left; width:100%;padding-bottom:25px;margin: 0px 0px 0px 5px;">25. FEDERAL TAX I.D. NUMBER</span>
              <div style="float:left; width:100%; color:#000; height:25px; line-height:25px; font-size:20px;">121234567</div>
            </div>
            <div style="width:80px; float:left">
             <span style="float:left; width:100%; padding-bottom:13px;">SSN EIN</span>
             <div style="float: left; width: 100%; margin-top: 5px;">
               <div style="height:25px; width:25px; border:1px solid #f54d2d; float:left;margin: 0 6px 5px 0;">
               </div>
           ...
           <div style="float:left; width:179px;border-right: 1px solid #f54d2d;">
            ...
            <div style="width:166px; float:left">
             ...
             <div style="float: left; width: 100%; margin-top: 5px;">
               ...
               <div style="height:25px; width:25px; border:1px solid #f54d2d; float:left;margin: 0 6px 5px 50px;">
               </div>
               <div style="height:25px; width:25px; float:left;">
                 <img src="'.$cross.'" />
               </div>
...
INCLUDING DEGREES OR CREDENTIALS</span>
           <p style="float:left; margin:0px; padding:0px; width:320px;">(I certify that the statements on the reverse
   ...
   <div style="float:right;padding: 0 15px 0 0;">
     DATE
           ...
           <div style="float:left; width:368px;border-right: 1px solid #f54d2d;">
            ...
            <div style="float: left; width: 100%; min-height: 88px;">
            </div>
    ...
    <div class="right_side" style="width:400px; float:left; ">
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
      ...
      <div class="pnt_name" style="height:52px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0 0 0 5px;">
        UDGM14H06003
      </div>
     </div>
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
       <span style="float: left; clear: left; margin: 0px 0px 0px 5px;">4. INSURED’S NAME (Last Name, First Name, Middle Initial)</span>
      <div class="pnt_name" style="height:59px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0 0 0 5px;">
        RUTH, RILEY
      </div>
     </div>
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
       <span style="float: left; clear: left; margin: 0px 0px 0px 5px;">7. INSURED’S ADDRESS (No., Street)</span>
      <div class="txt_fld1" style="height:43px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0 0 0 5px;">
        MCMILLAN PARKWAY
      </div>
     </div>
    <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
     <div style="float:left; width:334px;border-right:1px solid #f54d2d;">
         <span style="float: left; clear: left; margin: 0px 0px 0px 5px;">CITY</span>
          <div class="pnt_name" style="height:43px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0 0 0 5px; float:left; clear:left;">
           AUSTIN
          </div>
          </div>
          <div style="float:left">
          <span style="float: left; clear: left; margin: 0px 0px 0px 5px;">STATE</span>
          <div class="pnt_name" style="height:43px; line-height:35px; font-size:20px; color:#000; font-weight:bold; float:left; clear:left;margin: 0 0 0 5px">
           TX
          </div>
          </div>
    </div>
    <div style="float:left; width:100%; border-bottom:1px solid #f54d2d;">
    <div style="float:left; width:200px;border-right:1px solid #f54d2d;">
          ...
          <div class="pnt_name" style="height:43px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0 0 0 5px;">
           ( 1234565 )123456789
          </div>
          </div>
    </div>
    <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
       <span style="float: left; clear: left; margin: 0px 0px 0px 5px;">11. INSURED’S POLICY GROUP OR FECA NUMBER</span>
      <div class="pnt_name" style="height:51px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0 0 0 5px;">
        MCMILLAN PARKWAY
      </div>
     </div>
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
     ...
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
      ...
      <div class="pnt_name" style="height:43px; line-height:35px; font-size:20px; color:#000; font-weight:bold;">
        MCMILLAN PARKWAY
      </div>
     </div>
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
       <span style="float: left; width: 100%; margin: 0px 0px 0px 5px;">c. INSURANCE PLAN NAME OR PROGRAM NAME</span>
     <div class="pnt_name" style="height:44px; line-height:35px; font-size:20px; color:#000; font-weight:bold;">
        MCMILLAN PARKWAY
      </div>
     </div>
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
      <span style="float: left; width: 100%; margin: 0px 0px 0px 5px;">d. IS THERE ANOTHER HEALTH BENEFIT PLAN?</span>
      <div style="float: left; width:42%;margin: 14px 0px 0px 30px;">
           <div style="float: left; width:37%; margin: 0px 0px 0px 0px;">
             <div style="border: 1px solid rgb(245, 77, 45); width: 20px; height: 19px; float: left;">
             </div>
             <span style="float: left; margin: 2px 0px 0px 5px;">YES</span>
           </div>
     ...
     <div style="float:left; width:100%;border-bottom:5px solid #f54d2d;">
      <span style=" margin: 0px 0px 0px 5px;">13. INSURED’S OR AUTHORIZED PERSON’S SIGNATURE I authorize
payment of medical benefits to the undersigned physician or supplier for
services described below.</span>
<div class="signed_sec" style="float: left; margin-top: 16px; padding-bottom: 5px; width: 360px;">
             <span style="float:left;">SIGNED</span>
             <div style="float:left; color:#f54d2d;">______________________________________</div>
            </div>
     </div>
     <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
     ...
     <div style="float:left; width:100%;">
       ...
       <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
        <div class="lab_section" style="float:left;">
         ...
         <div class="charges" style="float:left; width:150px;">
          ...
          <div style="float: left; border-left: 1px solid rgb(245, 77, 45); width: 60px; height: 25px; margin-top: 22px;">
          </div>
      ...
      <div class="pnt_name" style="height:63px; line-height:35px; font-size:20px; color:#000; font-weight:bold;margin: 0px 0px 0px 5px;">
        MCMILLAN PARKWAY
      </div>
        </div>
        <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
         ...
         <div style="float: left; text-align: center; font-size: 11px; width: 51px;border-right:1px solid #f54d2d;">
          <span style="float: left; width: 100%; text-align:center; padding-bottom:6px;">H.</span>
          EPSDT
Famly
Plan
         </div>
         <div style="float: left; text-align: center;width: 51px;border-right:1px solid #f54d2d;">
          <span style="float: left; width: 100%; text-align:center;">I.</span>
         ID.
QUAL
         </div>
         ...
         <div style="float:left; width:100%;">
          ...
          <div style="width:38px; float:left; border-right:1px solid #f54d2d;padding: 0px 0px 0px 13px;height:20px">
          ...
          <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
           <div style="width:70px; float:left; border-right:1px dashed #f54d2d;padding: 0px 0px 0px 13px; background:#fff repeat-x; height:20px;">
          
          </div>
          <div style="width:23px; float:left; border-right:1px solid #f54d2d;padding: 0px 0px 0px 13px; background:#fff repeat-x; height:20px">
         
          </div>
          <div style="width:57px; float:left; border-right:1px solid #f54d2d;padding: 0px 0px 0px 13px; background:#fff repeat-x; height:20px;">
           
          </div>
          <div style="width:38px; float:left; border-right:1px solid #f54d2d;padding: 0px 0px 0px 13px; background:#fff repeat-x; height:20px">
          
          </div>
          <div style="width:38px; float:left; border-right:1px solid #f54d2d;border-top:1px dashed #f54d2d;padding: 0px 0px 0px 13px; background:#fff repeat-x; height:20px">
           NPI
          </div>
    ...
    <div style="float:left; width:100%;border-bottom:1px solid #f54d2d;">
      <div class="total_chrg" style="float:left; width:128px;border-right:1px solid #f54d2d;">
       ...
       <div style="float: left; width: 100%; padding-top: 25px;">
        <span style="float: left; width: 30px;margin: 0 0 0 5px;">$</span>
      ...
      <div class="total_chrg" style="float:left; width:132px;">
 ...
 <div style="float:left; width:100%; border-top:5px solid #ed1c24">
   ...
   <div style="float:left; font-style:italic; text-align:center; width:522px; font-weight:bold;">
  ...
  <div style="position:absolute; top:850px; right:-37px;"><img src="'.$bottom.'" /></div>
 </div>
