...
?> 
<form name="userfrm" id="userfrm" action="<?php echo $this->Html->url(array("action" => "edit_emergency_user")); ?>" method="post" >
<?php echo $this->Form->input('User.id', array('type' => 'hidden', 'id' => 'username')); ?>
 <table border="0" class="table_format" cellpadding="0" cellspacing="0" width="60%"  align="center">
		...
		<td>
	        <?php 
	          echo $this->Form->input('User.expiary_date', array('class' => 'validate[required,custom[mandatory-date]]', 'type'=>'text', 'id' => 'expiary_date', 'label'=> false, 'div' => false, 'error' => false,'value'=>$this->DateFormat->formatDate2Local($this->request->data['User']['expiary_date'],Configure::read('date_format'),true)));
	        ?>
		</td>
		</tr>
		    <tr>
