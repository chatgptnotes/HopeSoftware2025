<div class="inner_title">
 <h3><?php echo __('Add Specific Audit Log', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="auditlogpermfrm" id="auditlogpermfrm" action="<?php echo $this->Html->url(array("action" => "add_audit_log_permission")); ?>" method="post" onSubmit="return Validate(this);" >
    <table border="0" class="table_format" cellpadding="0" cellspacing="3" width="20%"  align="center">
    <tr>
	...
	<tr>
	  ...
	  <td>
	   <?php 
	          echo $this->Form->input('AuditLogPermission.user_id', array('class' => 'validate[required,custom[mandatory-select]]','options' => $users, 'empty' => 'Select Username','id' => 'username', 'label'=> false, 'div' => false, 'error' => false));
	   ?>
	  </td>
	 </tr>
	 <tr>
