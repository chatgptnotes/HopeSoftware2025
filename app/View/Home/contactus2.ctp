...
<style>
	...
	.leftSide{width:340px; float:left; line-height:22px; font-family:Arial, Helvetica, sans-serif; font-size:14px; border-right:1px solid #CCCCCC; padding-bottom:20px; padding-top:20px;}
	.rightSide{width:380px; float:right; margin-left:30px;}
</style>
</head>
