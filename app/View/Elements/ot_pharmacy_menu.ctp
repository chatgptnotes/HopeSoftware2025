		...
		<ul id="nav">
			  <li class="liHeader"> Items
				<ul>
					...
					<li><?php echo $this->Html->link('Item List',array('controller'=>'OtPharmacy','action'=>'add_item',),array('alt' => 'Item List'));?></li>
				</ul>
			</li>
			...
			<li class="liHeader"> Sales
				<ul>
					<li><?php echo $this->Html->link('Sales Bill',array('controller'=>'OtPharmacy','action'=>'sales_bill'),array('alt' => 'Sales Bill'));?></li>
					<li><?php echo  $this->Html->link('View Sales',array('controller'=>'OtPharmacy','action' => 'ot_details','sales'),array('alt' => 'View Sales'));?></li>
					<li><?php echo $this->Html->link('Sales Return',array('controller'=>'OtPharmacy','action' => 'sales_return'),array('alt' => 'Sales Return'));?></li>
				</ul>
			</li>
			...
			<!--   <li class="liHeader"> Sales Return
				<ul>
					...
					<li><?php echo  $this->Html->link('View Return',array('controller'=>'OtPharmacy','action'=>'ot_details','sales_return'),array('alt' => 'View return'));?></li>
				</ul>
			</li>
			-->
