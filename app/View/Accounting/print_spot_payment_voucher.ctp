...
<body style="background:none;width:98%;margin:auto;">
	...
	<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="800px;" style="padding-top:0px;padding-left:30px;" align="center">
		...
		<tr>
		<td style="padding-left:30px;" class="bor_right"><?php echo 'M.L.ENTERPRISES - Implants';/*$voucherPaymentData['Account']['name'];*/ ?></td>
		...
		<tr>
			<td style="padding-left:30px;" class="bor_right"><?php echo  $voucherPaymentData['Consultant']['market_team']/*$voucherPaymentData['VoucherPayment']['narration']*/; ?></td>
		</tr>
		<tr>
