...
<?php $hospital_details = $this->General->billingHeader($contraData['ContraEntry']['location_id']);?>
...
<body style="background:none;width:98%;margin:auto;">
	<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="800px;" style="padding-top:0px;padding-left:30px;" align="center">
		...
		<tr>	  
		  	<td valign="top" style="text-align:center;font-size:15px;" colspan="3"><strong><?php echo __("Contra Voucher");?></strong></td>
		</tr>
		
		<tr><td>&nbsp;</td></tr>
		  
		<tr>
			<td><?php echo __("No. : ");?><b> <?php echo $contraData['ContraEntry']['contra_voucher_no']; ?></b></td>
			<td align="right"><?php echo __("Dated : ");?></td>
			<td align="right"><b><?php echo date('j-M-Y',strtotime($contraData['ContraEntry']['date'])); ?></b></td>
		</tr>
		...
		<tr>
		  	<td class="bor_right"><b><?php echo __("To ");?></b> <?php echo $contraData['Account']['name']; ?></td>
		  	<td class="bor_right"></td>
		  	<td align="right"><b><?php echo $this->Number->precision($contraData['ContraEntry']['debit_amount'],2); ?></b></td>
		</tr>
		<tr>
			<td style="padding-left:30px;" class="bor_right"><?php echo $contraData['AccountAlias']['name']; ?></td>
			<td align="right" class="bor_right"><b><?php echo $this->Number->precision($contraData['ContraEntry']['debit_amount'],2); ?></b></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			<td style="padding-left:30px;" class="bor_right"><?php echo $contraData['ContraEntry']['narration']; ?></td>
			<td class="bor_right"></td>
			<td></td>
		</tr>
		<tr>
			<td class="bor_right"></td>
			<td class="bor_right border" align="right"><b><?php echo $this->Number->precision($contraData['ContraEntry']['debit_amount'],2); ?></b></td>
			<td class="border" align="right"><b><?php echo $this->Number->precision($contraData['ContraEntry']['debit_amount'],2); ?></b></td>
		</tr>
