...
<div class="inner_title">
	<h3>
		<?php echo __('Corporate Received', true); ?>
	</h3>
	<span>
		<?php echo $this->Html->link('Corporate Receivable',array('Controller'=>'Accounting','action'=>'corporate_receivable'),array('escape'=>false,'class'=>'blueBtn'));?>
			...
			<table width="100%" cellpadding="0" cellspacing="1" border="0" 	class="tabularForm" id="container-table"><!-- style="border-bottom:solid 10px #E7EEEF;" -->
				<thead>
					<tr> 
						...
						<th width="20%" align="center" valign="top" style="text-align: center; "><?php echo __('Total Received')?></th> 
						<th width="20%" align="center" valign="top" style="text-align: center; "><?php echo __('TDS')?></th> 
				...
				$netAmount =  $userData['0']['amount_paid'] ;?>
					<tr>
						...
						<td class="tdLabel"  style= "text-align: center;">
							<?php echo $userData[0]['tds'] ;
							$totalTDS +=  (double) $userData[0]['tds'];?>
						</td>
...
<table width="100%" >
	<tr>
		<td width="50%"  class="tdLabel" colspan="0" style="text-align: center;"><font color="red"><b><?php echo __('Grand Total :');?></b></font></td>
		
			<?php if(empty($totalRevenue)){ ?>
		<td width="20%"  class="tdLabel"><font color="red"><b><?php echo $this->Number->currency(0);?></b></font></td><?php
			}else{ ?>
		<td width="20%"  class="tdLabel" style= "text-align: center;"><font color="red"><b><?php echo $this->Number->currency($totalRevenue)?></b></font></td>
			<?php } ?>
		<td width="20%"  class="tdLabel" style= "text-align: center;"><font color="red"><b><?php echo $this->Number->currency($totalTDS)?></b></font></td>
	...
	$("#from").datepicker({
 	...
 	$(document).ready(function(){	
 		$(".iframe").click(function() {
 			id = $(this).attr('id'); 
 			getPaymentCollectionsURL = "<?php echo $this->Html->url(array('controller'=>"Accounting",'action'=>"corporate_received_patient_details",'?'=>$this->params->query)); ?>" ;
 	...
 	//$("#container-table").freezeHeader({ 'min-height': '400px' });
});
</script>
