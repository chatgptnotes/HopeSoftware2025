...
<div class="inner_title">
	<h3><?php echo __('Edit Group', true); ?></h3>
</div>

<div class="clr">&nbsp;</div>
<?php echo $this->Form->create('AccountingGroup',array('id'=>'accountingGroupFrm','name'=>'myForm',
		'url'=>array('controller'=>'Accounting','action'=>'group_edit','admin'=>true)));?>
	...
	<tr>
		...
		<td width="95%" valign="top">
			<table width="60%" border="0" cellspacing="0" cellpadding="0" class="formFull"  align="center">
				...
				<?php //if (!empty($this->data['AccountingGroup']['account_type'])){?>
				<tr id="account_type">
					...
					<td><?php echo $this->Form->input('AccountingGroup.account_type',array('type'=>'select','options'=>Configure::read('account_type'), 
							'label'=> false, 'div' => false,'empty'=>'Please Select','id'=>'accountType',
							'class'=>'validate[required,custom[mandatory-select]] textBoxExpnd inputBox')); ?>
					</td>
				</tr>
				<?php //}?>
				<tr>
					...
					<td align="left">
						...
						<?php $cancelBtnUrl =  array('controller'=>'accounting','action'=>'group_creation','admin'=>true);?>
