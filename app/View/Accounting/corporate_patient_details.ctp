			...
			<table width="100%" cellpadding="0" cellspacing="1" border="0" 	class="tabularForm"><!-- style="border-bottom:solid 10px #E7EEEF;" -->
				<thead>
					<tr> 
						...
						<th width="5%" align="center" valign="top" style="text-align: center;"><?php echo __('Total Discount') ?></th>
				...
				?>
				<tr>
					<td><?php echo $userData['Patient']['lookup_name']; ?></td>
					<td><?php echo $userData['CorporateSuperBill']['approved_amount']?></td>
					<td><?php echo $userData['CorporateSuperBill']['received_amount']?></td>
					<td><?php //echo $userData['CorporateSuperBill']['total_amount']?></td>
					<td><?php 
							$pendingBal = $userData['CorporateSuperBill']['approved_amount']-$userData['CorporateSuperBill']['received_amount'] ; 
							echo $pendingBal;
							$totalPendingBalance += $pendingBal ;
							$totalAmount  += $userData['CorporateSuperBill']['approved_amount'];
							$totalReceivedAmount  += $userData['CorporateSuperBill']['received_amount'];
							?>
					</td>  
				</tr> 
				<?php } ?>
