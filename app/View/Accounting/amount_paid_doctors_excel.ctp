	...
	<table align="center" style="margin-top: 10px" width="100%" border="1">
		<tr>
			...
			<table class="formFull" width="100%" align="center" cellspacing="0" border="1">
				<tr class="row_gray">
					<th style="width:9%"><?php echo __('VOU. DATE');?></th>
					<th style="width:39%"><?php echo __('VOU. NO');?></th>
					<th style="width:7%"><?php echo __('DEBIT LADGER');?></th>
					<th style="width:14%"><?php echo __('AMOUNT');?></th>
					<th style="width:9%"><?php echo __('CREDIT LEDGER');?></th>
					<th style="width:14%"><?php echo __('AMOUNT');?></th>
					<th style="width:9%"><?php echo __('NARATION');?></th>
				</tr>
			<?php
