	...
	if(!empty($frequentMedicationByDoctor)){?>
		...
		<?php foreach($frequentMedicationByDoctor as $data){?>
			...
			<?php 	}else{?>
				...
				var prn_option = '<select style="width:auto;" id="prn'+counter+'" class="" name="prn[]"><option value="0">No</option><option value="1">Yes</option></select>';
				...
				var active_option = '<select  id="isactive'+counter+'" class="" name="isactive[]"><option value="1">Yes</option><option value="0">No</option></select>';
					...
					var newHTml = '<td valign="top"><input  type="text" style="width:271px!important;" value="'+drugName+'" id="drugText_' + counter + '" class=" drugText validate[required,custom[onlyLetterNumber]]" name="drugText[]" autocomplete="off" counter='+counter+'>'+
										'<input  type="hidden" class="allHiddenId" id="drug_' + counter + '"  value="'+drugId+'" name="drug_id[]" > <span id="drugType_' + counter + '"></span> <span id="formularylinkId_' + counter + '"></span></td><td valign="top">'
							+ dose_option
							+ '</td><td valign="top">'
							+ dosage_form
							+ '</td><td valign="top">'
							...
							+ frequency_option
							+ '</td>'
							+ '<td valign="top" ><input size="2" type="text" value="" id="day'+counter+'" class="day" name="day[]" style="margin: 0 0 0 10px;"></td>'
					...
					var dosageformId = attrId.replace("drugText_",'dosageform_');
														  	...
														  	success: function(data){
                                                                ...
                                                                //select route and dose
																	...
																	if(dosageFrm[finData[1]]!='')
																		$("#"+dosageformId).val(dosageFrm[finData[1]]);
