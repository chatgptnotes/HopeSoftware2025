...
<?php
//debug($diagnosis);
$strXML ='<chart caption="Length for Age Chart for infants (Boys)" subCaption="0 to 36 Months" canvasBgColor="#DDDDDD" numVDivLines="35" bgAlpha="100" labelStep="90"   connectNullData="1"  yAxisMinValue="40" anchorBgColor="#000" yAxisValuesStep="" numDivLines="25" drawAnchors="0" xAxisName="AGE(Years)" yAxisName="Length (cm)" bgColor="#DDDDDD" showBorder="0"   use3DLighting="0" chartRightMargin="40"  showLegend="0" showValues="0" divLineColor="#0165BB"   alternateHGridAlpha="20" showAlternateHGridColor="0" showAlternateVGridColor="0"  decimalPrecision="5" baseFontColor="#000" animation="0">';
...
?>
  ...
  var datastring = '<?php echo $strXML; ?>';
   ...
   <center>
                            ...
                            <?php echo $this->JsFusionChart->showFusionChart("fusionpx_charts/MSSpline.swf", "multiaxisChartId4", "650px", "750px", "0", "0", "datastring", "chartContainer"); ?>
            </center>
</div>
