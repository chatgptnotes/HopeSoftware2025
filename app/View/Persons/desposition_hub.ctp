    ...
    <div class="row">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Auto-fetched" disabled>
            </div>
            <div class="form-group">
              <label>Patient Name:</label>
              <input type="text" class="form-control" value="<?php echo h($desposition_hub[0]['Person']['first_name']); ?> <?php echo h($desposition_hub[0]['Person']['last_name']); ?>" placeholder="Pulled from hospital records">
            </div>
            <div class="form-group">
              <label>Call Duration:</label>
              <input type="text" class="form-control" placeholder="Automatically calculated">
            </div>
            <div class="form-group">
              <label>Patient Mobile:</label>
              <input type="number" class="form-control" value="<?php echo h($desposition_hub[0]['Person']['mobile']); ?>" placeholder="Patient number">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="POST" action="<?php echo $this->Html->url(['action' => 'saveDisposition']); ?>">
      ...
      <div class="col-md-6">
       ...
       <div class="col-md-6">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="form-group">
              <label for="follow_up_date">Remark</label>
