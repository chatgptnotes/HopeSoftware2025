...
<div class="inner_title">
	...
	<?php
	//debug($diagnosis);
	$strXML ='<chart caption="Weight for Length Chart for Males" subCaption="0 to 36 Months" labelStep="30" canvasBgColor="#DDDDDD" anchorBgColor="#000" numVDivLines="60" bgAlpha="100" adjustDiv="1"   connectNullData="1"  yAxisMinValue="0" yAxisValuesStep="" numDivLines="35" drawAnchors="0" toolTipBgColor="DDDDDD" xAxisName="Length(Cm)" yAxisName="Weight (Kg)" bgColor="#DDDDDD" showBorder="0"   use3DLighting="0" chartRightMargin="40"  showLegend="0" showValues="0" divLineColor="#0245EF" yAxisMaxValue="25"  alternateHGridAlpha="20" showAlternateHGridColor="0" showAlternateVGridColor="0"  decimalPrecision="5" baseFontColor="#000" animation="0">';
