...
?>
     <div class="inner_title">
			 <h3><font style="color: #fff"> <?php echo __('Growth Chart', true)." for - ".ucwords($patient_name); ?></font></h3>
<?php
//debug($diagnosis);
$strXML ='<chart caption="Head Circumference chart for infants (Girls)" subCaption="0 to 36 Months" canvasBgColor="#DDDDDD" anchorBgColor="#000" numVDivLines="35" bgAlpha="100" labelStep="90"   connectNullData="1"  yAxisMinValue="30" yAxisValuesStep="" toolTipBgColor="DDDDDD" numDivLines="25" drawAnchors="0" xAxisName="AGE(Years)" yAxisName="HeadCircumference (cm)" bgColor="#DDDDDD" showBorder="0"   use3DLighting="0" chartRightMargin="40"  showLegend="0" showValues="0" divLineColor="#F90792"   alternateHGridAlpha="20" showAlternateHGridColor="0" showAlternateVGridColor="0"  decimalPrecision="5" baseFontColor="#000" animation="0">';
