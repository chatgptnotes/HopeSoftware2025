...
<body>
    ...
    <div class="container my-5" style=" background-color: #5198bf;">
        ...
        <form action="/persons/generate_qr" id="PersonSearchForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" class="form-control" id="emergencyContactMobile" placeholder="Emergency Contact Mobile" >
                </div>
            </div>
            <div class="form-group row">
                <div class="col-12 col-md-6">
                    <label for="secondEmergencyContactName">Second Emergency Contact Name*</label>
                    <input type="text" class="form-control" id="secondEmergencyContactName" placeholder="Second Emergency Contact Name" >
                </div>
                <div class="col-12 col-md-6">
                    <label for="secondEmergencyContactMobile">Second Emergency Contact Mobile*</label>
                        <input type="text" class="form-control" id="secondEmergencyContactMobile" placeholder="Second Emergency Contact Mobile" >
                </div>
            </div>
            ...
            <div class="additional-fields">
                <div class="form-group row">
                    <div class="col-12 col-md-6">
                        ...
                        <select class="form-control" id="physician" >
                            <option value="">Select</option>
                            <option value="bkMurali">B K Murali, MS (Orth.)</option>
                        </select>
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="medicalRequirements">Special Medical Requirements</label>
                        <textarea class="form-control" id="medicalRequirements" rows="2" placeholder="Enter special requirements"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-12 col-md-6">
                        ...
                        <select class="form-control" id="visitType" >
                            <option value="">Select</option>
                            <option value="consultationCharges">Consultation Charges</option>
                        </select>
                    </div>
                    <div class="col-12 col-md-6">
                ...
                <div class="form-group row">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" id="chronicConditions" placeholder="Enter Chronic Conditions">
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="allergy">Allergy</label>
                        <input type="text" class="form-control" id="allergy" placeholder="Allergy">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" id="currentMedication" placeholder="Current Medication">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select class="form-control" id="uploadIdProof">
