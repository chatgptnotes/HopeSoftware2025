...
<?php
//debug($diagnosis);
$strXML ='<chart caption="Weight for Age Chart for infants (boys)" subCaption="0 to 36 Months" canvasBgColor="#DDDDDD" numVDivLines="35" bgAlpha="100" labelStep="90"   connectNullData="1"  yAxisMinValue="1" anchorBgColor="#000" yAxisValuesStep="" numDivLines="25" drawAnchors="0" xAxisName="AGE(Years)" yAxisName="Weight (Kg)" bgColor="#DDDDDD" showBorder="0"   use3DLighting="0" chartRightMargin="40"  showLegend="0" showValues="0" divLineColor="#0245EF" yAxisMaxValue="20"  alternateHGridAlpha="20" showAlternateHGridColor="0" showAlternateVGridColor="0"  decimalPrecision="5" baseFontColor="#000" animation="0">';
