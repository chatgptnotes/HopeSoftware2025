...
<?php
//debug($diagnosis);
$strXML ='<chart caption="BMI Growth Chart for infants (Girls)" subCaption="0 to 36 Months" anchorBgColor="#000" canvasBgColor="#DDDDDD" numVDivLines="35" bgAlpha="100" labelStep="90"   connectNullData="1"  yAxisMinValue="40" yAxisValuesStep="" numDivLines="25" drawAnchors="0" xAxisName="AGE(Years)" yAxisName="BMI Value (Kg/m2)" bgColor="#DDDDDD" showBorder="0"   use3DLighting="0" chartRightMargin="40"  showLegend="0" showValues="0" divLineColor="#F90792"   alternateHGridAlpha="20" showAlternateHGridColor="0" showAlternateVGridColor="0"  decimalPrecision="5" baseFontColor="#000" animation="0">';
