<?php echo $this->Html->css(array('internal_style','home-slider.css','ibox.css','jquery.fancybox-1.3.4.css'));  
...
$(function() {
        ...
        var canvas = document.getElementById("canvas");
        var p_canvas = parent.document.getElementById("parent_canvas_card");
        ...
        if (canvas.toDataURL) {
                ...
                saveCB = function(data) { 
                        ...
                        if (pos >= 4 * 320 * 240) {
                                ...
                                parent.document.getElementById('parent_canvas_card').style.display = "block";
                                parent.document.getElementById('web_cam_card').value= canvas.toDataURL("image/png");
