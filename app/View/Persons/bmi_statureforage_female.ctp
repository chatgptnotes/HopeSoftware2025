...
<div class="inner_title">
	...
	<?php
	//debug($diagnosis);
	$strXML ='<chart caption="Stature for Age Chart for Females" subCaption="2 Years to 20 Years" labelStep="365" canvasBgColor="#DDDDDD" anchorBgColor="#000" numVDivLines="35" bgAlpha="100" adjustDiv="1" toolTipBgColor="DDDDDD"  connectNullData="1"  yAxisMinValue="75" yAxisValuesStep="3" numDivLines="35" drawAnchors="0" xAxisName="AGE(Years)" yAxisName="Stature (cm)" bgColor="#DDDDDD" showBorder="0"   use3DLighting="0" chartRightMargin="40"  showLegend="0" showValues="0" divLineColor="#F90792" yAxisMaxValue="200"  alternateHGridAlpha="20" showAlternateHGridColor="0" showAlternateVGridColor="0"  decimalPrecision="5" baseFontColor="#000" animation="0">';
