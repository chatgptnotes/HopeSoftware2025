<?php
	...
	if(empty($facilityname)) {
	  	$facilitynamewithreport = 'Total Registration Report By Patient Location'; 
	  	$facilityname = "";
	}
	else {
	    $headerString = "by ".$facilityname ;
		$facilitynamewithreport = $facilityname.'-Total Registration Report By Patient Location'; 
	}
	...
	$html ='<div style="margin-top:200px;">&nbsp;<span>Date: '.$this->DateFormat->formatDate2Local(date('Y-m-d'),Configure::read('date_format'), false).'</span><br><br></div>
			<table border="1" class="table_format"  cellpadding="2" cellspacing="0" width="100%" style="text-align:left;padding-top:50px;">				  
				  <tr class="row_title" style="background-color:#A1B6BE;">
				       <td height="30px" align="center" valign="middle" width="6%"><strong>Sr.No.</strong></td>
					   <td height="30px" align="center" valign="middle" width="9%"><strong>Date Of Reg.</strong></td>
					   <td height="30px" align="center" valign="middle" width="13%"><strong><?php echo __("MRN")?></strong></td>
					   ...
					   <td height="30px" align="center" valign="middle" width="5%"><strong>Blood Group</strong></td>
					   <td height="30px" align="center" valign="middle" width="7%"><strong>Patient Type</strong></td>
			<!--	   <td height="30px" align="center" valign="middle" width="8%"><strong>Treatment Type</strong></td>  -->
					   <td height="30px" align="center" valign="middle" width="10%"><strong>City</strong></td>
		...
		$html .='</tr>';  
	      ...
	      if(count($reports[0]) > 0) {
			   $k = 1; 
	      		foreach($reports as $pdfData){	
					...
					$html .= '<tr>
									...
									$html.='
									<!--<td align="center" height="17px">'.$treatment_type[$patient['treatment_type']].'</td> -->
			   ...
			   $html .=' <tr>
							...
							<td height="30px" align="center" valign="bottom" colspan="12"><strong>Total Patients: '.(count($reports)).'</strong></td>											
...
//pr($html);exit;
	...
	echo $tcpdf->Output('Registration_Report_By_Patient_Location'.$this->DateFormat->formatDate2Local(date('Y-m-d H:i:s'),Configure::read('date_format'), true).'.pdf', 'D');
