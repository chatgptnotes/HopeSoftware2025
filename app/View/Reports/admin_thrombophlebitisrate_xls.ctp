...
header ("Content-Disposition: attachment;  filename=\"Thrombophlebitis_Rate".$this->DateFormat->formatDate2Local(date('Y-m-d H:i:s'),Configure::read('date_format'), true)
.".xls");
...
<STYLE type="text/css">
 ...
 <table border='1' class='table_format'  cellpadding='0' cellspacing='0' width='100%' style='text-align:left;padding-top:50px;'>	
  <tr><td colspan="13" align="center"><h2><?php echo __("Thrombophlebitis Rate")." - ".$reportYear;  ?></h2></td></tr>
          <tr>
           <td width='30%'></td>
	  ...
	  <tr>
		<td height='30px' align='left' valign='middle'><strong><?php echo __('Total Number of Thrombophlebitis Cases', true); ?></strong></td>
	  <?php 
	  ...
	  ?>
          ...
          <tr>
		<td height='30px' align='left' valign='middle'><strong><?php  echo __('Total Number of Thrombophlebitis Days', true);  ?></strong></td>  
	  <?php 
		foreach($yaxisArray as $key => $yaxisArrayVal) {
	  ?>
                 <td height='30px' align='center' valign='middle'>
         ...
         <tr>
		<td height='30px' align='left' valign='middle'><strong><?php  echo __('Thrombophlebitis Rate', true); ?></strong></td>   
	  <?php 
		foreach($yaxisArray as $key => $yaxisArrayVal) {
	  ?>
                <td height='30px' align='center' valign='middle'>
