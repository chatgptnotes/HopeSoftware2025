<div class="inner_title">
	<h3>
		<?php echo __('Pharmacy Stock & Sales Report', true); ?>
	</h3>
	<span>
...
<?php  echo $this->Form->create('',array('action'=>'pharmacyStockSalesAnalysisReport','type' => 'POST','id'=>'reportfrm','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false,
																								        'legend'=>false,
