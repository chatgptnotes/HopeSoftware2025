...
<h3>&nbsp;<?php echo __('Mortality Rate', true); ?></h3>
 ...
 <form name="reportfrm" id="reportfrm" action="<?php echo $this->Html->url(array("controller" => "reports", "action" => "birth_death")); ?>" method="post" >
 <table align="center">
	...
	<tr>
	 ...
	 <td colspan="8" align="left"><?php
		echo $this->Form->input('format', array('id' => 'format', 'label'=> false, 'div' => false, 'error' => false,'onChange'=>'checkFormat(this.value);','options'=>array('EXCEL'=>'EXCEL','PDF'=>'PDF','GRAPH'=>'GRAPH')));
	 ?></td>
	 </tr>
	<tr id="fromDate">
	...
	<tr id="toDate">
	 ...
	 ?>
		<tr id="report_type">
		   ...
		   <td colspan="8" align="left">
			<?php 
	        echo $this->Form->input('reportType', array('id'=>'reportType','label'=> false, 'div' => false, 'error' => false,'options' =>$reportType,'selected'=>$reportType['Death']));?>
	...
	<?php 
	 ...
	 ?>
		<tr id="month" style="display:none;">
		   ...
		   <td colspan="8" align="left">
			<?php 
	        echo $this->Form->input('month', array('id'=>'month','label'=> false, 'div' => false, 'error' => false,'options' =>$monthArray,'empty'=>'Select Month'));?>
  ...
  $( "#reportfrm" ).click(function(){
     ...
     /*function getValidate(){  
		...
		if(get == 'GRAPH'){
			...
			document.getElementById('report_type').style.display = 'none';
		// Change the action graph
			document.reportfrm.action =basePath+"admin/reports/birth_death_chart";
		...
		document.reportfrm.action =basePath+"admin/reports/birth_death";	
