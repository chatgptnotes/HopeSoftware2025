...
<!-- 	</tr> -->
	<tr >
		<td valign="top">&nbsp;7</td>
		<td class="tbLabel">&nbsp;<?php echo $this->Html->link('Department-wise Collection Report',array('controller'=>'Users','action'=>'profitDepartment','admin'=>false));?>
			
		</td>
	</tr>
	<tr class="row_gray">
		<td valign="top">&nbsp;8</td>
		<td class="tbLabel">&nbsp;<?php echo $this->Html->link('Physician-wise Profit Sharing Collection Report',array('controller'=>'Users','action'=>'profitPhysician','admin'=>false));?>
