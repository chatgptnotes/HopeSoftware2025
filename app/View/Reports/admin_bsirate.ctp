...
<?php echo $this->Form->create('Reports',array('action'=>'bsirate','type'=>'post', 'id'=> 'bsiratefrm'));?>	
<table border="0"   cellpadding="0" cellspacing="0" width="500px" >
 ...
 <?php echo $this->Form->end();?>
   ...
   <?php 
                        echo $this->Form->create('Reports',array('action'=>'bsirate_chart','type'=>'post', 'id'=> 'bsiratechartfrm', 'style'=> 'float:left;'));
		        ...
		        echo $this->Form->end();
                        ...
                        echo $this->Form->create('Reports',array('action'=>'bsirate_xls','type'=>'post', 'id'=> 'bsiratexlsfrm', 'style'=> 'float:left;'));
		        echo $this->Form->input(null, array('type' => 'hidden', 'name'=> 'reportYear', 'value' =>$reportYear));
  ...
  <div class="clr ht5"></div>
   ...
   <table width="100%" cellpadding="0" cellspacing="1" border="0" class="tabularForm">
	  ...
	  <tr>
		<td><?php echo __('Total Number of BSI Cases', true); ?></td>   
	  <?php 
	  ...
	  ?>
          ...
          <tr>
		<td><?php  echo __('Total Number of BSI Days', true);  ?></td>   
	  <?php 
		foreach($yaxisArray as $key => $yaxisArrayVal) {
	  ?>
                 <td align="center">
         ...
         <tr>
		<td><b><?php  echo __('BSI Rate', true); ?></b></td>   
	  <?php 
		foreach($yaxisArray as $key => $yaxisArrayVal) {
	  ?>
                <td align="center">
