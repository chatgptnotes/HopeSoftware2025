...
<h3>&nbsp;<?php echo __('Daily Cheque Collection and NEFT Details', true); ?></h3>

</div>
 <form name="reportfrm" id="reportfrm" action="<?php echo $this->Html->url(array("controller" => "reports", "action" => "daily_check_collection")); ?>" method="post" >
 <table align="center">
	...
	<tr>
	 <td colspan="8" align="right"><?php echo __('Collection Type'); ?></td>
	 <td><b>:</b></td>
	 <td colspan="8" align="left">
	  <?php 
             echo $this->Form->input('collection_type', array('id'=>'collection_type','label'=> false, 'div' => false, 'error' => false, 'options'=>array(''=>'All','NEFT'=>'NEFT','Cheque'=>'Cheque')));
          ?>
	 </td>
	</tr>
	<tr>
