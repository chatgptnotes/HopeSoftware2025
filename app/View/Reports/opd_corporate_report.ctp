...
<div class="inner_title">
	<h3>
		<?php echo __('OPD Corporate Report', true); ?>
	</h3>
	<span>
		<?php echo $this->Html->link(__('Back to Dashboard'), array('controller'=>'Appointments','action' => 'appointments_management','admin'=>false), array('escape' => false,'class'=>'blueBtn'));?>
	</span>
</div> 
<?php }else{ ?>
	<table>
...
<?php } ?>
<?php echo $this->Form->create('Patient',array('type'=>'get','id'=>'Patient','url'=>array('controller'=>'Reports','action'=>'opd_corporate_report','admin'=>false),));?>
	...
	<td width="95%" valign="top">
		...
		<table align="center" style="margin-top: 10px">
			<tr>
				...
				<td><?php echo $this->Html->link($this->Html->image('icons/refresh-icon.png'),array('action'=>'opd_corporate_report'),array('escape'=>false));?></td>
				
				<?php if($this->params->query){
						$qryStr=$this->params->query;
						}?>
				
				<td><?php echo $this->Html->link($this->Html->image('icons/excel.png'),array('controller'=>'Reports','action'=>'opd_corporate_report','excel','?'=>$qryStr,'admin'=>false,'alt'=>'Export To Excel'),array('escape'=>false,'title' => 'Export To Excel'))?><?php echo $this->Form->end();?></td>
			</tr>
		</table>
			...
			<table width="100%" cellpadding="0" cellspacing="1" border="<?php echo $border ;  ?>" 	class="tabularForm">
				<thead>
					<tr> 
						...
						<th width="10%" align="center" valign="top" style="text-align: center;"><?php echo __('OPD Date');?></th> 
