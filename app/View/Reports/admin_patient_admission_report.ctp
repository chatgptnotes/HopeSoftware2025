...
<h3>&nbsp; <?php echo __('Total New Visits Report', true); ?></h3>
 ...
 <table align="center">
	...
	<!-- <tr>
	 ...
	 <td colspan="8" align="left"><?php
		echo $this->Form->input('PatientAdmissionReport.type', array('id' => 'itemtype', 'label'=> false, 'div' => false, 'error' => false,'options'=>array('Daily'=>'Daily','Weekly'=>'Weekly','Monthly'=>'Monthly','Yearly'=>'Yealy')));
	 ?></td>
	 </tr> -->
	 <tr>
	...
	<tr>
	   <td colspan="8" align="right"><?php echo __('Patient Admission Type'); ?></td>
	   <td><b>:</b></td>
	   <td colspan="8" align="left">
		<?php 
        echo $this->Form->input('PatientAdmissionReport.type', array('id'=>'patient_type','onchange'=>'getPerpose(this.value);','label'=> false, 'div' => false, 'error' => false,'empty'=>'All','options'=>array('IPD'=>'IPD','OPD'=>'OPD')));?>
  ...
  <tr>
	   ...
	   <td colspan="6" align="left">
		<?php 
        echo $this->Form->input('PatientAdmissionReport.pt_type', array('id'=>'pt_type','label'=> false, 'div' => false, 'error' => false,'empty'=>'All','options'=>array('private'=>'Private','corporate'=>'Corporate')));?>
	   </td>
	   <td class='tariff'>Tariff:</td>
	   <td class='tariff'><?php echo $this->Form->input('PatientAdmissionReport.tariff_standard_id',
	   		array('id'=>'tariff_standard','empty'=>'All Tariff','options'=>$tariffStandard,'div'=>false,'label'=>false,
	   				));?></td>
	   
  </tr>
  <tr id="perpose">
	   <td colspan="8" align="right"><?php echo __('Visit Purpose'); ?></td>
	   <td><b>:</b></td>
	   <td colspan="8" align="left">
		 <?php 
			    ...
			    // echo $this->Form->input('PatientAdmissionReport.treatment_type', array('empty'=>__('Select Type'),'options'=>$opdoptions,'id' => 'opd_id','label'=>false,'div'=>false)); 
			     echo $this->Form->input('PatientAdmissionReport.treatment_type', array('empty'=>__('Select Type'),'options'=>$opdoptions,'id' => 'opd_id','label'=>false,'div'=>false,'selected'=>$getOPCheck));
			     ?>
  ...
  <!--<tr>
	   <td colspan="8" align="right">Reference Doctor</td>
	   <td><b>:</b></td>
	   <td colspan="8" align="left">
		<?php 
  ...
  <!--<tr>
	   ...
	   <td colspan="8" align="left">
        ...
        //echo $this->Form->input('PatientAdmissionReport.patient_location', array('empty'=>'Please select','id'=>'patient_location','label'=> false, 'div' => false, 'error' => false,'options'=>$patient_location));?>
  ...
  <script language="javascript" type="text/javascript">
    function getValidate1(){  
		...
		if($("#SelectRight option:selected").val() == 'undefined'){
			...
			alert('Please Select the field to be displayed in report.');
			return false;
...
// TO set the format wise date or year selection
	function checkFormat(get){
		...
		// Change the action graph
			document.reportfrm.action =basePath+"admin/reports/patient_admission_report_chart";
		...
		document.reportfrm.action =basePath+"admin/reports/patient_admission_report";	
...
// TO display visit perpose on the fly. with selecting OPD
	function getPerpose(perpose){
		if(perpose == 'OPD'){
			$('#perpose').show('slow');
			document.getElementById('opd_id').disabled = false;
		} else {
			$('#perpose').hide('fast');
			document.getElementById('opd_id').disabled = true;
		}
	}

	$('#pt_type').change(function(){
		var pat_type=$(this).val();
		if(pat_type=='corporate'){
			$('.tariff').show();
		}else{
			$('.tariff').hide();
		}
