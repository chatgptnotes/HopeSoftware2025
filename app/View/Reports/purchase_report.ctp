<div class="inner_title">
	<h3>
		<?php echo __('Pharmacy Purchase Report', true); ?>
	</h3>
	<span>
...
<?php  echo $this->Form->create('',array('action'=>'purchaseReport','type' => 'POST','id'=>'reportfrm','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false,
																								        'legend'=>false,
 ...
 <table align="center">  
	...
	<tr>
	 ...
	 <td><b>:</b></td>
	  <td align="left">
		<?php 
        echo $this->Form->input('PharmacySale.to', array('class'=>'validate[required,custom[mandatory-date]] textBoxExpnd dateFromTo','style'=>'width:120px;','id'=>'to','label'=> false, 'div' => false, 'error' => false));?>
	</td>
	  </tr>	
	  <tr>
	  <td align="right"><?php echo __('Party Number')?></td>
	 <td><b>:</b></td>
	  <td align="left">
		<?php 
        echo $this->Form->input('PharmacySale.party_number', array('class'=>'textBoxExpnd party_number','style'=>'width:120px;','id'=>'partyNumber','label'=> false, 'div' => false, 'error' => false));?>
	</td>
	  </tr>
 </table>
...
$('#partyNumber').autocomplete({
	source: "<?php echo $this->Html->url(array("controller" => "app", "action" => "advance_autocomplete","PurchaseOrder","party_invoice_number","null",'0',"null","admin" => false,"plugin"=>false)); ?>",
	 minLength: 1,				
