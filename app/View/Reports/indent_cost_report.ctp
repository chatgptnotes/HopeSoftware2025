...
<?php echo $this->Form->create('',array('id'=>'content_indent'));?> 
			...
			<tr> 
	           ...
	           <td><?php echo __(' To : '); ?></td>
				...
				<td>&nbsp;</td>
	           <td><?php echo __(' Trans Mode : '); ?></td>
				<td>
		 			<?php echo $this->Form->input('',array('name'=>'mode','empty'=>'Please select','options'=>array('Sales'=>'Sales','DepReq'=>'DepReq'), 'class'=>'textBoxExpnd','label'=> false,'div' => false,)); ?>
		 		</td>
				<td>&nbsp;</td>
	           <td><?php echo __(' Department : '); ?></td>
		 		<td>
		 			<?php  echo $this->Form->input('',array('name'=>'department','empty'=>'Please select','options'=>array('KCHRC'=>'KCHRC','APAM'=>'APAM','OT Pharmacy'=>'OT Pharmacy','Central Store'=>'Central Store'),'class'=>'textBoxExpnd','id'=>'guarantor_id', 'label'=> false,'div' => false,)); ?>
		 		</td>
		 		<td>&nbsp;</td> 
			...
			<table  width="100%" cellpadding="0" cellspacing="0" border="" class="tabularForm">
				<tr>
					...
					<th width="51px" valign="top" align="center" style="text-align:center;">Quantity</th>
					<th width="50px" valign="top" align="center" style="text-align:center;">Cost Price</th>
					<th width="48px" valign="top" align="center" style="text-align:center;">MRP</th>
					<th width="90px" valign="top" align="center" style="text-align:center;">Rate</th>
					</thead>
				</tr>
