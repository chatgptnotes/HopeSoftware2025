...
<h3>&nbsp;<?php echo __('Daily Credit Card Collection', true); ?></h3>

</div>
 <form name="reportfrm" id="reportfrm" action="<?php echo $this->Html->url(array("controller" => "reports", "action" => "daily_credit_collection")); ?>" method="post" >
 <table align="center">
