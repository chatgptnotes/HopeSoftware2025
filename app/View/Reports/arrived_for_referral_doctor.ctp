...
<div class="inner_title">
	<h3>
		<?php echo __('No. of Arrivals Patients from Referral Doctor Report', true); ?>
	</h3>
...
<?php  echo $this->Form->create('',array('action'=>'arrived_for_referral_doctor','type' => 'get','id'=>'referalfrm','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false,
																								        'legend'=>false,
