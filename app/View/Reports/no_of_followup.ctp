<div class="inner_title">
	<h3>
		<?php echo __('No. of Follow Up Patients', true); ?>
	</h3>
...
<script>
	...
	jQuery("#noofFollowupfrm").validationEngine();
	});
	
</script>

<?php  echo $this->Form->create('',array('action'=>'no_of_followup','type' => 'get','id'=>'noofFollowupfrm','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false,
																								        'legend'=>false,
...
<table width="50%" cellpadding="0" cellspacing="2" border="0" 	class="tabularForm" id="content-list"><!-- style="border-bottom:solid 10px #E7EEEF;" -->
	<tr>
	 <td colspan="8"><?php echo "Total No. of Follow Up Patients: <b>".$getDataCount."</b>";
								?>
	 </td>
	 </tr>
	<tr> 
  ...
  ?>
    <td class="row_format"><?php echo $personval['Patient']['lookup_name']; ?> </td>
      <td class="row_format"><?php echo ucfirst($personval['Person']['sex']); ?> </td>
  <td class="row_format"><?php echo $this->General->getCurrentAge($personval['Person']['dob']); ?> </td>
  </tr> 
  <?php endforeach;  
