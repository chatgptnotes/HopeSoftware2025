...
<h3>&nbsp; <?php echo __('Time Taken For Discharge', true); ?></h3>

</div>
 <form name="reportfrm" id="reportfrm" action="<?php echo $this->Html->url(array("controller" => $this->params['controller'], "action" => "admin_time_taken_for_discharge/")); ?>" method="post" >
 <table align="center">
	 <tr>
		 <td colspan="8" align="right">Format</td>
		 <td><b>:</b></td>
		 <td colspan="8" align="left" width="70%"><?php
			echo $this->Form->input('DischargeSummary.format', array('id' => 'formattype', 'label'=> false, 'div' => false, 'error' => false,'options'=>array('EXCEL'=>'EXCEL','PDF'=>'PDF')));
		...
		<tr id = "year">
		 ...
		 <td><b>:</b></td>
		  <td colspan="8" align="left">
			<?php 
	        echo $this->Form->input('DischargeSummary.year', array('id'=>'year','label'=> false, 'div' => false, 'error' => false,'options' =>$lastTenYear));?>
	 ...
	 ?>
		<tr id="month">
		   ...
		   <td colspan="8" align="left">
			<?php 
	        echo $this->Form->input('DischargeSummary.month', array('id'=>'month','label'=> false, 'div' => false, 'error' => false,'options' =>$monthArray,'empty'=>'All'));?>
