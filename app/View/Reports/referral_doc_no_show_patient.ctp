...
<div class="inner_title">
	<h3>
		<?php echo __('No. of No shows Patients from Referral Doctor Report', true); ?>
	</h3>
...
<?php  echo $this->Form->create('',array('action'=>'referral_doc_no_show_patient','type' => 'get','id'=>'referalfrm','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false,
																								        'legend'=>false,
...
<table width="100%" cellpadding="0" cellspacing="2" border="0" 	class="tabularForm" id="content-list" style="margin:10px 10px 10px 10px;"><!-- style="border-bottom:solid 10px #E7EEEF;" -->
	<tr>
	 <td colspan="8"><?php echo "Total No. of No shows Patients: <b>".$getDataCount."</b>";
								?>
	 </td></tr>
	<tr> 
		...
		<th width="16%" align="center" valign="top" style="text-align: center; min-width: 150px;">No-Show</th> 
		<th width="16%" align="center" valign="top" style="text-align: center; min-width: 150px;">Date</th> 	
  ...
  <td class="row_format" align="center"><?php echo $this->General->getCurrentAge($personval['Person']['dob']); ?> </td>
   <td class="row_format" align="center"><?php echo ucfirst($personval['Appointment']['status']); ?> </td>
    <td class="row_format" align="center"><?php echo $this->DateFormat->formatDate2Local($personval['Appointment']['date'],
