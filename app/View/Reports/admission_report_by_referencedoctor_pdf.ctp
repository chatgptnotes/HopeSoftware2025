<?php
	...
	if(empty($facilityname)) {
	  	$facilitynamewithreport = 'Registration Report By Referral Doctorfggfhhgfh'; 
	  	$facilityname = "";
	}
	else {
	...
	$html ='<div style="margin-top:200px;">&nbsp;<span>Date: '.$this->DateFormat->formatDate2Local(date('Y-m-d'),Configure::read('date_format'), false).'</span><br><br></div>
			<table border="1" class="table_format"  cellpadding="2" cellspacing="0" width="100%" style="text-align:left;padding-top:50px;">				  
				  <tr class="row_title" style="background-color:#A1B6BE;">
					   ...
					   <td height="30px" align="center" valign="middle" width="13%"><strong>'.__("MRN").'</strong></td>
					   ...
					   <td height="30px" align="center" valign="middle" width="6%"><strong>'.__("Sex").'</strong></td>
					   <td height="30px" align="center" valign="middle" width="5%"><strong>'.__("Blood Group").'</strong></td>
					   <td height="30px" align="center" valign="middle" width="7%"><strong>'.__("Patient Type").'</strong></td>
					   <td height="30px" align="center" valign="middle" width="8%"><strong>'.__("Patient Status").'</strong></td>
					   <td height="30px" align="center" valign="middle" width="10%"><strong>'.__("City").'</strong></td>
                       <td height="30px" align="center" valign="middle" width="10%"><strong>'.__("Referral Doctor").'</strong></td>
					   <td height="30px" align="center" valign="middle" width="10%"><strong>'.__("Treating Consultant").'</strong></td>'; 
			   ...
			   $k = 1; 
	      		foreach($reports as $pdfData){	
					...
					$html .= '<tr>
									...
									$html.='
										<td align="center" height="17px">'.$patientstatus.'</td>
										<td align="center" height="17px">'.$person['city'].'</td>
                                        <td align="center" height="17px">'.$pdfData['InitialAlias']['name'].' '.$pdfData[0]['consultant_name'].'</td>
...
//pr($html);exit;
	...
	echo $tcpdf->Output('Registration_Report_By_Referral_Doctor'.$this->DateFormat->formatDate2Local(date('Y-m-d H:i:s'),Configure::read('date_format'), true).'.pdf', 'D');
