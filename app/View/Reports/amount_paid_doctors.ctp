...
<?php } ?>
<?php echo $this->Form->create('Patient',array('type'=>'get','id'=>'Patient','url'=>array('controller'=>'Reports','action'=>'amount_paid_doctors','admin'=>false),));?>
			...
			<table width="100%" cellpadding="0" cellspacing="1" border="<?php echo $border ;  ?>" 	class="tabularForm">
				<thead>
					<tr> 
						...
						<th width="20%" align="center" valign="top"><?php echo __('Doctors Name');?></th> 
						<th width="10%" align="center" valign="top" style="text-align: center;"><?php echo __('Admission Type');?></th> 
						<th width="10%" align="center" valign="top" style="text-align: center;"><?php echo __('Ampunt Paid');?></th> 
				...
				foreach($record as $key=> $value) { 
					...
					<tr>
						<td><?php echo $i ; ?></td>
						<td><?php echo $value['DoctorProfile']['first_name'] ; ?> <?php echo $value['DoctorProfile']['last_name'] ; ?></td>
						<td><?php echo $value['Patient']['admission_type'] ; ?></td>
