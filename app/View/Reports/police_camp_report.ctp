...
<?php } ?>
<?php echo $this->Form->create('Patient',array('type'=>'get','id'=>'Patient','url'=>array('controller'=>'Reports','action'=>'police_camp_report','admin'=>false),));?>
	...
	<td width="95%" valign="top">
		...
		<table align="center" style="margin-top: 10px">
			<tr>
				...
				<td><?php echo $this->Html->link($this->Html->image('icons/refresh-icon.png'),array('action'=>'police_camp_report'),array('escape'=>false));?></td>
				
				<?php if($this->params->query){
						$qryStr=$this->params->query;
						}?>
				
				<td><?php echo $this->Html->link($this->Html->image('icons/excel.png'),array('controller'=>'Reports','action'=>'police_camp_report','excel','?'=>$qryStr,'admin'=>false,'alt'=>'Export To Excel'),array('escape'=>false,'title' => 'Export To Excel'))?><?php echo $this->Form->end();?></td>
			</tr>
		</table>
			...
			<table width="100%" cellpadding="0" cellspacing="1" border="<?php echo $border ;  ?>" 	class="tabularForm">
				<thead>
					<tr> 
						...
						<th width="10%" align="center" valign="top" style="text-align: center;"><?php echo __('Date of Check-up');?></th> 
						<th width="10%" align="center" valign="top" style="text-align: center;"><?php echo __('Invoice No.');?></th> 
						<th width="10%" align="center" valign="top" style="text-align: center;"><?php echo __('Date of Invoice');?></th> 
						<th width="35%" align="center" valign="top" style="text-align: center;"><?php echo __('PS/Branch');?></th> 
					</tr> 
				</thead>
				...
				foreach($record as $key=> $value) { 
					...
					<tr>
						...
						<td><?php echo $value['OpdInvoice']['bill_number'] ; ?></td>
						<td><?php echo $this->DateFormat->formatdate2Local($value['OpdInvoice']['date'],Configure::read('date_format'),false); ?></td>
						<td><?php echo $value['Patient']['name_police_station'] ; ?></td>
				  	</tr>
			  	<?php $i++; }?>
				</tbody>
