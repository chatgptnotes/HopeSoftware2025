...
<h3>&nbsp; <?php echo __('Sales VAT and SAT Report', true); ?></h3>
<span><?php
...
<br />
 ...
 <form name="reportfrm" id="reportfrm" action="<?php echo $this->Html->url(array("controller" => $this->params['controller'], "action" => "sale_sat_vat_report/", )); ?>" method="post" >
 <table align="center"> 
