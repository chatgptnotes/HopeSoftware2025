...
<h3><?php echo __('Total Number Of Anesthesia', true).' - '.$reportYear; ?></h3>
</div>
...
<div id="chartContainer">FusionCharts will load here</div>
 ...
 <div>
	...
	$strXML = '<chart caption="Total Number Of Anesthesia" legendBgColor="1B1B1B"  bgColor="#4C5E64" baseFontColor="ffffff" divLineIsDashed="1" divLineColor="AFD8F8" toolTipBgColor="1B1B1B" showBorder="1" canvasBgColor="1B1B1B" canvasBaseColor="1B1B1B" use3DLighting="0" bgAlpha="100" xaxisname="Months" yaxisname="Count"  decimalPrecision="0" yAxisMaxValue="5">';
   ...
   <div class="btns" style="padding-right: 105px;">
           <?php echo $this->Html->link(__('Back'),array('controller'=>'reports','action'=>'total_anesthesia', 'admin'=>true),array('class'=>'grayBtn','div'=>false)); ?>
   </div>