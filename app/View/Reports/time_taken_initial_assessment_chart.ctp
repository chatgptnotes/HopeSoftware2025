...
<h3><?php echo __('Time Taken For Initial Assessment', true).' - '.$reportYear; ?></h3>
</div>
...
<div id="chartContainer">FusionCharts will load here</div>
 ...
 <div>
	...
	$strXML = '<chart caption= "Time Taken For Initial Assessment For {$patientType}" legendBgColor="1B1B1B"  bgColor="#4C5E64" baseFontColor="ffffff" divLineIsDashed="1" divLineColor="AFD8F8" toolTipBgColor="1B1B1B" showBorder="1" canvasBgColor="1B1B1B" canvasBaseColor="1B1B1B" use3DLighting="0" bgAlpha="100" xaxisname="Months" yaxisname="Hours"  decimalPrecision="0" yAxisMaxValue="20">';
	...
	?>
	   <script> var datastring = '<?php echo $strXML; ?>';</script>
					   <?php echo $this->JsFusionChart->showFusionChart("/fusionx_charts/MSColumn3D.swf", "totalanesthesia", "900", "500", "0", "0", "datastring", "chartContainer"); ?>
					   </div>        
   <div class="btns" style="padding-right: 105px;">
           <?php echo $this->Html->link(__('Back'),array('controller'=>'reports','action'=>'time_taken_initial_assessment', 'admin'=>true),array('class'=>'grayBtn','div'=>false)); ?>
   </div>