...
<tr><td colspan="8"  align="center"><h3><?php echo __("Patient Survey Reports"); ?></h3></td></tr>
<tr class='row_title'>
                                 <td height='30px' align='center' valign='middle' width='4%'><strong><?php echo __('Sr.', true); ?></strong></td>
                                 <td height='30px' align='left' valign='middle' width='80%'><strong><?php echo __('Questions', true); ?></strong></td>
                                 <td height='30px' align='center' valign='middle' width='15%'><strong><?php echo __('Strongly Agree', true); ?></strong></td>
                                 <td height='30px' align='center' valign='middle' width='15%'><strong><?php echo __('Agree', true); ?></strong></td>
                                 <td height='30px' align='center' valign='middle' width='15%'><strong><?php echo __('Neither Agree Nor  Disagree', true); ?></strong></td>
                                 <td height='30px' align='center' valign='middle' width='15%'><strong><?php echo __('Disagree', true); ?></strong></td>
                                 <td height='30px' align='center' valign='middle' width='15%'><strong><?php echo __('Strongly Disagree', true); ?></strong></td>
                                 <td height='30px' align='center' valign='middle' width='15%'><strong><?php echo __('Not Applicable', true); ?></strong></td>
				</tr>
              <?php 
                   for($i=1; $i <33; $i++) {
              ?>
