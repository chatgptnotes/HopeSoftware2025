...
<div class="inner_title">
    <h3>&nbsp; <?php echo __('Monthly Summary Of Sale Vouchers Report', true); ?></h3>
    <span><?php
...
<?php echo $this->Form->create('', array('action' => 'pharmacySaleVoucherCollectionReport', 'type' => 'POST', 'id' => 'reportfrm', 'inputDefaults' => array()
));
?>			
<table align="center"> 
    <tr>
...
?></td>
    ...
    <tr>
        ...
        <td colspan="8" align="left">
            <?php echo $this->Form->input('PharmacySale.from', array('class' => 'validate[required,custom[mandatory-date]] textBoxExpnd', 'style' => 'width:120px;', 'id' => 'from', 'label' => false, 'div' => false, 'error' => false)); ?>
...
<script>
    $(document).ready(function(){
        ...
        $("#view,#refreshBtn").click(function(){ 
            ...
            $.ajax({
                url: '<?php echo $this->Html->url(array('controller' => 'Reports', 'action' => 'viewPharmacySaleVoucherCollectionReport')); ?>',
