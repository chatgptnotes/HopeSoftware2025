...
<h3><?php echo __('SSI Rate', true); ?></h3>
 ...
 <div style="text-align: right;" class="inner_title">
   <?php 
    echo $this->Html->link(__('Generate Excel Report'), array('action' => 'ssirate_xlsreports', 'admin'=> true), array('escape' => false,'class'=>'blueBtn'));
   ?>
<div class="clr ht5"></div>
</div>                   
                   <table width="100%" cellpadding="0" cellspacing="1" border="0" class="tabularForm">
						 ...
						 <th><?php echo __('Number of Surgical Procedure', true); ?></th>
                                                 <th><?php echo __('SSI Rate', true); ?></th>
                                </tr>
                                <tr>
