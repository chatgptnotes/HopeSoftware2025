			...
			<table cellpadding="0" cellspacing="" border="0" align="center">
				<tr> 
					...
					<td>&nbsp;</td>
		 			...
		 			<td>
						<?php echo $this->Form->input('',array('type'=>'text','value'=>$this->params->query['item_name'],'name'=>'item_name','class'=>'validate[required]', 'id'=>'item_name','style'=>"width:90%",'class'=>'textBoxExpnd','label'=>false,'div'=>false)); ?>
		 				<?php echo $this->Form->hidden('',array('name'=>'product_id','value'=>$this->params->query['product_id'],'id'=>'product_id')); ?>
					</td>
					<td>&nbsp;</td>
					...
					<td>&nbsp;</td>
					<td>
						<?php echo $this->Html->link($this->Html->image('icons/refresh-icon.png'),array('action'=>'stock_register'),array('escape'=>false, 'title' => 'refresh'));?>
					</td>
				</tr>
			</table> 
				<div class="clr ht5"></div>
			<table width="100%" cellpadding="0" cellspacing="0" border="" class="tabularForm">
				<thead>
					<tr>
						...
						<th width="" valign="middle" align="center" style="text-align:center;">Batches</th> 
						<th width="" valign="middle" align="center" style="text-align:center;">Trans</br>Date</th>
						<th width="" valign="middle" align="center" style="text-align:center;">Opening</br>Stock</th>
						<th width="" valign="middle" align="center" style="text-align:center;">Qty</th>
						<th width="" valign="middle" align="center" style="text-align:center;">Mode</th>
						<th width="" valign="middle" align="center" style="text-align:center;">Closing</br>Stock</th>
						<th width="" valign="middle" align="center" style="text-align:center;">Details</th>
						<th width="" valign="middle" align="center" style="text-align:center;">Doctor</th>
					</tr>
				</thead>
				<tbody>
				<?php
				...
				<tr>
					...
					<td style="text-align:center"><?php echo $records['batch_number'];?></td>
					<td style="text-align:center"><?php echo $records['create_time'];?></td>
					<td style="text-align:center"><?php echo $records['opening_stock'];?></td>
					<td style="text-align:center"><?php echo $records['qty'];?></td>
					<td style="text-align:center"><?php echo $records['type']; ?></td>
					<td style="text-align:center"><?php echo $records['closing_stock'];?></td>
					<td><?php echo $records['patient_name'];?></td>
