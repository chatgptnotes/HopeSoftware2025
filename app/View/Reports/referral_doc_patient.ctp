<div class="inner_title">
	<h3>
		<?php echo __('No. of Patients who didn`t Turned Up from Referral Doctor Report', true); ?>
	</h3>
...
<?php  echo $this->Form->create('',array('action'=>'referral_doc_patient','type' => 'get','id'=>'referalfrm','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false,
																								        'legend'=>false,
