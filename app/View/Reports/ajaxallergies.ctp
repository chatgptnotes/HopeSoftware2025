...
$this->Paginator->options(array('url' =>array("?"=>$queryStr['NewCropAllergies'])));?>
  <tr style="text-align: center;">
			<td colspan="20">
				<!-- Shows the next and previous links --> <?php echo $this->Paginator->prev(__('« Previous', true), array('update'=>'#demo_Allergies',    												
				...
				<?php echo $this->Paginator->next(__('Next »', true), array('update'=>'#demo_Allergies',    												
						'complete' => $this->Js->get('#busy-indicator')->effect('fadeOut', array('buffer' => false)),
		    		 	'before' => $this->Js->get('#busy-indicator')->effect('fadeIn', array('buffer' => false))), null, array('class' => 'paginator_links')); ?>
