...
<?php echo $this->Form->create('',array('id'=>'content_drugSale'));?> 
			...
			<tr> 
	           ...
	           <td><?php echo __(' Department : '); ?></td>
		 		<td>
		 			<?php echo $this->Form->input('',array('name'=>'department','empty'=>'Please select','options'=>array('KCHRC'=>'KCHRC','APAM'=>'APAM','OT Pharmacy'=>'OT Pharmacy','Central Store'=>'Central Store'),'id'=>'guarantor_id', 'label'=> false,'class'=>'textBoxExpnd','div' => false,)); ?>
		 		</td>
		 		<td>&nbsp;</td>
			...
			<table  width="100%" cellpadding="0" cellspacing="0" border="" class="tabularForm">
				<tr>
					...
					<th width="51px" valign="top" align="center" style="text-align:center;">Department Name</th>
					<th width="51px" valign="top" align="center" style="text-align:center;">Sale Quantity</th>
					<th width="50px" valign="top" align="center" style="text-align:center;">Sale Amount</th>
					<th width="48px" valign="top" align="center" style="text-align:center;">Toatal After</th>
					<th width="90px" valign="top" align="center" style="text-align:center;">Return Amount</th>
					<th width="50px" valign="top" align="center" style="text-align:center;">Profit</th>
					<th width="50px" valign="top" align="center" style="text-align:center;">Return Loss</th>
					</thead>
				</tr>
