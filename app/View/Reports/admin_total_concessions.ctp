...
<h3>&nbsp;<?php echo __('Total Concessions', true); ?></h3>

</div>
 <form name="reportfrm" id="reportfrm" action="<?php echo $this->Html->url(array("controller" => "reports", "action" => "total_concessions")); ?>" method="post" >
 <table align="center">
