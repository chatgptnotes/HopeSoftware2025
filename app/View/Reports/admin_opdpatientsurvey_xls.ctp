...
header ("Content-Disposition: attachment;  filename=\"OPD_Patient_Survey_Report".$this->DateFormat->formatDate2Local(date('Y-m-d H:i:s'),Configure::read('date_format'), true)
.".xls");
...
<?php 
  ...
  <table border='1' class='table_format'  cellpadding='0' cellspacing='0' width='100%' style='text-align:left;padding-top:50px;'>
   <tr><td colspan="93" align="center"><h2><?php echo __("OPD Patient Survey Report")." - ".$reportYear; ?></h2></td></tr>
          <tr>
           <td></td>
           <td></td>
          
           <?php foreach($yaxisArray as $key => $yaxisArrayVal) { ?>
                  <td height='30px' align='center' valign='middle' width='20%' colspan="7" ><strong><?php echo $yaxisArrayVal; ?></strong></td>
           <?php } ?>
		          <td style="text-align:center;" colspan="7"><strong><?php echo __('Total'); ?></strong></td>
           </tr>
          <tr>
           <td width='150'><strong><?php echo __('Parameters'); ?></strong></td>
           <td width='400'><strong><?php echo __('Questions'); ?></strong></td>
           <?php foreach($yaxisArray as $key => $yaxisArrayVal) { ?>
                    <td  align="center" width='100'><strong><?php echo __('Strongly Agree'); ?></strong></td>
                    <td align="center" width='100'><strong><?php echo __('Agree'); ?></strong></td>
                    <td  align="center" width='100'><strong><?php echo __('Neither Agree Nor Disagree'); ?></strong></td>
                    <td align="center" width='100'><strong><?php echo __('Disagree'); ?></strong></td>
                    <td  align="center" width='100'><strong><?php echo __('Strongly Disagree'); ?></strong></td>
                    <td  align="center" width='100'><strong><?php echo __('Total Score'); ?></strong></td>
                    <td  align="center" width='100'><strong><?php echo __('% to Highest Score (70*5)'); ?></strong></td>
