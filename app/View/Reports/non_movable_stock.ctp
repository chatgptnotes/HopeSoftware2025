...
<h3>&nbsp; <?php echo __('Non Movable Stock', true); ?></h3>
	 <span align="right" >
...
<?php echo $this->Form->create('',array('id'=>'content-form'));?>
			...
			<table align="center" cellpadding="0" cellspacing="" border="0" >
				<tr>
					...
					<td>
		 				<?php echo $this->Form->input('',array('name'=>'department','empty'=>'Please select','options'=>$location_id, 'label'=> false,'div' => false,'class'=>'textBoxExpnd')); ?>
		 			</td>
		 			<td>&nbsp;</td>
		 			<td><?php echo $this->Form->input('Search',array('type'=>'submit','class'=>'blueBtn','label'=>false,'div'=>false)); ?></td>
		 			<td>&nbsp;</td>
		 			<td><?php echo $this->Html->link($this->Html->image('icons/refresh-icon.png'),array('action'=>'non_movable_stock'),array('escape'=>false, 'title' => 'refresh'));?></td>
				</tr>
			</table> 
				<div class="clr ht5"></div>
			<table width="100%" cellpadding="0" cellspacing="0" border="" class="tabularForm">
				<tr>
					...
					<th width="51px" valign="top" align="center" style="text-align:center;">Expiry Date</th>
					</thead>
				</tr>
				<?php ?>
				<tr>
