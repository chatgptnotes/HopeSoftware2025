...
<h3>&nbsp; <?php echo __('Pharmacy Sales/Return Report', true); ?></h3>
<span><?php
...
<br />
 ...
 <form name="reportfrm" id="reportfrm" action="<?php echo $this->Html->url(array("controller" => $this->params['controller'], "action" => "admin_sales_report/", )); ?>" method="post" >
 <table align="center"> 
  ...
  <tr>
	   ...
	   <td colspan="8" align="left">
		<?php 
        echo $this->Form->input('PharmacySale.for', array('id'=>'for','label'=> false, 'div' => false, 'error' => false,"options"=>array("Sales"=>"Sales","Return"=>"Return")));?>
 ...
 <tr id="paymenttype">
	 ...
	 <td colspan="8" align="left">
	  <?php 
             echo $this->Form->input('PharmacySale.payment_type', array('id'=>'payment_type','label'=> false, 'div' => false, 'error' => false, 'options'=>array('all'=>'All','cash'=>'Cash','credit'=>'Credit')));
          ?>
	 </td>
	</tr>
	<tr>
	 <td colspan="8" align="right"><?php echo __('Show Items'); ?></td>
	 <td><b>:</b></td>
	 <td colspan="8" align="left">
	  <?php 
             echo $this->Form->checkbox('PharmacySale.show_item', array('id'=>'show_item','label'=> false, 'div' => false, 'error' => false));
          ?>
	 </td>
	</tr>
 </table>
