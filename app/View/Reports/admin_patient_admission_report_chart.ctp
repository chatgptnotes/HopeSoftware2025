...
<h3><?php echo __('Total MRN Report', true).' - '.$reportYear;  ?></h3>
</div>
...
<div id="chartContainer">FusionCharts will load here</div>
 ...
 <div>
   <?php
	...
	$strXML = '<chart caption="TOTAL REGISTRATION" legendBgColor="1B1B1B"  bgColor="#4C5E64" baseFontColor="ffffff" divLineIsDashed="1" divLineColor="AFD8F8" toolTipBgColor="1B1B1B" showBorder="1" canvasBgColor="1B1B1B" canvasBaseColor="1B1B1B" use3DLighting="0" bgAlpha="100" xAxisName="{$x_axis}" yAxisName="Count"  decimalPrecision="0" yAxisMaxValue="5">';
   ...
   ?>
    <script> var datastring = '<?php echo $strXML; ?>';</script>
	 <?php echo $this->JsFusionChart->showFusionChart("/fusionx_charts/MSColumn3D.swf", "patientadmissionchart", "900", "500", "0", "0", "datastring", "chartContainer"); ?>
  </div>          
   <div class="btns" style="padding-right: 105px;">
           <?php echo $this->Html->link(__('Back'),array('controller'=>'reports','action'=>'patient_admission_report', 'admin'=>true),array('class'=>'grayBtn','div'=>false)); ?>
   </div>