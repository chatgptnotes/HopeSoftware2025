...
<h3><?php echo __('IPD Patient Survey Report', true); ?></h3>
<span><?php echo $this->Html->link(__('Back'),array('controller'=>'reports','action'=>'patient_survey_type', 'admin'=>true),array('class'=>'blueBtn','div'=>false)); ?></span>
</div>
<?php echo $this->Form->create('Reports',array('action'=>'patientsurvey_reports','type'=>'post', 'id'=> 'datefilterfrm'));?>	
<table border="0"   cellpadding="0" cellspacing="0" width="500px" >
 ...
 <?php echo $this->Form->end();?>
   ...
   <?php 
                        echo $this->Form->create('Reports',array('action'=>'patientsurvey_chart','type'=>'post', 'id'=> 'showloschartfrm', 'style'=> 'float:left;'));
		        ...
		        echo $this->Form->end();
                        ...
                        echo $this->Form->create('Reports',array('action'=>'patientsurvey_xls','type'=>'post', 'id'=> 'losxlsfrm', 'style'=> 'float:left;'));
		        echo $this->Form->input(null, array('type' => 'hidden', 'name'=> 'reportYear', 'value' =>$reportYear));
   ...
   <table width="100%" cellpadding="0" cellspacing="1" border="0" class="tabularForm">
          <tr>
           ...
           <?php foreach($yaxisArray as $key => $yaxisArrayVal) { ?>
                  <td style="text-align:center;" colspan="6"><strong><?php echo $yaxisArrayVal; ?></strong></td>
           <?php } ?>
		...
		foreach($yaxisArray as $key => $yaxisArrayVal) {
	       ?>
                    <td align="center"> 
                     ...
                     <td align="center"> 
                      <?php 
                         ...
                         if(@in_array($i, $filterNandQuestIdArray)) {
                    ...
                    <td align="center"> 
                      <?php 
                         // for disagree answer //
                         if(@in_array($i, $filterDisgreeQuestIdArray)) {
                    ...
                    <td align="center"> 
                      <?php 
                         ...
                         if(@in_array($i, $filterStdQuestIdArray)) {
                     ...
                     <td align="center"> 
                      <?php 
                         ...
                         if(@in_array($i, $filterNaQuestIdArray)) {
