...
<br />
 ...
 <?php  echo $this->Form->create('',array('action'=>'pharmacySaleVoucherReport','type' => 'POST','id'=>'reportfrm','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false,
																								        'legend'=>false,
 ...
 $(document).ready(function(){
		//load all records from here using ajax
			$("#view,#refreshBtn").click(function(){ 
				...
				$.ajax({
					url: '<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'viewPharmacySaleVoucherReport'));?>',
