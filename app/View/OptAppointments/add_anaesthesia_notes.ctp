...
<div class="clr"></div>
<p class="ht5"></p>
<form name="anaesthesianotesfrm" id="anaesthesianotesfrm"
	action="<?php echo $this->Html->url(array("action" => "save_anaesthesia_notes", "admin" => false)); ?>"
	method="post">

	<?php
	echo $this->Form->hidden ( 'Note.id' );
	echo $this->Form->input ( 'Note.patient_id', array (
			'type' => 'hidden',
			'id' => 'patient_id',
			'value' => $patient_id 
	) );
	echo $this->Form->input ( 'Note.note_type', array (
			'type' => 'hidden',
			'id' => 'note_type',
			'value' => 'anaesthesia' 
	) );
	...
	<table class="table_format" id="schedule_form">
		<tr>
			...
			<td>
			    	...
			    	<?php
								...
								echo $this->Form->input ( 'Note.surgery_id', array (
										'options' => $surgeries,
										'empty' => 'Please select',
										'id' => 'surgery_id',
		...
		<tr>
			...
			<td>
			    	...
			    	<?php
								...
								echo $this->Form->input ( 'Note.sb_consultant', array (
										'options' => $consultant,
										'empty' => 'Please select',
										'id' => 'sb_consultant',
										'class' => 'validate[required,custom[mandatory-select]]',
		...
		<tr>
			...
			<td>
			    	<?php
								...
								echo $this->Form->input ( 'Note.sb_registrar', array (
										'options' => $registrar,
										'empty' => 'Please select',
										'id' => 'sb_registrar',
										'class' => 'validate[required,custom[mandatory-select]]',
		...
		<tr>
			...
			<td>
			    	<?php
								$anaesthesia_type = array (
										'pre-operative' => 'Pre Operative',
										'post-operative' => 'Post Operative',
										'intra-operative' => 'Intra Operative' 
								);
								echo $this->Form->input ( 'Note.anaesthesia_note_type', array (
										'options' => $anaesthesia_type,
										'empty' => 'Please select',
										'id' => 'anaesthesia_note_type',
										'class' => 'validate[required,custom[mandatory-select]]',
										'label' => false,
										'style' => 'width:200px' 
								) );
		...
		<tr>
			...
			<td>
			    	<?php
								...
								echo $this->Form->input ( 'Note.note_date', array (
										'type' => 'text',
										'id' => 'note_date',
										'class' => 'validate[required,custom[mandatory-date]]',
										'label' => false,
										'style' => 'width:170px',
										'value' => isset ( $this->data ['Note'] ['note_date'] ) ? $this->DateFormat->formatDate2Local ( $this->data ['Note'] ['note_date'], Configure::read ( 'date_format' ), true ) : '' 
								) );
								?>
	...
	<div id="accordionCust">
		<h3 style="display: block" id="post-opt-link">
			<a href="#" style="text-decoration: none; cursor: auto;">Anaesthesia
			...
			<td>
				<div class="btns" style="padding-right: 80px">
	   	  				 <?php
												...
												echo $this->Html->link ( __ ( 'Cancel' ), 'javascript:void(0);', array (
														'escape' => false,
														'class' => 'grayBtn Back' 
												) );
