...
<h3><?php echo __('Edit Packages', true); ?></h3>
</div>
<?php 
  if(!empty($errors)) {
?>
...
<?php }   echo $this->Form->create('Location',array("action" => "edit", "admin" => true,'type' => 'file','id'=>'locationfrm','inputDefaults' => array('label' => false, 'div' => false, 'error' => false	))); ?>
	...
	<?php echo __('Packages Name',true); ?><font color="red">*</font>
	</td>
	<td>
        <?php 
	...
	<tr>
		...
		<td>
        <?php 
          	echo $this->Form->input('Location.hospital_pan_no', array('class'=>'validate[required,custom[mandatory-enter]]','id' => 'hospital_pan_no', 'label'=> false, 'div' => false, 'error' => false));
        ?>
        </td>
	</tr>
	<tr>
