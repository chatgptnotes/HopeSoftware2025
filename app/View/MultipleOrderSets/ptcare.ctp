...
?>
<?php echo $this->Form->create('',array('url'=>'SaveOtherOrder/ptcare'),array('type' => 'file','default'=>false,'id'=>'ConfigueMedicationDisplayorderformForm','inputDefaults' => array(
		'label' => false,
		'div' => false,
		'error' => false,
		'legend'=>false,
								...
								<td>
									<table width="100%" border="0">
										...
										<?php //$start_date = $this->DateFormat->formatDate2Local($sentences[0],Configure::read('date_format'),true); ?>
											...
											<td><?php echo __('Start Date/time :',true); ?><font color="red">*</font>
											</td>
										...
										<tr>
											...
											<td valign="top"><?php echo __('Urinary Catherer Insertion :',true); ?>
											</td>
											<td valign="top"><?php echo $this->Form->input('PatientOrder.urinary_catherer_insertion', array('empty'=>'Please select','options'=> array('Indwelling'=>'Indwelling','Straight cath'=>'Straight cath'),'selected'=>$multipleOrderContent['MultipleOrderContaint']['urinary_catherer_insertion'],'label'=>false,'style'=>'width:200px;'));?>
											</td>
...
$(document).ready(function(){
	...
	.datepicker(
	 ...
	 $("#drug_name").autocomplete("<?php echo $this->Html->url(array("controller" => "app", "action" => "autocomplete","patient_care","STR", "admin" => false,"plugin"=>false)); ?>", {
			width: 250,
			selectFirst: true
		   });
