...
<?php echo $this->Form->create('',array('url'=>'SaveOtherOrder/diet'),array('type' => 'file','default'=>false,'id'=>'diet','inputDefaults' => array(
		'label' => false,
		'div' => false,
		'error' => false,
		'legend'=>false,
								...
								<td>
									<table width="100%">
										<tr>
											...
											<td><?php echo __('Frequency :',true); ?></td>
											<td><?php echo $this->Form->input('PatientOrder.frequency', array('empty'=>'Please select','options'=> Configure :: read('frequency'), 'id' => 'frequency','selected'=>$frequency,'label'=>false ,'style'=>'width:200px;'));?></td>
										...
										<tr>
											<td><?php echo __('NPO   Exception :',true); ?></td>
											<td><?php  echo $this->Form->input('PatientOrder.npo', array('options'=> array(""=>"Please Select","NPO except for ice chips"=>"NPO except for ice chips"), 'id' => 'npo', 'selected'=>$multipleOrderContent['MultipleOrderContaint']['npo'],'label'=>false,'div'=>false,'style'=>'width:200px'));?></td>

											<td valign="top"><?php echo __('Special Instruction :',true); ?><font color="red">*</font></td>
											<td valign="top"><?php echo $this->Form->textarea('PatientOrder.special_instruction', array('rows'=>'3','label'=>false,'value'=>$special_instruction,'style'=>'width:300px;','class' => 'validate[required,custom[mandatory-enter]]'));?></td>
										</tr>
...
$("#drug_name").autocomplete("<?php echo $this->Html->url(array("controller" => "app", "action" => "autocomplete","diet","STR", "admin" => false,"plugin"=>false)); ?>", {
width: 250,
selectFirst: true
});
