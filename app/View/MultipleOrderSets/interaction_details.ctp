...
<table border="0" class="table_format" cellpadding="0" cellspacing="0"
	...
	<tbody>
		...
		<?php  if(($getConditonalData[0]->SeverityLevel!='')){?>
		<tr class="row_title">
		...
		<?php }}?>
		<?php if(!empty($allAlergy)){?>
		<tr class="row_title">
			<td class="table_cell" width="20%" align="left"><?php echo __('Drug/Allergy Interaction');?>
			</td>
			<td class="table_cell" align="left" width="20%" colspan=2><?php echo __('Patient Allergy');?>
			</td>
		</tr>
			<tr>
			<td class="table_cell" width="60%" align="left"><font
				color="orange"><?php echo __($allAlergy); ?>
			</font>
			</td>
			<td class="table_cell" width="60%" align="left"><font
				color="orange"><?php $explAllergy= explode("with",$allAlergy) ; echo __($explAllergy[1]);?>
			</font>
			</td>
			<td class="table_cell" align="left" width="20%"><?php //echo $this->Html->link("More Info",array('onclick'=>'moreInfo()'));?>
				<?php //echo $this->Form->hidden('Discussion',array('value'=>$getConditonalRow->Discussion));?>
...
var ajaxUrl = "<?php echo $this->Html->url(array("controller" => "MultipleOrderSets", "action" => "SaveOrderMedication","admin"=>false)); ?>";
		$.ajax({
			type : "POST",
			data: postData,
			url : ajaxUrl , 
