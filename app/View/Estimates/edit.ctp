...
<?php
	...
	echo $this->Form->create('EstimatePatient',array('type' => 'file','name'=>'register','id'=>'personfrm','inputDefaults' => array('label' => false, 'div' => false, 'error' => false	))); 
	?>
	<?php 
		  if(!empty($errors)) {
	?>
			...
			<!-- form start here -->
					<div class="btns">
						<?php 
							...
							echo $this->Html->link(__('Cancel'),array('action' => 'estimateTypes',$this->request->data['EstimatePatient']['id']), array('escape' => false,'class'=>'blueBtn'));
						?>
