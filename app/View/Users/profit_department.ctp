<div class="inner_title">
	<h3>
		<?php echo __('Department-wise Collection Report', true); ?>
	</h3>
...
<script>
	...
	jQuery("#deptWiseReceiptfrm").validationEngine();
	});
	
</script>

<?php  echo $this->Form->create('',array('action'=>'profitDepartment','type' => 'get','id'=>'deptWiseReceiptfrm','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false,
																								        'legend'=>false,
...
<table width="50%" cellpadding="0" cellspacing="2" border="0" 	class="tabularForm" id="content-list"><!-- style="border-bottom:solid 10px #E7EEEF;" -->
	<tr> 
		<th width="25%" align="center" valign="top" style="text-align: center;;">Department Name</th>
		<th width="25%" align="center" valign="top" style="text-align: center; min-width: 150px;">Amount</th> 	
	</tr> 
	<?php
   $toggle =0;
      if(count($data) > 0) {
  ...
  ?>
    <td class="row_format"><?php echo $personval['Department']['name']; ?> </td>
