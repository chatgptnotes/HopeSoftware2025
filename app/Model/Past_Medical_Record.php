...
class PastMedicalRecord extends AppModel {
	...
	//exit;
		...
		$this->saveAll(array('illness'=>$data['Diagnosis']['illness'],'status'=>$data['Diagnosis']['status'],
				'duration'=>$data['Diagnosis']['duration'],
				'comments'=>$data['comments']['comments'],'patient_id' =>$id));
