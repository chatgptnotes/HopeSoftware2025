 ...
 */
class LabManager extends AppModel {
	
		public $name = 'LaboratoryTestOrder';
		public $useTable = 'laboratory_test_orders';
		...
		function insertTestOrder($data=array(),$action='insert'){
			...
			if(is_array($data['LaboratoryTestOrder']['laboratory_id'])){
				...
				foreach($data['LaboratoryTestOrder']['laboratory_id'] as $labID){
					...
					$laboratoryToken->save(array('laboratory_id'=>$labID,'patient_id'=>$data['LaboratoryTestOrder']['patient_id'],'laboratory_test_order_id'=>$this->id));
					//generate lab id for each new test ordered
				    $laboratoryToken->id ='';
					$labId =  $this->autoGeneratedLabID($this->id); 
