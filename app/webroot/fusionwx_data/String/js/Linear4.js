var dataString ='<chart manageResize="1" editMode="1" origW="380" origH="80" animation="0" showShadow="0" upperLimit="9" lowerLimit="0" chartTopMargin="5" chartBottomMargin="10" chartLeftMargin="30" chartRightMargin="30" \n\
\n\
...
showgaugeBorder="0" baseFontColor="FFFFFF" bgColor="#1D2020" bgAlpha="100">\n\
	<pointers>\n\
		<pointer value="6.7"/>\n\
	</pointers>\n\
	<annotations>\n\
		...
		<annotationGroup id="Grp2" showBelow="1" x="190" y="$gaugeStartY+36" >\n\
			<annotation type="text"  color="004D69" bold="1" x="0" y="0"/>\n\
		</annotationGroup>\n\
	</annotations>\n\
	<styles>\n\
		<definition>\n\
